...
def test_SegmentSpecification__look_up_division_setting_from_past_between_voices_01():
    '''From-past set-division lookup expression between voices.
    '''
    ...
    red_voice_2_division_command = red_segment.timespan.start_offset.look_up_division_setting('Voice 2')
...
def test_SegmentSpecification__look_up_division_setting_from_past_between_voices_02():
    '''From-past set-division lookup expression between voices with reverse callback.
    '''
    ...
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
    red_voice_2_division_command = red_segment.timespan.start_offset.look_up_division_setting('Voice 2')
    red_voice_2_division_command = red_voice_2_division_command.reflect()
    blue_segment.set_divisions(red_voice_2_division_command, contexts=['Voice 1'])
    score = score_specification.interpret()
...
def test_SegmentSpecification__look_up_division_setting_from_past_between_voices_03():
    '''From-past set-division lookup expression between voices with set-time reverse.
    '''
...
def test_SegmentSpecification__look_up_division_setting_from_past_between_voices_04():
    '''From-past set-division lookup expression between voices with reverse callbacks.
    '''
