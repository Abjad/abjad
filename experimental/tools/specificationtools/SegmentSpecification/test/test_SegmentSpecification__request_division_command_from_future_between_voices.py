...
def test_SegmentSpecification__request_division_command_from_future_between_voices_01():
    ...
    blue_voice_2_division_command = blue_segment.timespan.start_offset.request_division_command('Voice 2')
...
def test_SegmentSpecification__request_division_command_from_future_between_voices_02():
    ...
    red_segment.set_time_signatures([(2, 8), (2, 8)])
    blue_voice_2_division_command = blue_segment.timespan.start_offset.request_division_command('Voice 2')
    blue_voice_2_division_command = blue_voice_2_division_command.reverse()
    red_segment.set_divisions(blue_voice_2_division_command, contexts=['Voice 1'])
    red_segment.set_divisions([(2, 16), (5, 16)], contexts=['Voice 2'])
    red_segment.set_rhythm(library.sixteenths)
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
...
def test_SegmentSpecification__request_division_command_from_future_between_voices_03():
...
def test_SegmentSpecification__request_division_command_from_future_between_voices_04():
