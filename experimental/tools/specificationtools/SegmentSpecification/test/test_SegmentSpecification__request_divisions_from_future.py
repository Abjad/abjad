...
def test_SegmentSpecification__request_divisions_from_future_01():
...
def test_SegmentSpecification__request_divisions_from_future_02():
    ...
    red_segment.set_time_signatures([(2, 8), (2, 8)])
    blue_divisions = blue_segment.request_divisions('Voice 1')
    blue_divisions = blue_divisions.REVERSE()
    red_segment.set_divisions(blue_divisions)
    red_segment.set_rhythm(library.sixteenths)
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
    blue_segment.set_divisions([(5, 16)])
...
def test_SegmentSpecification__request_divisions_from_future_03():
...
def test_SegmentSpecification__request_divisions_from_future_04():
