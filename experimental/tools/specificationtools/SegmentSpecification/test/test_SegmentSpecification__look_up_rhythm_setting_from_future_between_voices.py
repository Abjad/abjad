...
def test_SegmentSpecification__look_up_rhythm_setting_from_future_between_voices_01():
    '''From-future set-rhythm lookup expression between voices.
    '''
    ...
    blue_voice_2_rhythm_set_expression = blue_segment.timespan.start_offset.look_up_rhythm_setting('Voice 2')
...
def test_SegmentSpecification__look_up_rhythm_setting_from_future_between_voices_02():
    '''From-future set-rhythm lookup expression between voices with reverse callback.
    '''
...
def test_SegmentSpecification__look_up_rhythm_setting_from_future_between_voices_03():
    '''From-future set-rhythm lookup expression between voices with set-time reverse.
    '''
...
def test_SegmentSpecification__look_up_rhythm_setting_from_future_between_voices_04():
    '''From-future set-rhythm lookup expression between voices with reverse callbacks.
    '''
