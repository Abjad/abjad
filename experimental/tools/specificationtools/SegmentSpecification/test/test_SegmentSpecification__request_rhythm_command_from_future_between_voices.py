...
def test_SegmentSpecification__request_rhythm_command_from_future_between_voices_01():
    ...
    blue_voice_2_rhythm_command = blue_segment.request_rhythm_command('Voice 2')
...
def test_SegmentSpecification__request_rhythm_command_from_future_between_voices_02():
    ...
    red_segment.set_divisions([(1, 8), (2, 8)], contexts=['Voice 1'])
    red_segment.set_divisions([(1, 8), (3, 8)], contexts=['Voice 2'])
    blue_voice_2_rhythm_command = blue_segment.request_rhythm_command('Voice 2', reverse=True)
    red_segment.set_rhythm(blue_voice_2_rhythm_command, contexts=['Voice 1'])
    red_segment.set_rhythm(library.dotted_sixteenths)
...
def test_SegmentSpecification__request_rhythm_command_from_future_between_voices_03():
    ...
    red_segment.set_divisions([(1, 8), (3, 8)], contexts=['Voice 2'])
    blue_voice_2_rhythm_command = blue_segment.request_rhythm_command('Voice 2')
    red_segment.set_rhythm(blue_voice_2_rhythm_command, contexts=['Voice 1'], reverse=True)
    red_segment.set_rhythm(library.dotted_sixteenths)
...
def test_SegmentSpecification__request_rhythm_command_from_future_between_voices_04():
