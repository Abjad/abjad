...
def test_SegmentSpecification__look_up_division_setting_from_past_01():
    '''From-past set-division lookup expression.
    '''
    ...
    red_division_set_expression = red_segment.timespan.start_offset.look_up_division_setting('Voice 1')
...
def test_SegmentSpecification__look_up_division_setting_from_past_02():
    '''From-past set-division lookup expression with reverse callback.
    '''
...
def test_SegmentSpecification__look_up_division_setting_from_past_03():
    '''From-past set-division lookup expression with set-time reverse.
    '''
...
def test_SegmentSpecification__look_up_division_setting_from_past_04():
    '''From-past set-division lookup expression with reverse callbacks.
    '''
