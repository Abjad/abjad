...
def test_SegmentSpecification__request_divisions_from_future_between_voices_01():
...
def test_SegmentSpecification__request_divisions_from_future_between_voices_02():
    ...
    red_segment.set_time_signatures([(2, 8), (2, 8)])
    blue_voice_2_divisions = blue_segment.request_divisions('Voice 2')
    blue_voice_2_divisions = blue_voice_2_divisions.reverse()
    red_segment.set_divisions(blue_voice_2_divisions)
    red_segment.set_divisions([(2, 16), (5, 16)], contexts=['Voice 2'])
    red_segment.set_rhythm(library.sixteenths)
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
...
def test_SegmentSpecification__request_divisions_from_future_between_voices_03():
...
def test_SegmentSpecification__request_divisions_from_future_between_voices_04():
