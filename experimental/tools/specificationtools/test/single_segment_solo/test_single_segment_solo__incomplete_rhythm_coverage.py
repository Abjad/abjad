...
def test_single_segment_solo__incomplete_rhythm_coverage_01():
    ...
    selector = red_segment.select_background_measures('Voice 1', 1, 2)
...
def test_single_segment_solo__incomplete_rhythm_coverage_02():
    ...
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    red_segment.set_divisions([(3, 16)])
    selector = red_segment.select_background_measures('Voice 1', 0, 1)
    selector.set_rhythm(library.sixteenths)
    selector = red_segment.select_background_measures('Voice 1', -1)
    selector.set_rhythm(library.thirty_seconds)
    score = score_specification.interpret()
...
def test_single_segment_solo__incomplete_rhythm_coverage_03():
    ...
    selector = red_segment.select_background_measures('Voice 1', 1, 2)
    selector.set_rhythm(library.thirty_seconds)
    selector.set_rhythm(library.sixteenths, contexts=['Voice 1'])
    score = score_specification.interpret()
...
def test_single_segment_solo__incomplete_rhythm_coverage_04():
    ...
    selector.set_rhythm(library.sixteenths)
    selector = red_segment.select_background_measures('Voice 1', -1)
    selector.set_rhythm(library.thirty_seconds, contexts=['Voice 1'])
    score = score_specification.interpret()
...
def test_single_segment_solo__incomplete_rhythm_coverage_05():
    ...
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    red_segment.set_divisions([(3, 16)])
    selector = red_segment.select_background_measures('Voice 1', start=-2)
    selector.set_rhythm(library.sixteenths)
    selector = red_segment.select_background_measures('Voice 1', start=-1)
    selector.set_rhythm(library.thirty_seconds)
    score = score_specification.interpret()
