...
def test_single_segment_solo__nonoverlapping_division_selectors_01():
    ...
    red_segment.set_divisions([(2, 32)], timespan=first_measure)
    second_measure = red_segment.select_background_measures(1, 2)
    red_segment.set_divisions([(3, 32)], timespan=second_measure)
    third_measure = red_segment.select_background_measures(2, 3)
    red_segment.set_divisions([(4, 32)], timespan=third_measure)
