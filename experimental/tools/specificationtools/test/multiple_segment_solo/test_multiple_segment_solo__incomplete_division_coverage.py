...
def test_multiple_segment_solo__incomplete_division_coverage_01():
    ...
    red_segment.set_divisions([(4, 16)], contexts=['Voice 1'], timespan=left_measure)
...
def test_multiple_segment_solo__incomplete_division_coverage_02():
    ...
    right_measure = red_segment.select_background_measures(1, 2)
    red_segment.set_divisions([(4, 16)], contexts=['Voice 1'], timespan=left_measure)
    red_segment.set_divisions([(5, 16)], contexts=['Voice 1'], timespan=right_measure, persist=False)
    red_segment.set_rhythm(library.sixteenths)
    blue_segment = score_specification.append_segment(name='blue')
