...
def test_multiple_segment_quartet_01():
    ...
    source = score_specification['red'].select_time_signatures('Voice 1')
...
def test_multiple_segment_quartet_03():
    ...
    first_measure = red_segment.select_background_measures('Voice 1', stop=1)
    second_measure = red_segment.select_background_measures('Voice 1', start=-1)
