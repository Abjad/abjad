...
def test_schematic_examples__X_series_02():
    ...
    source_1 = red_segment.select_divisions('Voice 1')
    source_2 = red_segment.select_divisions('Voice 2')
    source_1 = source_1.reverse()
    source_2 = source_2.reverse()
    red_segment.set_divisions(source_1, contexts=['Voice 3'], truncate=True)
    red_segment.set_divisions(source_2, contexts=['Voice 4'], truncate=True)
    red_segment.set_rhythm(library.thirty_seconds)
...
def test_schematic_examples__X_series_03():
    ...
    blue_segment.set_rhythm(red_voice_1_rhythm.reverse(), contexts=['Voice 1'])
    blue_segment.set_rhythm(red_voice_2_rhythm.reverse(), contexts=['Voice 2'])
    blue_segment.set_rhythm(red_voice_3_rhythm.reverse(), contexts=['Voice 3'])
    blue_segment.set_rhythm(red_voice_4_rhythm.reverse(), contexts=['Voice 4'])
...
def test_schematic_examples__X_series_05():
    ...
    voice_1_rhythmic_cell = first_division.request_rhythm('Voice 1')
...
def test_schematic_examples__X_series_06():
    ...
    first_division = red_segment.select_divisions('Voice 1', 0, 1)
    rhythmic_cell = first_division.request_rhythm('Voice 1')
...
def test_schematic_examples__X_series_07():
    ...
    first_measure.set_rhythm(cell.rotate(Duration(-4, 32)), contexts=['Voice 3'])
    second_measure.set_rhythm(cell.rotate(Duration(-5, 32)), contexts=['Voice 3'])
    first_measure.set_rhythm(cell.rotate(Duration(-6, 32)), contexts=['Voice 4'])
    ...
    voice_1_rhythm = timespan.request_rhythm('Voice 1')
    voice_2_rhythm = timespan.request_rhythm('Voice 2')
    voice_3_rhythm = timespan.request_rhythm('Voice 3')
    voice_4_rhythm = timespan.request_rhythm('Voice 4')
...
def test_schematic_examples__X_series_08():
    ...
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    measures = red_segment.select_background_measures()
    first_measure, middle_measure, last_measure = measures.partition_objects_by_ratio((1, 1, 1))
    ...
    last_measure.set_rhythm(library.even_runs(2), contexts=['Voice 1'])
    first_measure.set_rhythm(library.even_runs(1), contexts=['Voice 2'])
    middle_measure.set_rhythm(library.even_runs(2), contexts=['Voice 2'])
    last_measure.set_rhythm(library.even_runs(0), contexts=['Voice 2'])
    first_measure.set_rhythm(library.even_runs(2), contexts=['Voice 3'])
    middle_measure.set_rhythm(library.even_runs(0), contexts=['Voice 3'])
    last_measure.set_rhythm(library.even_runs(1), contexts=['Voice 3'])
    ...
    last_leaves = timespan.request_rhythm('Voice 1')
...
def test_schematic_examples__X_series_09():
    ...
    timespan = red_segment.adjust_timespan_offsets(Offset(3, 16), Offset(6, 16))
    rhythm = timespan.request_rhythm('Voice 1')
    blue_segment.set_rhythm(rhythm, contexts=['Voice 1'])
    rhythm = timespan.request_rhythm('Voice 2')
    blue_segment.set_rhythm(rhythm, contexts=['Voice 2'])
    rhythm = timespan.request_rhythm('Voice 3')
    blue_segment.set_rhythm(rhythm, contexts=['Voice 3'])
    rhythm = timespan.request_rhythm('Voice 4')
