...
def test_schematic_examples__X_series_04():
    ...
    red_segment.set_rhythm(library.equal_divisions(16), timespan=left, contexts=['Voice 1'])
    red_segment.set_rhythm(library.equal_divisions(8), timespan=middle, contexts=['Voice 1'])
    red_segment.set_rhythm(library.equal_divisions(4), timespan=right, contexts=['Voice 1'])
...
def test_schematic_examples__X_series_07():
    ...
    red_segment.set_rhythm(cell, contexts=['Voice 1'], timespan=second_measure, rotation=Duration(-1, 32))
    red_segment.set_rhythm(cell, contexts=['Voice 2'], timespan=first_measure, rotation=Duration(-2, 32))
    red_segment.set_rhythm(cell, contexts=['Voice 2'], timespan=second_measure, rotation=Duration(-3, 32))
    red_segment.set_rhythm(cell, contexts=['Voice 3'], timespan=first_measure, rotation=Duration(-4, 32))
    red_segment.set_rhythm(cell, contexts=['Voice 3'], timespan=second_measure, rotation=Duration(-5, 32))
    red_segment.set_rhythm(cell, contexts=['Voice 4'], timespan=first_measure, rotation=Duration(-6, 32))
    red_segment.set_rhythm(cell, contexts=['Voice 4'], timespan=second_measure, rotation=Duration(-7, 32))
    blue_segment = score_specification.append_segment(name='blue')
...
def test_schematic_examples__X_series_08():
    ...
    red_segment.set_rhythm(library.even_runs(0), contexts=['Voice 1'], timespan=first_measure)
    red_segment.set_rhythm(library.even_runs(1), contexts=['Voice 1'], timespan=middle_measure)
    red_segment.set_rhythm(library.even_runs(2), contexts=['Voice 1'], timespan=last_measure)
    red_segment.set_rhythm(library.even_runs(1), contexts=['Voice 2'], timespan=first_measure)
    red_segment.set_rhythm(library.even_runs(2), contexts=['Voice 2'], timespan=middle_measure)
    red_segment.set_rhythm(library.even_runs(0), contexts=['Voice 2'], timespan=last_measure)
    red_segment.set_rhythm(library.even_runs(2), contexts=['Voice 3'], timespan=first_measure)
    red_segment.set_rhythm(library.even_runs(0), contexts=['Voice 3'], timespan=middle_measure)
    red_segment.set_rhythm(library.even_runs(1), contexts=['Voice 3'], timespan=last_measure)
