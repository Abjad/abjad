...
def test_schematic_examples__X_series_07():
    ...
    second_measure.set_rhythm(cell, contexts=['Voice 1'], rotation=Duration(-1, 32))
    first_measure.set_rhythm(cell, contexts=['Voice 2'], rotation=Duration(-2, 32))
    second_measure.set_rhythm(cell, contexts=['Voice 2'], rotation=Duration(-3, 32))
    first_measure.set_rhythm(cell, contexts=['Voice 3'], rotation=Duration(-4, 32))
    second_measure.set_rhythm(cell, contexts=['Voice 3'], rotation=Duration(-5, 32))
    first_measure.set_rhythm(cell, contexts=['Voice 4'], rotation=Duration(-6, 32))
    second_measure.set_rhythm(cell, contexts=['Voice 4'], rotation=Duration(-7, 32))
    blue_segment = score_specification.append_segment(name='blue')
