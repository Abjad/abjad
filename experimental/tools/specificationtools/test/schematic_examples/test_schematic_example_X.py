...
def test_schematic_example_X_04():
    ...
    indicator = specificationtools.RotationIndicator(-1, 1)
    red_segment.set_rhythm(voice_1_rhythm.rotate(indicator), contexts=['Voice 2'])
    indicator = specificationtools.RotationIndicator(-2, 1)
...
def test_schematic_example_X_05():
    ...
    indicator = specificationtools.RotationIndicator(Duration(-1, 32), fracture_spanners=False)
    red_segment.set_rhythm(voice_1_rhythmic_cell.rotate(indicator), contexts=['Voice 2'])
    indicator = specificationtools.RotationIndicator(Duration(-2, 32), fracture_spanners=False)
    red_segment.set_rhythm(voice_1_rhythmic_cell.rotate(indicator), contexts=['Voice 3'])
    indicator = specificationtools.RotationIndicator(Duration(-3, 32), fracture_spanners=False)
...
def test_schematic_example_X_06():
    ...
    indicator = specificationtools.RotationIndicator(-1, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(indicator), contexts=['Voice 2'])
    indicator = specificationtools.RotationIndicator(-2, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(indicator), contexts=['Voice 3'])
    indicator = specificationtools.RotationIndicator(-3, fracture_spanners=False)
