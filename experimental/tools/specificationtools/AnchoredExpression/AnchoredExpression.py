...
class AnchoredExpression(Expression):
    ...
    def __init__(self, anchor=None):
        ...
        assert isinstance(anchor, (specificationtools.AnchoredExpression, str, type(None))), repr(anchor)
        self._anchor = anchor
    ...
    def start_offset(self):
        ...
        '''
        from experimental.tools import specificationtools
        result = specificationtools.OffsetExpression(anchor=self._expression_abbreviation)
        result._score_specification = self.score_specification
        return result
    ...
    def stop_offset(self):
        ...
        '''
        from experimental.tools import specificationtools
        result = specificationtools.OffsetExpression(anchor=self._expression_abbreviation, edge=Right)
        result._score_specification = self.score_specification
        return result
