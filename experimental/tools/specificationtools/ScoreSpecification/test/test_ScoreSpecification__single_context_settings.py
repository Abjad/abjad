...
def test_ScoreSpecification_single_context_settings_01():
    ...
    assert not score_specification.score_specification.single_context_set_expressions
    assert not score_specification.score_specification.segment_specifications['red'].single_context_set_expressions
    ...
    assert len(score_specification.score_specification.segment_specifications['red'].single_context_set_expressions) == 1
