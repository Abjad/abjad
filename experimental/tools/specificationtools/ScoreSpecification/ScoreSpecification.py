...
class ScoreSpecification(Specification):
    ...
    def __init__(self, score_template):
        ...
        self._leaf_set_expressions = specificationtools.ExpressionInventory()
    ...
    def get_segment_specification(self, expr):
        ...
        ::
            ...
            >>> expression = specificationtools.SegmentIdentifierExpression("'red' + 2")
    ...
    def make_default_timespan_scoped_single_context_division_set_expression(self, target_timespan, voice_name):
        ...
        return specificationtools.TimespanScopedSingleContextDivisionSetExpression(
            source_expression=specificationtools.IterablePayloadExpression(divisions),
    ...
    def make_default_timespan_scoped_single_context_rhythm_set_expression(self, target_timespan, voice_name):
        ...
        from experimental.tools import specificationtools
        return specificationtools.TimespanScopedSingleContextRhythmSetExpression(
            source_expression=specificationtools.RhythmMakerExpression(library.skip_tokens),
            target_timespan=target_timespan,
            target_context_name=voice_name,
            fresh=True
            )
    ...
    def make_timespan_scoped_single_context_set_expressions_for_voice(self, attribute, voice_name):
        from experimental.tools import specificationtools
        timespan_scoped_set_expressions = specificationtools.TimespanScopedSingleContextSetExpressionInventory()
