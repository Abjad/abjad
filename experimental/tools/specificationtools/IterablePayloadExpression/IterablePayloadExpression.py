...
class IterablePayloadExpression(PayloadExpression):
    ...
    ::
        ...
        >>> payload_expression = specificationtools.IterablePayloadExpression([(4, 16), (2, 16)])
    ...
    def __and__(self, timespan):
        ...
        division_payload_expression = specificationtools.StartPositionedDivisionPayloadExpression(
