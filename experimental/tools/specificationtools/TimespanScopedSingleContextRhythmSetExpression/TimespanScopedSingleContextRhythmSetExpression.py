...
from experimental.tools.specificationtools.TimespanScopedSingleContextSetExpression import \
...
class TimespanScopedSingleContextRhythmSetExpression(TimespanScopedSingleContextSetExpression):
    ...
    def __sub__(self, timespan):
        '''Subtract `timespan` from timespan-scoped single-context rhythm set expression.
            ...
            >>> source_expression = specificationtools.StartPositionedRhythmPayloadExpression(
    ...
    def evaluate(self, division_list, start_offset, voice_name):
        ...
        if isinstance(self.source_expression, specificationtools.RhythmMakerExpression):
        ...
        elif isinstance(self.source_expression, specificationtools.StartPositionedRhythmPayloadExpression):
        ...
        elif isinstance(self.source_expression, specificationtools.RhythmSetExpressionLookupExpression):
        ...
        elif isinstance(self.source_expression, specificationtools.CounttimeComponentSelectExpression):
            region_expression = specificationtools.SelectExpressionRhythmRegionExpression(
