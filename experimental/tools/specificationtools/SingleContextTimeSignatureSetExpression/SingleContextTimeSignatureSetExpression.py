...
from experimental.tools.specificationtools.SingleContextSetExpression import SingleContextSetExpression
...
class SingleContextTimeSignatureSetExpression(SingleContextSetExpression):
    ...
    def evaluate(self):
        ...
        expression = specificationtools.TimespanScopedSingleContextTimeSignatureExpression(
