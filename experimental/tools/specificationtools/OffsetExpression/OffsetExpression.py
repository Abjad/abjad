...
from experimental.tools.specificationtools.LookupMethodMixin import LookupMethodMixin
from experimental.tools.specificationtools.OffsetCallbackMixin import OffsetCallbackMixin
...
class OffsetExpression(AnchoredExpression, OffsetCallbackMixin, LookupMethodMixin):
    ...
    ::
        ...
        specificationtools.OffsetExpression(
            anchor=specificationtools.CounttimeComponentSelectExpression(
                anchor='red',
    ...
    def evaluate(self):
        ...
        expression = specificationtools.IterablePayloadExpression([offset])
        return expression
