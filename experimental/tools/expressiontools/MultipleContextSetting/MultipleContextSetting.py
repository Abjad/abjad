import copy
from experimental.tools.expressiontools.Setting import Setting
...
class MultipleContextSetting(Setting):
    ...
    def _attribute_to_single_context_setting_class(self, attribute):
        ...
        return {
            'time_signatures': expressiontools.SingleContextTimeSignatureSetting,
            'divisions': expressiontools.SingleContextDivisionSetting,
            'rhythm': expressiontools.SingleContextRhythmSetting,
            }[attribute]
