...
from experimental.tools.expressiontools.TimespanScopedSingleContextSetting import TimespanScopedSingleContextSetting
...
class TimespanScopedSingleContextRhythmSetting(TimespanScopedSingleContextSetting):
    ...
    def __sub__(self, timespan):
        '''Subtract `timespan` from setting.
            ...
            >>> timespan_scoped_single_context_rhythm_setting = expressiontools.TimespanScopedSingleContextRhythmSetting(
    ...
    def to_region_expression(self, division_list, start_offset, voice_name):
        ...
        elif isinstance(self.expression, expressiontools.RhythmSettingLookupExpression):
