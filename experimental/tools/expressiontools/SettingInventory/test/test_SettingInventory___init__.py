...
def test_SettingInventory___init___01():
    ...
    setting_inventory_2 = expressiontools.SettingInventory(setting_inventory_1)

    assert isinstance(setting_inventory_1, expressiontools.SettingInventory)
    assert isinstance(setting_inventory_2, expressiontools.SettingInventory)
