...
class DivisionList(BoundedObject):
    ...
    ``'Voice 1'`` has only one division region division list::
        ...
        >>> len(score_specification.score_specification.context_proxies['Voice 1'].division_payload_expressions)
        1

    ::

        >>> z(score_specification.score_specification.context_proxies['Voice 1'].division_payload_expressions[0])
    ...
    def __init__(self, divisions, start_offset=None, voice_name=None):
        ...
        for division in divisions:
            ...
            positioned_division = expressiontools.Division(division, start_offset=division_start_offset)
    ...
    def __add__(self, expr):
        '''Concatenate division lists.
            ...
            >>> left = expressiontools.DivisionList([(1, 16), (2, 16)])
            >>> right = expressiontools.DivisionList([(3, 16), (4, 16)])
