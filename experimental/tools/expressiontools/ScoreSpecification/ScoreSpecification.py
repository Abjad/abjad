...
from experimental.tools.expressiontools.Specification import Specification
...
class ScoreSpecification(Specification):
    ...
    ::
        ...
        >>> score_specification = expressiontools.ScoreSpecificationInterface(template)
    ...
    def __init__(self, score_template):
        ...
        self._segment_specifications = expressiontools.SegmentSpecificationInventory()
        self._segment_specification_class = expressiontools.SegmentSpecification
    ...
    def segment_specification_class(self):
        ...
        ::
            ...
            <class 'experimental.tools.expressiontools.SegmentSpecification.SegmentSpecification.SegmentSpecification'>
