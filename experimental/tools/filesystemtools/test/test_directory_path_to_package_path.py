...
def test_ScoreManagementObject_directory_path_to_package_path_02():
    ...
    assert filesystemtools.directory_path_to_package_path(directory_path) == 'example_score_1.mus'

    directory_path = os.path.join(scores_directory_path, 'example_score_1', 'mus', 'materials')
    assert filesystemtools.directory_path_to_package_path(directory_path) == \
...
def test_ScoreManagementObject_directory_path_to_package_path_03():
    ...
    assert filesystemtools.directory_path_to_package_path(file_path) == 'example_score_1.foo'
