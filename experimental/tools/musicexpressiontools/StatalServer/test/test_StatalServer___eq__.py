...
def test_StatalServer___eq___01():
    ...
    statal_server_1 = musicexpressiontools.StatalServer([0, 1, 2, 3, 4])
    statal_server_2 = musicexpressiontools.StatalServer([0, 1, 2, 3, 4])
    statal_server_3 = musicexpressiontools.StatalServer([0, 1, 2, 3])
