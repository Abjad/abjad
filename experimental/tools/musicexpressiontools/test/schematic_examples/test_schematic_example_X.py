...
def test_schematic_example_X_04():
    ...
    red_segment.set_rhythm(voice_1_rhythm.rotate(rotation), contexts=['Voice 2'])
    rotation = musicexpressiontools.RotationExpression(-2, 1)
    red_segment.set_rhythm(voice_1_rhythm.rotate(rotation), contexts=['Voice 3'])
...
def test_schematic_example_X_06():
    ...
    rotation = musicexpressiontools.RotationExpression(-1, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(rotation), contexts=['Voice 2'])
    rotation = musicexpressiontools.RotationExpression(-2, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(rotation), contexts=['Voice 3'])
    rotation = musicexpressiontools.RotationExpression(-3, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(rotation), contexts=['Voice 4'])
    blue_segment = score_specification.append_segment(name='blue')
    blue_segment.set_time_signatures(2 * [(1, 8)])
    red_voice_1_rhythm = red_segment.select_leaves('Voice 1')
    blue_segment.set_rhythm(red_voice_1_rhythm.reflect(), contexts=['Voice 1'])
