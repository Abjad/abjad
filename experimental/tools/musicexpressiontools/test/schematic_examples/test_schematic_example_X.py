...
def test_schematic_example_X_04():
    ...
    indicator = musicexpressiontools.RotationExpression(-2, 1)
...
def test_schematic_example_X_05():
    ...
    indicator = musicexpressiontools.RotationExpression(Duration(-1, 32), fracture_spanners=False)
    red_segment.set_rhythm(voice_1_rhythmic_cell.rotate(indicator), contexts=['Voice 2'])
    indicator = musicexpressiontools.RotationExpression(Duration(-2, 32), fracture_spanners=False)
    red_segment.set_rhythm(voice_1_rhythmic_cell.rotate(indicator), contexts=['Voice 3'])
    indicator = musicexpressiontools.RotationExpression(Duration(-3, 32), fracture_spanners=False)
...
def test_schematic_example_X_06():
    ...
    indicator = musicexpressiontools.RotationExpression(-1, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(indicator), contexts=['Voice 2'])
    indicator = musicexpressiontools.RotationExpression(-2, fracture_spanners=False)
    red_segment.set_rhythm(rhythmic_cell.rotate(indicator), contexts=['Voice 3'])
    indicator = musicexpressiontools.RotationExpression(-3, fracture_spanners=False)
