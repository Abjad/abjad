...
def test_SegmentSpecification__select_divisions_01():
    ...
    divisions_that_start_during_red.timespan.set_rhythm(library.joined_sixteenths)
    divisions_that_start_during_blue.timespan.set_rhythm(library.joined_eighths)
...
def test_SegmentSpecification__select_divisions_02():
    ...
    divisions_that_start_during_red.timespan.set_rhythm(library.joined_sixteenths)
    blue_segment = score_specification.append_segment(name='blue')
    blue_segment.set_rhythm(library.joined_eighths)
    score = score_specification.interpret()
...
def test_SegmentSpecification__select_divisions_03():
    ...
    antepenultimate_division.timespan.set_rhythm(library.joined_sixteenths)
    score = score_specification.interpret()
...
def test_SegmentSpecification__select_divisions_04():
    ...
    red_segment.set_divisions([(3, 16)])
    red_segment.set_rhythm(library.joined_thirty_seconds)
    red_segment.select_divisions('Voice 1')[2].timespan.set_rhythm(library.joined_sixteenths)
    score = score_specification.interpret()
...
def test_SegmentSpecification__select_divisions_06():
    ...
    red_segment.set_divisions([(3, 16)])
    red_segment.set_rhythm(library.joined_thirty_seconds)
    red_segment.select_divisions('Voice 1')[0].timespan.set_rhythm(library.joined_sixteenths)
    score = score_specification.interpret()
...
def test_SegmentSpecification__select_divisions_07():
    ...
    red_segment.set_divisions([(3, 16)])
    red_segment.set_rhythm(library.joined_thirty_seconds)
    red_segment.select_divisions('Voice 1')[:].timespan.set_rhythm(library.joined_sixteenths)
    score = score_specification.interpret()
