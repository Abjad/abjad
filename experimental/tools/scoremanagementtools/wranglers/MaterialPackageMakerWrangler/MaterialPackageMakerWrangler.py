...
class MaterialPackageMakerWrangler(PackageWrangler):
    ...
    def forbidden_package_importable_names(self):
        return ['scoremanagementtools.makers.' + class_name for class_name in self.forbidden_class_names]

    ### PUBLIC METHODS ###

    def get_asset_proxy(self, package_importable_name):
        from experimental.tools.scoremanagementtools.proxies.MaterialPackageProxy import MaterialPackageProxy
        ...
        if material_package_maker_class_name is not None:
            ...
            command = 'from experimental.tools.scoremanagementtools.makers import {} as material_package_maker_class'
    ...
    def make_asset_class_file(self, package_short_name, generic_output_name):
        ...
        lines.append('from experimental.tools.scoremanagementtools.makers.MaterialPackageMaker import MaterialPackageMaker')
        lines.append('from experimental.tools.scoremanagementtools.editors.UserInputWrapper import UserInputWrapper')
        lines.append('from experimental.tools import scoremanagementtools')
        lines.append('')
        lines.append('')
