...
def test_ScoreManagementObject_read_only_attributes_01():
    ...
    assert score_management_object.configuration.score_management_tools_package_importable_name == 'scoremanagementtools'

    path = os.environ.get('SCORE_MANAGEMENT_TOOLS_PATH')
    assert score_management_object.configuration.score_management_tools_package_path_name == path
