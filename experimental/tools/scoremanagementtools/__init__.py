...
should be set in your profile, or equivalent:
    ...
    export SCFOUTPUT=$HOME/.scoremanagementtools/output
    export SCFPATH=$ABJADEXPERIMENTAL/tools/scoremanagementtools
...
6. Create Example Score I using SCF. Type 'scoremanagementtools' to start SCF again.
