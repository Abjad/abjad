...
Do the following to install score management tools on your system:

    1. verify score management tools directories
    2. set score management tools environment variables
    3. add abjad/experimental/scr to your PATH
    4. create a scores directory
    5. start and stop score management tools
    6. create Example Score I using score management tools
    7. create Example Score II using score management tools
    7. create Étude Score I using score management tools
    9. run the score management tools py.test battery


1. Verify score management tools directories. The following six directories should be 
on your filesystem:

    abjad/experimental/materials
    abjad/experimental/music
    abjad/experimental/scoremanagementtools
...
the score management tools test battery to run correctly. Set these two user-specific
...
This tells your shell where the scoremanagementtools start-up script is housed:
...
5. Start and stop score management tools. Type ...

    scoremanagementtools

... from the commandline and score management tools should start.
This step hasn't yet been tested on a computer with a brand-new score management tools installation.
What you see here probably won't be very interesting because you
won't yet have any score management tools-managed scores created on your system.
...
If the shell can't find score management tools go back to step #3 and make sure you added
the abjad/experimental/scr directory to your PATH.
After score management tools starts correctly enter 'q' to quit score management tools and return to the shell.


6. Create Example Score I using score management tools. Type 'scoremanagementtools' to start score management tools again.
Once score management tools starts you should see a menu item that says "new score (new)".
...
Quit score management tools once you finish. Check your scores directory. You should
...
7. Create Example Score II using score management tools. Repeat the steps listed for #6, above:

    (1/3) score title: Example Score II
    (2/3) package name: example_score_2
    (3/3) year of completion: 2013

8. Create Étude Score I using score management tools. Repeat the steps listed above for #6 and #7.

Quit score management tools when your are done. score management tools tests parts of the system against 
Example Score I, Example Score II and Étude Score I.
    
9. Run the py.test score management tools battery. You're now in a position to run the score management tools py.test battery.
Just run "py.test in abjad/experimental/scoremanagementtools" the same way you do for every other part
of Abjad. You're ready to read the score management tools code if all tests pass.
'''
