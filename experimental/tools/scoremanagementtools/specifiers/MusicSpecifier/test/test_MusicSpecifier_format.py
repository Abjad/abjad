...
def test_MusicSpecifier_format_01():
    ...
    specifier = scoremanagementtools.specifiers.MusicSpecifier([])
...
def test_MusicSpecifier_format_02():
    ...
    specifier = scoremanagementtools.specifiers.MusicSpecifier([], name='foo')
...
def test_MusicSpecifier_format_03():
    ...
    ms = scoremanagementtools.specifiers.MusicSpecifier([mcs_1, mcs_2])
...
def test_MusicSpecifier_format_04():
    ...
    ms = scoremanagementtools.specifiers.MusicSpecifier([mcs_1, mcs_2], name='blue music')
