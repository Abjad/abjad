...
def test_FileProxy_rename_interactively_01():
    ...
    path_name = os.path.join(os.environ.get('SCORE_MANAGEMENT_TOOLS_PATH'), 'test_file.txt')
    ...
    try:
        ...
        new_path_name = os.path.join(os.environ.get('SCORE_MANAGEMENT_TOOLS_PATH'), 'new_test_file.txt')
