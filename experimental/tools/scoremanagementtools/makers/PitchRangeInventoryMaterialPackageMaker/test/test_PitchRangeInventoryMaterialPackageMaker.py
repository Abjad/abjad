...
def test_PitchRangeInventoryMaterialPackageMaker_01():
    ...
    try:
        ...
        mpp = scoremanagementtools.makers.PitchRangeInventoryMaterialPackageMaker('materials.testpir')
...
def test_PitchRangeInventoryMaterialPackageMaker_02():
    ...
    try:
        ...
        mpp = scoremanagementtools.makers.PitchRangeInventoryMaterialPackageMaker(
            'materials.testpir')
