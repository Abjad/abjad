...
#            session=session)
    ...
    def get_appropriate_material_package_proxy(self,
        ...
        if material_package_maker_class_name is None:
            ...
            command += 'scoremanagertools.makers.{}(material_package_importable_name, session=self.session)'
    ...
    def make_material_package(self, material_package_importable_name, is_interactive=False, tags=None):
        ...
        path = self.package_importable_name_to_package_directory_path(material_package_importable_name)
