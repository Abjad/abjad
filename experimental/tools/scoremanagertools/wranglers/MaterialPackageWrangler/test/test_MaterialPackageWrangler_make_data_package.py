...
def test_MaterialPackageWrangler_make_data_package_01():
    ...
    assert not packagesystemtools.package_exists('built_in_materials.testnumbers')

    try:
        wrangler.make_data_package('built_in_materials.testnumbers')
        assert packagesystemtools.package_exists('built_in_materials.testnumbers')
...
def test_MaterialPackageWrangler_make_data_package_02():
    ...
    wrangler = scoremanagertools.wranglers.MaterialPackageWrangler()
    assert packagesystemtools.package_exists('built_in_materials.red_numbers')
    assert py.test.raises(Exception, "wrangler.make_data_package('built_in_materials.red_numbers')")
...
def test_MaterialPackageWrangler_make_data_package_04():
    ...
    try:
        ...
        wrangler.make_data_package('built_in_materials.testnumbers', tags=tags)
        assert packagesystemtools.package_exists('built_in_materials.testnumbers')
        mpp = scoremanagertools.proxies.MaterialPackageProxy('built_in_materials.testnumbers')
