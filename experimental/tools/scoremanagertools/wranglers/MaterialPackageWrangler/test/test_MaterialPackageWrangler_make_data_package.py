...
def test_MaterialPackageWrangler_make_data_package_01():
    ...
    assert not packagesystemtools.exists('built_in_materials.testnumbers')

    try:
        wrangler.make_data_package('built_in_materials.testnumbers')
        assert packagesystemtools.exists('built_in_materials.testnumbers')
...
def test_MaterialPackageWrangler_make_data_package_02():
    ...
    wrangler = scoremanagertools.wranglers.MaterialPackageWrangler()
    assert packagesystemtools.exists('built_in_materials.red_numbers')
