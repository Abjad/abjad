...
def test_MaterialPackageWrangler_make_data_package_01():
    ...
    assert not wrangler.configuration.packagesystem_path_exists('built_in_materials.testnumbers')

    try:
        wrangler.make_data_package('built_in_materials.testnumbers')
        assert wrangler.configuration.packagesystem_path_exists('built_in_materials.testnumbers')
