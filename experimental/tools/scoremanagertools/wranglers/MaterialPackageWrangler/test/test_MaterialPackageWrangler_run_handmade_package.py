...
def test_MaterialPackageWrangler_run_handmade_package_01():
    ...
    assert not score_manager.configuration.packagesystem_path_exists('built_in_materials.testnotes')

    try:
        score_manager._run(user_input='m h testnotes default default q')
        assert score_manager.configuration.packagesystem_path_exists('built_in_materials.testnotes')
