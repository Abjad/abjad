...
def test_MaterialPackageWrangler_read_only_attributes_02():
    ...
    assert 'materials' in wrangler.list_asset_container_package_importable_names()
    assert 'example_score_1.mus.materials' in wrangler.list_asset_container_package_importable_names()
...
def test_MaterialPackageWrangler_read_only_attributes_03():
    ...
    assert wrangler.current_asset_container_package_importable_name == 'materials'
...
def test_MaterialPackageWrangler_read_only_attributes_04():
    ...
    assert wrangler.list_score_external_asset_container_package_importable_names() == ['materials']
...
def test_MaterialPackageWrangler_read_only_attributes_05():
    ...
    assert 'materials.red_notes' in wrangler.list_score_external_asset_package_importable_names()
...
def test_MaterialPackageWrangler_read_only_attributes_06():
    ...
    assert wrangler.score_internal_asset_container_package_importable_name_infix == 'mus.materials'
...
def test_MaterialPackageWrangler_read_only_attributes_07():
    ...
    assert wrangler.temporary_asset_package_importable_name == 'materials.__temporary_package'
...
def test_MaterialPackageWrangler_read_only_attributes_08():
    ...
    assert 'example_score_1.mus.materials' in wrangler.list_asset_container_package_importable_names()
    assert wrangler.current_asset_container_package_importable_name == 'example_score_1.mus.materials'
    assert wrangler.temporary_asset_package_importable_name == 'example_score_1.mus.materials.__temporary_package'
    path = os.path.join(
