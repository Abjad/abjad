...
def test_MaterialPackageWrangler_make_numeric_sequence_package_01():
    ...
    assert not wrangler.configuration.packagesystem_path_exists('built_in_materials.testsequence')

    try:
        wrangler.make_numeric_sequence_package('built_in_materials.testsequence')
        assert wrangler.configuration.packagesystem_path_exists('built_in_materials.testsequence')
