...
def test_MaterialPackageWrangler_interactively_get_available_material_package_path_01():
    ...
    result = wrangler.interactively_get_available_material_packagesystem_path(pending_user_input='red~notes q')
...
def test_MaterialPackageWrangler_interactively_get_available_material_package_path_03():
    ...
    result = wrangler.interactively_get_available_material_packagesystem_path(pending_user_input='q')
    assert result is None

    result = wrangler.interactively_get_available_material_packagesystem_path(pending_user_input='b')
    assert result is None

    result = wrangler.interactively_get_available_material_packagesystem_path(pending_user_input='home')
    assert result is None
