...
def test_PackageProxy_read_only_attributes_01():
    ...
    package_proxy = scoremanagertools.proxies.PackageProxy('experimental.tools.scoremanagertools.built_in_materials.red_sargasso_measures')
    ...
    assert package_proxy.package_path == 'experimental.tools.scoremanagertools.built_in_materials.red_sargasso_measures'
    ...
    assert package_proxy.parent_package_path == 'built_in_materials'
