...
def test_PackageProxy_read_only_attributes_01():
    ...
    assert package_proxy.initializer_file_name == \
        os.path.join(os.environ.get('SCORE_MANAGER_MATERIALS_DIRECTORY'), 'red_sargasso_measures','__init__.py')
    ...
    assert package_proxy.parent_initializer_file_name == \
        os.path.join(os.environ.get('SCORE_MANAGER_MATERIALS_DIRECTORY'), '__init__.py')
