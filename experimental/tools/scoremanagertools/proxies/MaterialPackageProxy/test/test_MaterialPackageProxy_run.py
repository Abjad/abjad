...
def test_MaterialPackageProxy_run_03():
    ...
    score_manager._run(user_input='all red_example_score m 2 b q')
    assert score_manager._session.transcript.signature == (12, (6, 10))

    score_manager._run(user_input='all red_example_score m 2 home q')
    assert score_manager._session.transcript.signature == (12, (2, 10))

    score_manager._run(user_input='all red_example_score m 2 score q')
    assert score_manager._session.transcript.signature == (12, (4, 10))

    score_manager._run(user_input='all red_example_score m 2 foo q')
