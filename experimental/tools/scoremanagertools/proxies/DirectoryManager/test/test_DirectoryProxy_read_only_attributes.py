...
def test_DirectoryManager_read_only_attributes_01():
    ...
    directory_proxy = scoremanagertools.proxies.DirectoryManager(directory_path)
...
def test_DirectoryManager_read_only_attributes_02():
    ...
    score_manager_configuration = scoremanagertools.scoremanager.ScoreManagerConfiguration()
    directory_path = score_manager_configuration.score_manager_tools_directory_path
    directory_proxy_1 = scoremanagertools.proxies.DirectoryManager(directory_path)
    directory_proxy_2 = scoremanagertools.proxies.DirectoryManager(directory_path)
    directory_proxy_3 = scoremanagertools.proxies.DirectoryManager(
