...
def test_OctaveTranspositionMappingInventoryMaterialPackageMaker_01():
    ...
    try:
        ...
        mpp = scoremanagertools.makers.OctaveTranspositionMappingInventoryMaterialPackageMaker('materials.testoctavetrans')
...
def test_OctaveTranspositionMappingInventoryMaterialPackageMaker_02():
    ...
    try:
        ...
        mpp = scoremanagertools.makers.OctaveTranspositionMappingInventoryMaterialPackageMaker(
