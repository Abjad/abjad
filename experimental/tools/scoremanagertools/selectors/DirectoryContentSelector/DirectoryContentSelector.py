...
class DirectoryContentSelector(Selector):
    ...
    asset_container_filesystem_paths = []
    ...
    def list_items(self):
        ...
        result = []
        for directory_path in self.asset_container_filesystem_paths:
            directory_proxy = DirectoryProxy(filesystem_path=directory_path, session=self._session)
