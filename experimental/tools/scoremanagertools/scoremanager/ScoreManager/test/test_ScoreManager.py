...
def test_ScoreManager_07():
    ...
    assert score_manager._session.transcript[3][1] == ['1073741824', '']
    assert score_manager._session.transcript[4][1] == ['> q', '']
...
def test_ScoreManager_08():
    ...
    assert score_manager._session.transcript[3][1] == ['Expression not executable.', '']
    assert score_manager._session.transcript[4][1] == ['> q', '']
...
def test_ScoreManager_09():
    ...
    assert score_manager._session is score_manager.score_package_wrangler._session
