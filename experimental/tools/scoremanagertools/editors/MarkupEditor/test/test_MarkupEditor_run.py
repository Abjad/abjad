...
def test_MarkupEditor_run_01():
    ...
    editor._run(user_input='''arg '"foo~text~here"' dir up done''')
...
def test_MarkupEditor_run_02():
    ...
    editor = scoremanagertools.editors.MarkupEditor()
    editor._run(user_input='arg foo~text done')
...
def test_MarkupEditor_run_03():
    ...
    editor._run(user_input='arg entirely~new~text name bar direction up done')
