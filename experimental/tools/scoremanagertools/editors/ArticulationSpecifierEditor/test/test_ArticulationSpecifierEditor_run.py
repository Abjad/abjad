...
def test_ArticulationSpecifierEditor_run_01():
    ...
    editor._run(user_input='artic experimental.tools.scoremanagertools.built_in_materials.red_mar done')
    specifier = scoremanagertools.specifiers.ArticulationSpecifier(
        articulation_handler_name='experimental.tools.scoremanagertools.built_in_materials.red_marcati')
