...
def test_ScoreManagerObject_path_to_package_importable_name_01():

    assert score_manager_object.path_to_package_importable_name(os.environ.get('SCORE_MANAGER_MATERIALS_DIRECTORY')) == 'materials'
    assert score_manager_object.path_to_package_importable_name(os.environ.get('SCORE_MANAGER_SPECIFIERS_DIRECTORY')) == 'specifiers'
    assert score_manager_object.path_to_package_importable_name(os.environ.get('SCORE_MANAGER_CHUNKS_DIRECTORY')) == 'sketches'


def test_ScoreManagerObject_path_to_package_importable_name_02():
...
def test_ScoreManagerObject_path_to_package_importable_name_03():
