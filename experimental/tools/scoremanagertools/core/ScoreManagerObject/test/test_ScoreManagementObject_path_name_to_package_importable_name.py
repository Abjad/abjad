...
def test_ScoreManagementObject_path_name_to_package_path_01():

    assert score_manager_object.path_to_package_path(
...
def test_ScoreManagementObject_path_name_to_package_path_02():

    path = os.path.join(scores_directory_path, 'example_score_1')
    assert score_manager_object.path_to_package_path(path) == 'example_score_1'

    path = os.path.join(scores_directory_path, 'example_score_1', 'mus')
    assert score_manager_object.path_to_package_path(path) == 'example_score_1.mus'

    path = os.path.join(scores_directory_path, 'example_score_1', 'mus', 'materials')
    assert score_manager_object.path_to_package_path(path) == 'example_score_1.mus.materials'


def test_ScoreManagementObject_path_name_to_package_path_03():

    path = os.path.join(scores_directory_path, 'example_score_1', 'foo')
    assert score_manager_object.path_to_package_path(path) == 'example_score_1.foo'
