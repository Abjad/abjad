...
def test_directory_path_to_package_path_01():
    ...
    assert packagepathtools.filesystem_path_to_packagesystem_path(
...
def test_directory_path_to_package_path_02():
    ...
    assert packagepathtools.filesystem_path_to_packagesystem_path(directory_path) == 'red_example_score'

    directory_path = os.path.join(user_scores_directory_path, 'red_example_score', 'music')
    assert packagepathtools.filesystem_path_to_packagesystem_path(directory_path) == 'red_example_score.music'

    directory_path = os.path.join(user_scores_directory_path, 'red_example_score', 'music', 'materials')
    assert packagepathtools.filesystem_path_to_packagesystem_path(directory_path) == \
...
def test_directory_path_to_package_path_03():
    ...
    assert packagepathtools.filesystem_path_to_packagesystem_path(directory_path) == 'red_example_score.foo'

    file_path = os.path.join(user_scores_directory_path, 'red_example_score', 'foo.py')
    assert packagepathtools.filesystem_path_to_packagesystem_path(file_path) == 'red_example_score.foo'
