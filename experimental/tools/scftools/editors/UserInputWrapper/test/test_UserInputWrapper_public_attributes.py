...
def test_UserInputWrapper_public_attributes_01():
    ...
    wrapper = scftools.editors.UserInputWrapper()
    ...
    assert wrapper.user_input_module_import_statements == ['from experimental.tools.scftools.editors import UserInputWrapper']
