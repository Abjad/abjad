...
from experimental.tools.scftools.wranglers.PackageWrangler import PackageWrangler
...
class MaterialPackageMakerWrangler(PackageWrangler):
    ...
    def forbidden_package_importable_names(self):
        return ['scftools.makers.' + class_name for class_name in self.forbidden_class_names]

    ### PUBLIC METHODS ###

    def get_asset_proxy(self, package_importable_name):
        from experimental.tools.scftools.proxies.MaterialPackageProxy import MaterialPackageProxy
    ...
    def make_asset_class_file(self, package_short_name, generic_output_name):
        ...
        lines.append('from experimental.tools.scftools.makers.MaterialPackageMaker import MaterialPackageMaker')
        lines.append('from experimental.tools.scftools.editors.UserInputWrapper import UserInputWrapper')
        lines.append('from experimental.tools import scftools')
        lines.append('')
        lines.append('')
