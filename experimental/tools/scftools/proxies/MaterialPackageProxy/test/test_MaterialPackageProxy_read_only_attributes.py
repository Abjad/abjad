...
def test_MaterialPackageProxy_read_only_attributes_01():
    ...
    mpp = scftools.proxies.MaterialPackageProxy('materials.red_numbers')
...
def test_MaterialPackageProxy_read_only_attributes_02():
    ...
    mpp = scftools.makers.SargassoMeasureMaterialPackageMaker('materials.red_sargasso_measures')
    ...
    assert     mpp.material_package_maker is scftools.makers.SargassoMeasureMaterialPackageMaker
...
def test_MaterialPackageProxy_read_only_attributes_03():
    ...
    mpp = scftools.proxies.MaterialPackageProxy('materials.red_notes')
