from experimental.tools.scftools.proxies.BasicModuleProxy import BasicModuleProxy
...
class OutputMaterialModuleProxy(BasicModuleProxy):
    ...
    def remove(self):
        ...
        parent_package_initializer_file_proxy = scftools.proxies.InitializerFileProxy(
        ...
        grandparent_package_initializer = scftools.proxies.InitializerFileProxy(
