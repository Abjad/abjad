...
from experimental.tools.scftools.editors.UserInputWrapper import UserInputWrapper
...
class MaterialPackageMaker(MaterialPackageProxy):
    ...
    def _initialize_user_input_wrapper_in_memory(self):
        ...
        proxy = scftools.proxies.UserInputModuleProxy(user_input_module_importable_name, session=self.session)
