...
def test_Session_read_only_properties_01():
    ...
    assert isinstance(session.complete_transcript, scftools.core.Transcript)
...
def test_Session_read_only_properties_02():
    ...
    assert isinstance(session.current_score_package_proxy, scftools.proxies.ScorePackageProxy)
