...
class SCFObject(object):
    ...
    def __init__(self, session=None):
        from experimental.tools.scftools.core.Session import Session
    ...
    def editors_package_importable_name(self):
        return self.dot_join(['scftools', 'editors'])
    ...
    def specifier_classes_package_importable_name(self):
        return self.dot_join(['scftools', 'specifiers'])
    ...
    def make_getter(self, where=None):
        ...
        return scftools.menuing.UserInputGetter(where=where, session=self.session)
    ...
    def make_menu(self, is_hidden=False, is_internally_keyed=False, is_keyed=True,
        ...
        from experimental.tools import scftools
        menu = scftools.menuing.Menu(where=where, session=self.session)
