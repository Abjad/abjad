...
class ConcreteInterpreter(Interpreter):
    ...
    def counttime_component_selector_to_rhythm_region_expression(
        ...
        assert isinstance(rhythm_material_request, selectortools.CounttimeComponentSelector)
