...
def test_BeatSelector__payload_callbacks_02():
...
def test_BeatSelector__payload_callbacks_03():
...
def test_BeatSelector__payload_callbacks_04():
    '''Repeat to duration.
    '''
...
def test_BeatSelector__payload_callbacks_05():
    '''Repeat to length.
    '''
...
def test_BeatSelector__payload_callbacks_07():
    '''Rotate beats.
    '''
