...
def test_CounttimeComponentSelector__callbacks_01():
    '''Slice leaves.
    '''
...
def test_CounttimeComponentSelector__callbacks_02():
...
def test_CounttimeComponentSelector__callbacks_03():
...
def test_CounttimeComponentSelector__callbacks_04():
    '''Repeat to duration.
    '''
...
def test_CounttimeComponentSelector__callbacks_05():
    '''Repeat to length.
    '''
...
def test_CounttimeComponentSelector__callbacks_06():
    '''Reflect rhythm.
    '''
...
def test_CounttimeComponentSelector__callbacks_07():
...
def test_CounttimeComponentSelector__callbacks_08():
...
def test_CounttimeComponentSelector__callbacks_09():
