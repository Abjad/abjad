...
class SegmentSelector(Selector):
    ...
    ::
        ...
        selectortools.SegmentSelector(
            ...
            callbacks=settingtools.CallbackInventory([
                'result = self.___getitem__(expr, start_offset, slice(None, 2, None))'
                ])
            )
    ...
    ::
        ...
        selectortools.SegmentSelector(
            voice_name='Voice 1',
            callbacks=settingtools.CallbackInventory([
                "result = self.___getitem__(expr, start_offset, slice(None, 'green', None))"
                ])
            )
    ...
    ::
        ...
        selectortools.SegmentSelector(
            voice_name='Voice 1',
            callbacks=settingtools.CallbackInventory([
                "result = self.___getitem__(expr, start_offset, slice(None, ('green', 1), None))"
                ])
            )
    ...
    ::
        ...
        selectortools.SegmentSelector(
            voice_name='Voice 1',
            callbacks=settingtools.CallbackInventory([
                "result = self.___getitem__(expr, start_offset, slice('red', ('red', 1), None))"
                ])
            )
