...
class MaterialPackageMakerWrangler(PackageWrangler):
    ...
    def get_asset_proxy(self, package_importable_name):
        from scftools.proxies.MaterialPackageProxy import MaterialPackageProxy
        ...
        if material_package_maker_class_name is not None:
            ...
            command = 'from scftools.makers import {} as material_package_maker_class'
    ...
    def make_asset_class_file(self, package_short_name, generic_output_name):
        ...
        lines.append('from scftools.makers.MaterialPackageMaker import MaterialPackageMaker')
        lines.append('from scftools.editors.UserInputWrapper import UserInputWrapper')
        lines.append('import scftools')
        lines.append('')
        lines.append('')
