...
class SegmentDivisionList(DivisionList):
    ...
    for the entire score::
        ...
        ... 
        DivisionRegionDivisionList('[3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16]', start_timepoint=None, stop_timepoint=None, fresh=True, truncate=False)
