...
class SegmentDivisionList(DivisionList):
    ...
    for the entire score::
        ...
        ... 
        DivisionRegionDivisionList('[3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16], [3, 16]', start_timepoint=Timepoint(anchor=SingleSegmentSelector(identifier='red'), addendum=Offset(0, 1)), stop_timepoint=Timepoint(anchor=SingleSegmentSelector(identifier='red'), addendum=Offset(21, 8)), fresh=True, truncate=False)
