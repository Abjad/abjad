...
eighths = rhythmmakertools.TaleaFilledRhythmMaker([1], 8)
...
halves = rhythmmakertools.TaleaFilledRhythmMaker([1], 2)
...
quarters = rhythmmakertools.TaleaFilledRhythmMaker([1], 4)
...
sixteenths = rhythmmakertools.TaleaFilledRhythmMaker([1], 16)
sixteenths.beam_cells_together = True
sixteenths.name = 'sixteenths'
__all__.append(sixteenths.name)


sixty_fourths = rhythmmakertools.TaleaFilledRhythmMaker([1], 64)
...
thirty_seconds = rhythmmakertools.TaleaFilledRhythmMaker([1], 32)
