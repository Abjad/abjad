...
def test_BackgroundMeasureSelector__partition_by_ratio_01():
    '''Count ratio part.
    '''
    ...
    left, right = measures.partition_by_ratio_of_lengths((1, 1))
...
def test_BackgroundMeasureSelector__partition_by_ratio_02():
    '''Count ratio part.
    '''
    ...
    measures = red_segment.select_background_measures()
    last_two_measures = measures.partition_by_ratio_of_lengths((1, 1))[-1]
...
def test_BackgroundMeasureSelector__partition_by_ratio_03():
    '''Time ratio part.
    '''
    ...
    red_segment.set_time_signatures([(1, 8), (1, 8), (1, 8), (3, 8)])
    measures = red_segment.select_background_measures()
    last_measure = measures.partition_by_ratio_of_durations((1, 1))[-1]
    red_segment.set_divisions([(2, 32)])
