...
def test_OctaveTranspositionMappingInventoryMaterialPackageMaker_01():
    ...
    try:
        ...
        mpp = scf.makers.OctaveTranspositionMappingInventoryMaterialPackageMaker('materials.testoctavetrans')
...
def test_OctaveTranspositionMappingInventoryMaterialPackageMaker_02():
    ...
    try:
        ...
        mpp = scf.makers.OctaveTranspositionMappingInventoryMaterialPackageMaker(
