...
from experimental.quantizationtools.QGridTempoLookup import QGridTempoLookup
from experimental.quantizationtools._Quantizer import _Quantizer
...
class QGridQuantizer(_Quantizer):
    ...
    ::
        ...
        >>> from experimental.quantizationtools import QGridQuantizer
        >>> q = QGridQuantizer()
