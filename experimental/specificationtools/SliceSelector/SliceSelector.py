...
class SliceSelector(AbjadObject):
    ...
    def __init__(self, container, start=None, stop=None):
        from experimental import specificationtools
        assert isinstance(container, specificationtools.ScoreObjectSelector), repr(container)
