...
def test_multiple_segment_quartet_03():
    ...
    first_half, second_half = red_segment.divide_timespan_by_ratio((1, 1))
    red_segment.set_divisions([(3, 16)], timespan=first_measure, contexts=['Voice 1'], persist=False)
    red_segment.set_divisions([(5, 16)], timespan=second_measure, contexts=['Voice 1'], persist=False)
    red_segment.set_divisions([(5, 16)], timespan=first_measure, contexts=['Voice 2'], persist=False)
    red_segment.set_divisions([(3, 16)], timespan=second_measure, contexts=['Voice 2'], persist=False)
    red_segment.set_divisions([(3, 16)], timespan=first_half, contexts=['Voice 3'], persist=False)
    red_segment.set_divisions([(5, 16)], timespan=second_half, contexts=['Voice 3'], persist=False)
    red_segment.set_divisions([(5, 16)], timespan=first_half, contexts=['Voice 4'], persist=False)
    red_segment.set_divisions([(3, 16)], timespan=second_half, contexts=['Voice 4'], persist=False)
