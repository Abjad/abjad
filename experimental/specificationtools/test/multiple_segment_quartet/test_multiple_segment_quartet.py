...
def test_multiple_segment_quartet_03():
    ...
    first_measure = red_segment.select_background_measure_timespan(stop=1)
    second_measure = red_segment.select_background_measure_timespan(start=-1)
    first_half, second_half = red_segment.select_ratio((1, 1))
