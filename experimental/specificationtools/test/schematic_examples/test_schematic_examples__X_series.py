...
def test_schematic_examples__X_series_04():
    ...
    left = red_segment.select_division_timespan(0, 1)
    middle = red_segment.select_division_timespan(1, 2)
    right = red_segment.select_division_timespan(2, 3)
...
def test_schematic_examples__X_series_05():
    ...
    first_division = red_segment.select_division_timespan(0, 1)
    voice_1_rhythmic_cell = red_segment.request_rhythm('Voice 1', timespan=first_division)
...
def test_schematic_examples__X_series_06():
    ...
    first_division = red_segment.select_division_timespan(0, 1)
    rhythmic_cell = red_segment.request_rhythm('Voice 1', timespan=first_division)
...
def test_schematic_examples__X_series_07():
    ...
    second_measure = red_segment.select_background_measure_timespan(1, 2)
    ...
    timespan = red_segment.select_leaf_timespan(start=4, voice='Voice 1')
    voice_1_rhythm = red_segment.request_rhythm('Voice 1', timespan=timespan)
    voice_2_rhythm = red_segment.request_rhythm('Voice 2', timespan=timespan)
    voice_3_rhythm = red_segment.request_rhythm('Voice 3', timespan=timespan)
    voice_4_rhythm = red_segment.request_rhythm('Voice 4', timespan=timespan)
...
def test_schematic_examples__X_series_08():
    ...
    red_segment = score_specification.append_segment(name='red')
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    first_measure, middle_measure, last_measure = red_segment.select_ratio_of_background_measures((1, 1, 1))
    ...
    timespan = red_segment.select_leaf_timespan(start=-10)
    last_leaves = red_segment.request_rhythm('Voice 1', timespan=timespan)
...
def test_schematic_examples__X_series_09():
    ...
    rhythm = red_segment.request_rhythm('Voice 3', timespan=timespan)
    blue_segment.set_rhythm(rhythm, contexts=['Voice 3'])
    rhythm = red_segment.request_rhythm('Voice 4', timespan=timespan)
