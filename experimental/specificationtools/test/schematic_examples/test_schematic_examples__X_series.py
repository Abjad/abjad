...
def test_schematic_examples__X_series_03():
    ...
    left_measure, right_measure = measures.new_partition_by_ratio((1, 1))
...
def test_schematic_examples__X_series_08():
    ...
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    measures = red_segment.select_background_measures()
    first_measure, middle_measure, last_measure = measures.new_partition_by_ratio((1, 1, 1))
...
def test_schematic_examples__X_series_09():
    ...
    #timespan = red_segment.adjust_offsets(Offset(3, 16), Offset(6, 16))
    timespan = red_segment.select() 
    timespan.adjust_offsets(Offset(3, 16), Offset(6, 16))
