...
def test_schematic_examples__X_series_05():
    ...
    voice_1_rhythmic_cell = red_segment.request_rhythm('Voice 1', selector=first_division)
...
def test_schematic_examples__X_series_06():
    ...
    first_division = red_segment.select_divisions(0, 1)
    rhythmic_cell = red_segment.request_rhythm('Voice 1', selector=first_division)
...
def test_schematic_examples__X_series_07():
    ...
    cell = red_segment.request_rhythm('Voice 1', selector=first_measure)
    ...
    voice_1_rhythm = red_segment.request_rhythm('Voice 1', selector=selector)
    voice_2_rhythm = red_segment.request_rhythm('Voice 2', selector=selector)
    voice_3_rhythm = red_segment.request_rhythm('Voice 3', selector=selector)
    voice_4_rhythm = red_segment.request_rhythm('Voice 4', selector=selector)
...
def test_schematic_examples__X_series_08():
    ...
    last_leaves = red_segment.request_rhythm('Voice 1', selector=selector)
