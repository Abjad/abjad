...
def test_single_segment_solo__incomplete_rhythm_coverage_01():
    ...
    selector = red_segment.select_background_measure_timespan(1, 2)
...
def test_single_segment_solo__incomplete_rhythm_coverage_02():
    ...
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    red_segment.set_divisions([(3, 16)])
    selector = red_segment.select_background_measure_timespan(0, 1)
    red_segment.set_rhythm(library.sixteenths, selector=selector)
    selector = red_segment.select_background_measure_timespan(-1)
    red_segment.set_rhythm(library.thirty_seconds, selector=selector)
    score = score_specification.interpret()
...
def test_single_segment_solo__incomplete_rhythm_coverage_03():
    ...
    selector = red_segment.select_background_measure_timespan(1, 2)
    red_segment.set_rhythm(library.thirty_seconds, selector=selector)
    red_segment.set_rhythm(library.sixteenths, contexts=['Voice 1'], selector=selector)
    score = score_specification.interpret()
...
def test_single_segment_solo__incomplete_rhythm_coverage_05():
    ...
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    red_segment.set_divisions([(3, 16)])
    selector = red_segment.select_background_measure_timespan(start=-2)
    red_segment.set_rhythm(library.sixteenths, selector=selector)
    selector = red_segment.select_background_measure_timespan(start=-1)
    red_segment.set_rhythm(library.thirty_seconds, selector=selector)
    score = score_specification.interpret()
