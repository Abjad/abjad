...
def test_single_segment_solo__rhythm_context_cascade_01():
    ...
    red_segment.set_rhythm(library.note_filled_tokens, contexts=['Voice 1'])
...
def test_single_segment_solo__rhythm_context_cascade_03():
    ...
    red_segment.set_rhythm(library.thirty_seconds)
    red_segment.set_rhythm(library.note_filled_tokens, contexts=['Voice 1'])
    red_segment.set_rhythm(library.rest_filled_tokens, contexts=['Voice 1'])
    score = score_specification.interpret()
...
def test_single_segment_solo__rhythm_context_cascade_05():
    ...
    red_segment.set_divisions([(3, 16)])
    red_segment.set_rhythm(library.sixteenths)
    selector = red_segment.select_background_measure(1)
