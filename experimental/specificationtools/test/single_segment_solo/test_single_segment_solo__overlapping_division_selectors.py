...
def test_single_segment_solo__overlapping_division_selectors_03():
    ...
    red_segment = score_specification.append_segment(name='red') 
    red_segment.set_time_signatures([(4, 8), (3, 8)])
    first_measure = red_segment.select_background_measure_timespan(1, 2)
    red_segment.set_divisions([(3, 16)], selector=first_measure)
    red_segment.set_divisions([(1, 16)])
    red_segment.set_rhythm(library.thirty_seconds)
    score = score_specification.interpret()
...
def test_single_segment_solo__overlapping_division_selectors_04():
    ...
    red_segment = score_specification.append_segment(name='red') 
    red_segment.set_time_signatures([(4, 8), (3, 8)])
    last_measure = red_segment.select_background_measure_timespan(1, 2)
    red_segment.set_divisions([(3, 16)])
...
def test_single_segment_solo__overlapping_division_selectors_06():
    ...
    red_segment = score_specification.append_segment(name='red') 
    red_segment.set_time_signatures([(4, 8), (3, 8), (2, 8)])
    middle_measure = red_segment.select_segment_ratio((4, 3, 2))[1]
    red_segment.set_divisions([(3, 16)])
    red_segment.set_divisions([(1, 16)], selector=middle_measure)
    red_segment.set_rhythm(library.thirty_seconds)
    score = score_specification.interpret()
