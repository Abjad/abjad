...
def test_SegmentSpecification__request_rhythm_from_future_between_voices_01():
    ...
    blue_voice_2_rhythm = blue_segment.request_rhythm('Voice 2')
...
def test_SegmentSpecification__request_rhythm_from_future_between_voices_02():
    ...
    red_segment.set_divisions([(2, 16), (3, 16)], contexts=['Voice 1'])
    red_segment.set_divisions([(2, 16), (5, 16)], contexts=['Voice 2'])
    blue_voice_2_rhythm = blue_segment.request_rhythm('Voice 2', reverse=True)
    red_segment.set_rhythm(blue_voice_2_rhythm, contexts=['Voice 1'])
    red_segment.set_rhythm(library.sixteenths)
...
def test_SegmentSpecification__request_rhythm_from_future_between_voices_03():
    ...
    red_segment.set_divisions([(2, 16), (5, 16)], contexts=['Voice 2'])
    blue_voice_2_rhythm = blue_segment.request_rhythm('Voice 2')
    red_segment.set_rhythm(blue_voice_2_rhythm, contexts=['Voice 1'], reverse=True)
    red_segment.set_rhythm(library.sixteenths)
...
def test_SegmentSpecification__request_rhythm_from_future_between_voices_04():
