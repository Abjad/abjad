...
def test_SegmentSpecification_request_rhythm_from_past_between_voices_01():
...
def test_SegmentSpecification_request_rhythm_from_past_between_voices_02():
    ...
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
    red_voice_2_rhythm = red_segment.request_rhythm('Voice 2', reverse=True)
    blue_segment.set_rhythm(red_voice_2_rhythm, contexts=['Voice 1'])
...
def test_SegmentSpecification_request_rhythm_from_past_between_voices_03():
    ...
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
    red_voice_2_rhythm = red_segment.request_rhythm('Voice 2')
    blue_segment.set_rhythm(red_voice_2_rhythm, contexts=['Voice 1'], reverse=True)
