...
def test_SegmentSpecification_get_timespan_from_measures_01():
    ...
    segment.set_divisions_new([(5, 16)], timespan=first_measure, contexts=['Voice 2'])
    segment.set_divisions_new([(3, 16)], timespan=second_measure, contexts=['Voice 2'])

    segment.set_divisions_new([(3, 16)], timespan=first_half, contexts=['Voice 3'])
    segment.set_divisions_new([(5, 16)], timespan=second_half, contexts=['Voice 3'])

    segment.set_divisions_new([(5, 16)], timespan=first_half, contexts=['Voice 4'])
    segment.set_divisions_new([(3, 16)], timespan=second_half, contexts=['Voice 4'])
