...
def test_SegmentSpecification_request_division_command_from_past_between_voices_01():
    ...
    red_voice_2_division_command = red_segment.request_division_command('Voice 2')
...
def test_SegmentSpecification_request_division_command_from_past_between_voices_02():
    ...
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
    red_voice_2_division_command = red_segment.request_division_command('Voice 2', reverse=True)
    blue_segment.set_divisions(red_voice_2_division_command, contexts=['Voice 1'])
...
def test_SegmentSpecification_request_division_command_from_past_between_voices_03():
    ...
    blue_segment.set_time_signatures([(3, 8), (3, 8)])
    red_voice_2_division_command = red_segment.request_division_command('Voice 2')
    blue_segment.set_divisions(red_voice_2_division_command, contexts=['Voice 1'], reverse=True)
...
def test_SegmentSpecification_request_division_command_from_past_between_voices_04():
