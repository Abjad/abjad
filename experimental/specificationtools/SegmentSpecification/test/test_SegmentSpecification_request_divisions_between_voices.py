...
def test_SegmentSpecification_request_divisions_between_voices_01():
...
def test_SegmentSpecification_request_divisions_between_voices_02():
...
def test_SegmentSpecification_request_divisions_between_voices_03():
    ...
    red_segment.set_divisions([(5, 16), (3, 16)], contexts=['Voice 2'])
    voice_2_divisions = red_segment.request_divisions('Voice 2')
    red_segment.set_divisions(voice_2_divisions, contexts=['Voice 1'], reverse=True)
    red_segment.set_rhythm(library.sixteenths)
...
def test_SegmentSpecification_request_divisions_between_voices_04():
