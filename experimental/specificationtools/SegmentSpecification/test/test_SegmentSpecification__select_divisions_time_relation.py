...
def test_SegmentSpecification__select_divisions_time_relation_01():
    ...
    divisions_that_stop_during_red = red_segment.select_divisions(time_relation=time_relation)
    divisions_that_stop_during_blue = blue_segment.select_divisions(time_relation=time_relation)
