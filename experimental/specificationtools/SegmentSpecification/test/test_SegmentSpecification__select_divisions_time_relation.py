...
def test_SegmentSpecification__select_divisions_time_relation_01():
    ...
    inequality = timerelationtools.timespan_2_stops_during_timespan_1
    divisions_that_stop_during_red = red_segment.select_divisions(inequality=inequality)
    divisions_that_stop_during_blue = blue_segment.select_divisions(inequality=inequality)
