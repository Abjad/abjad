...
def test_SegmentSpecification_select_background_measures_01():
    ...
    segment.set_divisions_new([(3, 32)], timespan=last_two_measures)
...
def test_SegmentSpecification_select_background_measures_02():
    ...
    segment.set_divisions_new([(2, 32)])
    segment.set_divisions_new([(3, 32)], timespan=first_two_measures)
    segment.set_rhythm(library.thirty_seconds)
    score = score_specification.interpret()
...
def test_SegmentSpecification_select_background_measures_03():
    ...
    segment.set_divisions_new([(2, 32)])
    segment.set_divisions_new([(3, 32)], timespan=middle_measure)
    segment.set_rhythm(library.thirty_seconds)
    score = score_specification.interpret()
