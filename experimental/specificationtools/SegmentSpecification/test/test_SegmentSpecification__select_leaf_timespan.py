...
def test_SegmentSpecification__select_leaf_timespan_01():
    ...
    timespan = red_segment.select_leaf_timespan(start=2, stop=4)
...
def test_SegmentSpecification__select_leaf_timespan_02():
    ...
    timespan = red_segment.select_leaf_timespan(start=4, stop=7)
...
def test_SegmentSpecification__select_leaf_timespan_03():
    ...
    blue_segment = score_specification.append_segment(name='blue')
    blue_segment.set_time_signatures(2 * [(2, 8)])
    timespan = red_segment.select_leaf_timespan(start=4, stop=8)
    voice_1_rhythm = red_segment.request_rhythm('Voice 1', timespan=timespan)
    blue_segment.set_rhythm(voice_1_rhythm, contexts=['Voice 1'])
    score = score_specification.interpret()
