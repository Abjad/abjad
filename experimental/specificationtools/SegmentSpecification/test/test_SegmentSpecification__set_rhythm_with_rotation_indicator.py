...
def test_SegmentSpecification__set_rhythm_with_rotation_indicator_01():
    ...
    red_segment.set_rhythm(library.eighths, timespan=first_division)
    red_segment.set_rhythm(library.sixteenths, timespan=second_division)
    red_segment.set_rhythm(library.thirty_seconds, timespan=third_division)
