...
def test_SegmentSpecification_request_division_command_from_past_01():
...
def test_SegmentSpecification_request_division_command_from_past_02():
    ...
    blue_segment = score_specification.make_segment(name='blue')
    blue_segment.set_time_signatures([(4, 8), (5, 8)])
    red_division_command = red_segment.request_division_command('Voice 1', reverse=True)
    blue_segment.set_divisions(red_division_command)
...
def test_SegmentSpecification_request_division_command_from_past_03():
    ...
    blue_segment.set_time_signatures([(4, 8), (5, 8)])
    red_division_command = red_segment.request_division_command('Voice 1')
    blue_segment.set_divisions(red_division_command, reverse=True)
...
def test_SegmentSpecification_request_division_command_from_past_04():
