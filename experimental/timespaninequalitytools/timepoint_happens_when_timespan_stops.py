def timepoint_happens_when_timespan_stops(timespan=None, timepoint=None, hold=False):
    r'''.. versionadded:: 1.0
    ...
    Make timepoint inequality indicating that `timepoint` happens when `timespan` stops::

        >>> timespaninequalitytools.timepoint_happens_when_timespan_stops()
