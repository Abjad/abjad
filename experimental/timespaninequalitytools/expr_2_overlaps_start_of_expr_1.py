def expr_2_overlaps_start_of_expr_1(expr_1=None, expr_2=None, hold=False):
    r'''.. versionadded:: 1.0
    ...
    ::
        ...
        >>> timespaninequalitytools.expr_2_overlaps_start_of_expr_1()
        TimespanInequality('expr_2.start < expr_1.start < expr_2.stop')
    ...
    timespan_inequality = timespaninequalitytools.TimespanInequality(
        'expr_2.start < expr_1.start < expr_2.stop',
        expr_1=expr_1, 
        expr_2=expr_2)
