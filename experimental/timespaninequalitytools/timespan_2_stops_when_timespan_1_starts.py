def timespan_2_stops_when_timespan_1_starts(expr_1=None, expr_2=None, hold=False):
    r'''.. versionadded:: 1.0
    ...
    ::
        ...
        >>> timespaninequalitytools.timespan_2_stops_when_timespan_1_starts()
        TimespanInequality('expr_2.stop == expr_1.start')
