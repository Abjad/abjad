def timespan_2_intersects_timespan_1(timespan_1=None, timespan_2=None, hold=False):
    ...
    ::
        ...
        >>> timespaninequalitytools.timespan_2_intersects_timespan_1()
        TimespanInequality('timespan_1.start <= timespan_2.start < timespan_2.stop or timespan_1.start < timespan_2.stop <= timespan_2.stop or timespan_1.start < timespan_2.start < timespan_1.stop < timespan_2.stop')
    ...
    timespan_inequality = timespaninequalitytools.TimespanInequality(
        'timespan_1.start <= timespan_2.start < timespan_2.stop or '
        'timespan_1.start < timespan_2.stop <= timespan_2.stop or '
