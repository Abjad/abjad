def timespan_2_stops_after_timespan_1_stops(expr_1=None, expr_2=None, hold=False):
    r'''.. versionadded:: 1.0
    ...
    ::
        ...
        >>> timespaninequalitytools.timespan_2_stops_after_timespan_1_stops()
        TimespanInequality('expr_1.stop < expr_2.stop')
