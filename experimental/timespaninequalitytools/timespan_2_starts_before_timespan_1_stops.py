def timespan_2_starts_before_timespan_1_stops(expr_1=None, expr_2=None, hold=False):
    r'''.. versionadded:: 1.0
    ...
    ::
        ...
        >>> timespaninequalitytools.timespan_2_starts_before_timespan_1_stops()
        TimespanInequality('expr_2.start < expr_1.stop')
