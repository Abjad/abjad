def timespan_2_overlaps_stop_of_timespan_1_only(expr_1=None, expr_2=None, hold=False):
    r'''.. versionadded:: 1.0
    ...
    ::
        ...
        >>> timespaninequalitytools.timespan_2_overlaps_stop_of_timespan_1_only()
        TimespanInequality('expr_1.start <= expr_2.start < expr_1.stop < expr_2.stop')
