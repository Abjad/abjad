...
def test_Selection___copy___01():
    ...
    selection_1 = selectortools.Selection(contexts=['Voice 1', 'Voice 3'], timespan=timespan)
    selection_2 = copy.deepcopy(selection_1)

    assert isinstance(selection_1, selectortools.Selection)
    assert isinstance(selection_2, selectortools.Selection)
