...
class TimespanInequality(object):
    """
    Timespan inequality.
    ...
    def __init__(self, template=None):
        template = (
            template or "timespan_1.start_offset < timespan_2.start_offset"
        )
    ...
    def evaluate_offset_inequality(
        ...
        template = template.replace("timespan.stop", make_repr(timespan_stop))
        template = template.replace("offset", make_repr(offset))
        truth_value = eval(template, {"Offset": abjad.Offset})
        return truth_value
    ...
    def get_offset_indices(
        ...
        # 1.a
        if inequality == "timespan_1.start_offset == timespan_2.start_offset":
            try:
                ...
                pass
        # 1.b
        elif inequality == "timespan_1.start_offset < timespan_2.start_offset":
            try:
        ...
        # 1.c
            ...
            inequality == "timespan_1.start_offset <= timespan_2.start_offset"
        ):
            try:
                ...
                pass
        # 2.a
        elif inequality == "timespan_1.start_offset == timespan_2.stop_offset":
            try:
                leftmost_index = self._find_index(
        ...
        # 2.c
            ...
            try:
                ...
                pass
        # 3.a
        elif inequality == "timespan_1.stop_offset == timespan_2.start_offset":
            try:
                leftmost_index = self._find_index(
        ...
        # 3.c
            ...
            try:
                ...
                pass
        # 4.a
        elif inequality == "timespan_1.stop_offset == timespan_2.stop_offset":
            try:
                leftmost_index = self._find_index(
                    timespan_2_start_offsets, timespan_1.stop_offset
                )
        ...
        # 5.a
            ...
            try:
                ...
                pass
        # 5.b
        elif inequality == "timespan_2.start_offset < timespan_1.start_offset":
            try:
                leftmost_index = 0
        ...
        # 5.c
            ...
            try:
                ...
                pass
        # 6.a
        elif inequality == "timespan_2.start_offset == timespan_1.stop_offset":
            try:
                leftmost_index = self._find_index(
                    timespan_2_start_offsets, timespan_1.stop_offset
                )
        ...
        # 6.c
            ...
            try:
                ...
                pass
        # 7.a
        elif inequality == "timespan_2.stop_offset == timespan_1.start_offset":
            try:
                leftmost_index = self._find_index(
                    timespan_2_stop_offsets, timespan_1.start_offset
                )
        ...
        # 7.c
            ...
            try:
                ...
                pass
        # 8.a
        elif inequality == "timespan_2.stop_offset == timespan_1.stop_offset":
            try:
                leftmost_index = self._find_index(
                    timespan_2_stop_offsets, timespan_1.stop_offset
                )
