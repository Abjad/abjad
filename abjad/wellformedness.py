...
class Wellformedness(object):
    ...
    def check_beamed_long_notes(self, argument=None) -> typing.Tuple[typing.List, int]:
        ...
        ..  container:: example
            ...
            >>> print(abjad.Wellformedness.tabulate_wellformedness(voice))
    ...
    def check_notes_on_wrong_clef(
        ...
        ..  container:: example
            ...
            >>> print(abjad.Wellformedness.tabulate_wellformedness(staff))
            0 /	4 beamed long notes
            0 /	5 duplicate ids
            0 /	1 empty containers
            0 /	5 missing parents
    ...
    def tabulate_wellformedness(
        ...
        """
        triples = Wellformedness()(component)
        strings = []
...
def wellformed(
    ...
    """
    for violators, total, check_name in Wellformedness()(component):
        if eval(check_name) is not True:
            continue
        if violators:
            return False
