...
class IntervalVector(Vector):
    ...
    @classmethod
    def from_pitches(class_, pitches, item_class=None) -> "IntervalVector":
        """
        Initializes interval vector from ``pitches``.
        """
        pitch_segment = PitchSegment.from_pitches(pitches)
...
class IntervalClassVector(Vector):
    ...
    @classmethod
    def from_pitches(class_, pitches, item_class=None) -> "IntervalClassVector":
        """
        Makes interval-class vector from ``pitches``.
        ...
        ..  container:: example
            ...
            >>> vector = abjad.IntervalClassVector.from_pitches(
...
class PitchClassVector(Vector):
    ...
    @classmethod
    def from_pitches(class_, pitches, item_class=None) -> "PitchClassVector":
        """
        Makes pitch-class vector from ``pitches``.
        """
        pitch_segment = PitchSegment.from_pitches(pitches)
        return class_(pitch_segment, item_class=item_class)
...
class PitchVector(Vector):
    ...
    @classmethod
    def from_pitches(class_, pitches, item_class=None) -> "PitchVector":
        """
        Makes pitch vector from ``pitches``.
        """
        pitch_segment = PitchSegment.from_pitches(pitches)
        return class_(pitch_segment, item_class=item_class)
