...
def populate(
    ...
    *,
    ...
    """
    Populates rhythm-tree container ``rtc`` as meter.
    ...
    above.
    """
    assert isinstance(rtc, RhythmTreeContainer)
    ...
    if factors:
        ...
        if factor in (2, 3, 4):
            ...
            for part in parts:
                ...
                grouping = RhythmTreeContainer(pair_)
                if factors:
                    for _ in range(part):
                        rtc_ = RhythmTreeContainer(pair)
