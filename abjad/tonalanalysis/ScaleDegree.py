...
class ScaleDegree(AbjadValueObject):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.ScaleDegree('#4')
        ScaleDegree('#4')
    ...
    def __eq__(self, argument):
        ...
        ..  container:: example
            ...
            >>> degree_1 = abjad.tonalanalysis.ScaleDegree('#4')
            >>> degree_2 = abjad.tonalanalysis.ScaleDegree('#4')
            >>> degree_3 = abjad.tonalanalysis.ScaleDegree(5)
    ...
    def __str__(self):
        ...
        ..  container:: example
            ...
            >>> str(abjad.tonalanalysis.ScaleDegree('#4'))
            '#4'
    ...
    def from_accidental_and_number(accidental, number):
        ...
        ..  container:: example
            ...
            >>> class_ = abjad.tonalanalysis.ScaleDegree
    ...
    def accidental(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ScaleDegree('#4').accidental
            Accidental('sharp')
    ...
    def name(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ScaleDegree(1).name
            'tonic'
            >>> abjad.tonalanalysis.ScaleDegree(2).name
            'superdominant'
            >>> abjad.tonalanalysis.ScaleDegree(3).name
            'mediant'
            >>> abjad.tonalanalysis.ScaleDegree(4).name
            'subdominant'
            >>> abjad.tonalanalysis.ScaleDegree(5).name
            'dominant'
            >>> abjad.tonalanalysis.ScaleDegree(6).name
            'submediant'
            >>> abjad.tonalanalysis.ScaleDegree(7).name
            'leading tone'
    ...
    def number(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ScaleDegree('#4').number
            4
    ...
    def roman_numeral_string(self):
        ...
        ..  container:: example
            ...
            >>> degree = abjad.tonalanalysis.ScaleDegree('#4')
    ...
    def string(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ScaleDegree('b4').string
            'b4'

            >>> abjad.tonalanalysis.ScaleDegree('4').string
            '4'
    ...
    def title_string(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ScaleDegree('b4').title_string
            'FlatFour'

            >>> abjad.tonalanalysis.ScaleDegree('4').title_string
            'Four'
