...
class ChordExtent(AbjadValueObject):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.ChordExtent(7)
        ChordExtent(7)
    ...
    ..  container:: example
        ...
        >>> extent = abjad.tonalanalysis.ChordExtent(7)
        >>> abjad.tonalanalysis.ChordExtent(extent)
        ChordExtent(7)
    ...
    def __eq__(self, argument):
        ...
        ..  container:: example
            ...
            >>> extent_1 = abjad.tonalanalysis.ChordExtent(5)
            >>> extent_2 = abjad.tonalanalysis.ChordExtent(5)
            >>> extent_3 = abjad.tonalanalysis.ChordExtent(7)
    ...
    def name(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordExtent(5).name
            'triad'

            >>> abjad.tonalanalysis.ChordExtent(7).name
            'seventh'
    ...
    def number(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordExtent(7).number
            7
