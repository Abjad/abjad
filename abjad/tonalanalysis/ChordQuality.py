...
class ChordQuality(AbjadValueObject):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.ChordQuality('major')
        ChordQuality('major')
    ...
    ..  container:: example
        ...
        >>> quality = abjad.tonalanalysis.ChordQuality('major')
        >>> abjad.tonalanalysis.ChordQuality(quality)
        ChordQuality('major')
    ...
    def __eq__(self, argument):
        ...
        ..  container:: example
            ...
            >>> quality_1 = abjad.tonalanalysis.ChordQuality('major')
            >>> quality_2 = abjad.tonalanalysis.ChordQuality('major')
            >>> quality_3 = abjad.tonalanalysis.ChordQuality('dominant')
    ...
    def is_uppercase(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordQuality('major').is_uppercase
            True

            >>> abjad.tonalanalysis.ChordQuality('minor').is_uppercase
            False
    ...
    def quality_string(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordQuality('major').quality_string
            'major'

            >>> abjad.tonalanalysis.ChordQuality('minor').quality_string
            'minor'
