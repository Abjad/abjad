...
class TonalAnalysis(system.AbjadObject):
    ...
    def _analyze_chord(argument):
        ...
        for x in range(len(ordered_npcs)):
            ...
            return None
        root = ordered_npcs[0]
        class_ = tonalanalysis.RootlessChordClass
        ...
        return tonalanalysis.RootedChordClass(
            root,
    ...
    def _analyze_incomplete_tonal_function(argument, key_signature):
        import abjad
        from abjad import tonalanalysis
        if isinstance(argument, tonalanalysis.RootedChordClass):
        ...
        scale = tonalanalysis.Scale(key_signature)
        ...
        class_ = tonalanalysis.RomanNumeral
