...
class RootedChordClass(PitchClassSet):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.RootedChordClass('g', 'major')
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.RootedChordClass('g', 'dominant', 7)
    ...
    def __init__(
        ...
        chord_quality = tonalanalysis.RootlessChordClass(
    ...
    def bass(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass('g', 'major').bass
            NamedPitchClass('g')
    ...
    def cardinality(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass('g', 'dominant', 7).cardinality
            4
    ...
    def chord_quality(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass('g', 'dominant', 7).chord_quality
    ...
    def extent(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass('g', 'dominant', 7).extent
            ChordExtent(7)
        ...
        return tonalanalysis.ChordExtent(extent)
    ...
    def inversion(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass('g', 'dominant', 7).inversion
            0
    ...
    def markup(self):
        ...
        ..  container:: example
            ...
            >>> markup = abjad.tonalanalysis.RootedChordClass('g', 'dominant', 7).markup
    ...
    def quality_pair(self):
        ...
        ..  container:: example
            ...
            >>> chord_class = abjad.tonalanalysis.RootedChordClass(
            ...     'c',
            ...     'major',
            ...     'triad',
            ...     'root',
    ...
    def cardinality_to_extent(cardinality):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass.cardinality_to_extent(3)
            5
            >>> abjad.tonalanalysis.RootedChordClass.cardinality_to_extent(4)
            7
            >>> abjad.tonalanalysis.RootedChordClass.cardinality_to_extent(5)
            9
            >>> abjad.tonalanalysis.RootedChordClass.cardinality_to_extent(6)
            11
            >>> abjad.tonalanalysis.RootedChordClass.cardinality_to_extent(7)
            13
    ...
    def extent_to_cardinality(extent):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_cardinality(5)
            3
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_cardinality(7)
            4
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_cardinality(9)
            5
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_cardinality(11)
            6
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_cardinality(13)
            7
    ...
    def extent_to_extent_name(extent):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_extent_name(5)
            'triad'
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_extent_name(7)
            'seventh'
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_extent_name(9)
            'ninth'
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_extent_name(11)
            'eleventh'
            >>> abjad.tonalanalysis.RootedChordClass.extent_to_extent_name(13)
            'thirteenth'
