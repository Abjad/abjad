...
class Scale(PitchClassSegment):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.Scale(('c', 'minor'))
    ...
    def dominant(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).dominant
            NamedPitchClass('g')
    ...
    def key_signature(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).key_signature
    ...
    def leading_tone(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).leading_tone
            NamedPitchClass('bf')
    ...
    def mediant(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).mediant
            NamedPitchClass('ef')
    ...
    def named_interval_class_segment(self):
        ...
        ..  container:: example
            ...
            >>> scale = abjad.tonalanalysis.Scale(('d', 'dorian'))
            >>> str(scale.named_interval_class_segment)
            '<+M2, +m2, +M2, +M2, +M2, +m2, +M2>'
    ...
    def subdominant(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).subdominant
            NamedPitchClass('f')
    ...
    def submediant(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).submediant
            NamedPitchClass('af')
    ...
    def superdominant(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).superdominant
            NamedPitchClass('d')
    ...
    def tonic(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.Scale(('c', 'minor')).tonic
            NamedPitchClass('c')
    ...
    def make_notes(self, n, written_duration=(1, 8)):
        ...
        ..  container:: example
            ...
            >>> scale = abjad.tonalanalysis.Scale(('c', 'major'))
    ...
    def make_score(self):
        ...
        ..  container:: example
            ...
            >>> scale = abjad.tonalanalysis.Scale(('E', 'major'))
    ...
    def scale_degree_to_named_pitch_class(self, scale_degree):
        ...
        """
        import abjad
        scale_degree = abjad.tonalanalysis.ScaleDegree(scale_degree)
    ...
    def voice_scale_degrees_in_open_position(self, scale_degrees):
        ...
        scale_degrees = [tonalanalysis.ScaleDegree(x)
