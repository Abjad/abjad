...
class RomanNumeral(AbjadValueObject):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.RomanNumeral('bII6/4')
        RomanNumeral('bII6/4')
    ...
    ..  container:: example
        ...
        >>> roman_numeral = abjad.tonalanalysis.RomanNumeral('bII')
    ...
    def __init__(self, symbol='V7'):
        ...
        scale_degree = tonalanalysis.ScaleDegree(scale_degree)
        ...
        if not suspension:
            ...
            suspension = tonalanalysis.ChordSuspension(suspension[0])
    ...
    def __eq__(self, argument):
        ...
        ..  container:: example
            ...
            >>> roman_numeral_1 = abjad.tonalanalysis.RomanNumeral('I')
            >>> roman_numeral_2 = abjad.tonalanalysis.RomanNumeral('I')
            >>> roman_numeral_3 = abjad.tonalanalysis.RomanNumeral('V7')
    ...
    def _get_quality_symbol(self):
        from abjad import tonalanalysis
        if self.extent == tonalanalysis.ChordExtent(5):
            if self.quality == tonalanalysis.ChordQuality('diminished'):
                return 'o'
            elif self.quality == tonalanalysis.ChordQuality('augmented'):
                return '+'
            else:
                return ''
        elif self.extent == tonalanalysis.ChordExtent(7):
            if self.quality == tonalanalysis.ChordQuality('dominant'):
                return ''
            elif self.quality == tonalanalysis.ChordQuality('major'):
                return 'M'
            elif self.quality == \
                tonalanalysis.ChordQuality('diminished'):
                return 'o'
            elif self.quality == \
                tonalanalysis.ChordQuality('half diminished'):
                return '@'
            elif self.quality == tonalanalysis.ChordQuality('augmented'):
                return '+'
            else:
    ...
    def bass_scale_degree(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII6/4').bass_scale_degree
            ScaleDegree('6')

            >>> abjad.tonalanalysis.RomanNumeral('V7').bass_scale_degree
            ScaleDegree('5')
        ...
        bass_scale_degree %= 7
        bass_scale_degree += 1
        bass_scale_degree = tonalanalysis.ScaleDegree(bass_scale_degree)
    ...
    def extent(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII').extent
            ChordExtent(5)
    ...
    def figured_bass_string(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('II6/5').figured_bass_string
            '6/5'
    ...
    def inversion(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII').inversion
            ChordInversion(0)
    ...
    def markup(self):
        ...
        ..  container:: example
            ...
            >>> markup = abjad.tonalanalysis.RomanNumeral('bII').markup
    ...
    def quality(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII').quality
            ChordQuality('major')
    ...
    def root_scale_degree(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII').root_scale_degree
            ScaleDegree('b2')

            >>> abjad.tonalanalysis.RomanNumeral('bII6/4').root_scale_degree
            ScaleDegree('b2')
    ...
    def suspension(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII6/4').suspension is None
            True

            >>> abjad.tonalanalysis.RomanNumeral('V7').suspension is None
            True
    ...
    def symbol(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.RomanNumeral('bII6/4').symbol
            'bII6/4'

            >>> abjad.tonalanalysis.RomanNumeral('V7').symbol
            'V7'
