...
class ChordInversion(AbjadValueObject):
    ...
    ..  container:: example
        ...
        >>> abjad.tonalanalysis.ChordInversion(1)
        ChordInversion(1)
    ...
    def __eq__(self, argument):
        ...
        ..  container:: example
            ...
            >>> inversion_1 = abjad.tonalanalysis.ChordInversion(0)
            >>> inversion_2 = abjad.tonalanalysis.ChordInversion(0)
            >>> inversion_3 = abjad.tonalanalysis.ChordInversion(1)
    ...
    def extent_to_figured_bass_string(self, extent):
        ...
        ..  container:: example
            ...
            >>> inversion = abjad.tonalanalysis.ChordInversion(0)
            >>> inversion.extent_to_figured_bass_string(5)
            ''
            >>> inversion.extent_to_figured_bass_string(7)
            '7'

            >>> inversion = abjad.tonalanalysis.ChordInversion(1)
            >>> inversion.extent_to_figured_bass_string(5)
            '6'
            >>> inversion.extent_to_figured_bass_string(7)
            '6/5'

            >>> inversion = abjad.tonalanalysis.ChordInversion(2)
            >>> inversion.extent_to_figured_bass_string(5)
            '6/4'
            >>> inversion.extent_to_figured_bass_string(7)
            '4/3'

            >>> inversion = abjad.tonalanalysis.ChordInversion(3)
            >>> inversion.extent_to_figured_bass_string(7)
            '4/2'
    ...
    def name(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordInversion(0).name
            'root position'

            >>> abjad.tonalanalysis.ChordInversion(1).name
            'first'

            >>> abjad.tonalanalysis.ChordInversion(2).name
            'second'
    ...
    def number(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordInversion(0).number
            0

            >>> abjad.tonalanalysis.ChordInversion(1).number
            1

            >>> abjad.tonalanalysis.ChordInversion(2).number
            2
    ...
    def title(self):
        ...
        ..  container:: example
            ...
            >>> abjad.tonalanalysis.ChordInversion(0).title
            'RootPosition'

            >>> abjad.tonalanalysis.ChordInversion(1).title
            'FirstInversion'

            >>> abjad.tonalanalysis.ChordInversion(2).title
            'SecondInversion'
