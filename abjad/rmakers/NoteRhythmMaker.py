...
class NoteRhythmMaker(RhythmMaker):
    ...
    def burnish_specifier(self) -> typing.Optional[BurnishSpecifier]:
        ...
        ..  container:: example
            ...
            >>> rhythm_maker = abjad.rmakers.NoteRhythmMaker(
            ...     burnish_specifier=abjad.rmakers.BurnishSpecifier(
    ...
    def division_masks(self) -> typing.Optional[typing.List[Pattern]]:
        ...
        ..  container:: example
            ...
            >>> mask = abjad.rmakers.SilenceMask(
    ...
    def duration_specifier(self) -> typing.Optional[DurationSpecifier]:
        ...
        ..  container:: example
            ...
            >>> partition_table = abjad.rmakers.PartitionTable([
            ...     (5, [3, 2]),
            ...     (9, [3, 3, 3]),
            ...     ])
            >>> rhythm_maker = abjad.rmakers.NoteRhythmMaker(
