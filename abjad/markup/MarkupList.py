...
class MarkupList(TypedList):
    ...
    def center_column(self, direction=None):
        ...
        contents = []
        for markup in self:
            string = abjad.Markup._parse_markup_command_argument(markup)
            contents.append(string)
        command = abjad.MarkupCommand('center-column', contents)
    ...
    def column(self, direction=None):
        ...
        command = abjad.MarkupCommand('column', contents)
        return abjad.Markup(contents=command, direction=direction)
    ...
    def combine(self, direction=None):
        ...
        command = abjad.MarkupCommand('combine', contents_1, contents_2)
        return abjad.Markup(contents=command, direction=direction)
    ...
    def concat(self, direction=None):
        ...
        result = []
        for markup in self:
            contents = abjad.Markup._parse_markup_command_argument(markup)
            result.append(contents)
        command = abjad.MarkupCommand('concat', result)
        return abjad.Markup(contents=command, direction=direction)
    ...
    def left_column(self, direction=None):
        ...
        command = abjad.MarkupCommand('left-column', contents)
        return abjad.Markup(contents=command, direction=direction)
    ...
    def line(self, direction=None):
        ...
        for markup in self:
            contents.extend(markup.contents)
        command = abjad.MarkupCommand('line', contents)
        return abjad.Markup(contents=command, direction=direction)
    ...
    def overlay(self, direction=None):
        ...
        for markup in self:
            contents.append(abjad.Markup._parse_markup_command_argument(markup))
        command = abjad.MarkupCommand('overlay', contents)
        return abjad.Markup(contents=command, direction=direction)
    ...
    def right_column(self, direction=None):
        ...
        for markup in self:
            contents.append(abjad.Markup._parse_markup_command_argument(markup))
        command = abjad.MarkupCommand('right-column', contents)
        return abjad.Markup(contents=command, direction=direction)
