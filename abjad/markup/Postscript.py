...
class Postscript(AbjadValueObject):
    ...
    def __init__(self, operators=None):
        import abjad
        prototype = abjad.PostscriptOperator
    ...
    def as_markup(self):
        ...
        """
        import abjad
        return abjad.Markup.postscript(self)
    ...
    def charpath(self, text, modify_font=True):
        ...
        operator = abjad.PostscriptOperator(
            'charpath',
            text,
            modify_font,
            )
    ...
    def closepath(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('closepath')
        return self._with_operator(operator)
    ...
    def fill(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('fill')
        return self._with_operator(operator)
    ...
    def findfont(self, font_name):
        ...
        operator = abjad.PostscriptOperator('findfont', font_name)
        return self._with_operator(operator)
    ...
    def grestore(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('grestore')
        return self._with_operator(operator)
    ...
    def gsave(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('gsave')
        return self._with_operator(operator)
    ...
    def lineto(self, x, y):
        ...
        x = float(x)
        y = float(y)
        operator = abjad.PostscriptOperator('lineto', x, y)
        return self._with_operator(operator)
    ...
    def moveto(self, x, y):
        ...
        x = float(x)
        y = float(y)
        operator = abjad.PostscriptOperator('moveto', x, y)
        return self._with_operator(operator)
    ...
    def newpath(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('newpath')
        return self._with_operator(operator)
    ...
    def rlineto(self, dx, dy):
        ...
        dx = float(dx)
        dy = float(dy)
        operator = abjad.PostscriptOperator('rlineto', dx, dy)
        return self._with_operator(operator)
    ...
    def rmoveto(self, dx, dy):
        ...
        dx = float(dx)
        dy = float(dy)
        operator = abjad.PostscriptOperator('rmoveto', dx, dy)
        return self._with_operator(operator)
    ...
    def rotate(self, degrees):
        ...
        operator = abjad.PostscriptOperator('rotate', degrees)
        return self._with_operator(operator)
    ...
    def scale(self, dx, dy):
        ...
        dx = float(dx)
        dy = float(dy)
        operator = abjad.PostscriptOperator('scale', dx, dy)
        return self._with_operator(operator)
    ...
    def scalefont(self, font_size):
        ...
        operator = abjad.PostscriptOperator('scalefont', font_size)
        return self._with_operator(operator)
    ...
    def setdash(self, array=None, offset=0):
        ...
        offset = float(offset)
        operator = abjad.PostscriptOperator('setdash', array, offset)
        return self._with_operator(operator)
    ...
    def setfont(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('setfont')
        return self._with_operator(operator)
    ...
    def setgray(self, gray_value):
        ...
        operator = abjad.PostscriptOperator('setgray', gray_value)
        return self._with_operator(operator)
    ...
    def setlinewidth(self, width):
        ...
        import abjad
        width = float(width)
        operator = abjad.PostscriptOperator('setlinewidth', width)
        return self._with_operator(operator)
    ...
    def show(self, text):
        ...
        import abjad
        text = str(text)
        operator = abjad.PostscriptOperator('show', text)
        return self._with_operator(operator)
    ...
    def stroke(self):
        ...
        """
        import abjad
        operator = abjad.PostscriptOperator('stroke')
        return self._with_operator(operator)
    ...
    def translate(self, dx, dy):
        ...
        dx = float(dx)
        dy = float(dy)
        operator = abjad.PostscriptOperator('translate', dx, dy)
        return self._with_operator(operator)
