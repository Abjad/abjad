...
class NoteRhythmMaker(RhythmMaker):
    ...
    ..  container:: example
        ...
        >>> rhythm_maker = abjad.rhythmos.NoteRhythmMaker()
    ...
    def __init__(
        ...
        *,
        ...
        if burnish_specifier is not None:
            prototype = rhythmos.BurnishSpecifier
    ...
    def __format__(self, format_specification=''):
        ...
        ..  container:: example
            ...
            abjad.rhythmos.NoteRhythmMaker()
    ...
    def burnish_specifier(self) -> typing.Optional[BurnishSpecifier]:
        ...
        ..  container:: example
            ...
            >>> rhythm_maker = abjad.rhythmos.NoteRhythmMaker(
            ...     burnish_specifier=abjad.rhythmos.BurnishSpecifier(
    ...
    def division_masks(self) -> typing.Optional[typing.List[Pattern]]:
        ...
        ..  container:: example
            ...
            >>> mask = abjad.rhythmos.SilenceMask(
    ...
    def duration_specifier(self) -> typing.Optional[DurationSpecifier]:
        ...
        ..  container:: example
            ...
            >>> rhythm_maker = abjad.rhythmos.NoteRhythmMaker(
            ...     duration_specifier=abjad.rhythmos.DurationSpecifier(
        ...
        ..  container:: example
            ...
            >>> partition_table = abjad.rhythmos.PartitionTable([
            ...     (5, [3, 2]),
            ...     (9, [3, 3, 3]),
            ...     ])
            >>> rhythm_maker = abjad.rhythmos.NoteRhythmMaker(
