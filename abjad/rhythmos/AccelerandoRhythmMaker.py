...
class AccelerandoRhythmMaker(RhythmMaker):
    ...
    ..  container:: example
        ...
        >>> rhythm_maker = abjad.rhythmos.AccelerandoRhythmMaker(
        ...     beam_specifier=abjad.rhythmos.BeamSpecifier(
        ...         use_feather_beams=True,
        ...         ),
        ...     interpolation_specifiers=abjad.rhythmos.InterpolationSpecifier(
        ...         start_duration=(1, 8),
        ...         stop_duration=(1, 20),
        ...         written_duration=(1, 16),
        ...         ),
        ...     tuplet_specifier=abjad.rhythmos.TupletSpecifier(
    ...
    def _get_interpolation_specifiers(self):
        ...
        elif isinstance(specifiers, rhythmos.InterpolationSpecifier):
    ...
    def _interpolate_cosine(y1, y2, mu):
        ...
        >>> abjad.rhythmos.AccelerandoRhythmMaker._interpolate_cosine(
        ...     y1=0,
        ...     y2=1,
        ...     mu=0.5,
        ...     )
    ...
    def _interpolate_divide(
        ...
        >>> abjad.rhythmos.AccelerandoRhythmMaker._interpolate_divide(
        ...     total_duration=10,
        ...     start_duration=1,
        ...     stop_duration=1,
        ...     exponent=1,
    ...
    def _interpolate_divide_multiple(
        ...
        >>> durations = abjad.rhythmos.AccelerandoRhythmMaker._interpolate_divide_multiple(
    ...
    def _interpolate_exponential(y1, y2, mu, exponent=1):
        ...
        >>> class_ = abjad.rhythmos.AccelerandoRhythmMaker
    ...
    def interpolation_specifiers(self):
        ...
        ..  container:: example
            ...
            ...         ),
            ...     interpolation_specifiers=[
            ...         abjad.rhythmos.InterpolationSpecifier(
            ...             start_duration=(1, 8),
            ...             stop_duration=(1, 20),
            ...             written_duration=(1, 16),
            ...             ),
    ...
    def tie_specifier(self):
        ...
        ..  container:: example
            ...
            ...         written_duration=(1, 16),
            ...         ),
            ...     tie_specifier=abjad.rhythmos.TieSpecifier(
