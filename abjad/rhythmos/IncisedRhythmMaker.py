...
class IncisedRhythmMaker(RhythmMaker):
    ...
    ..  container:: example
        ...
        >>> rhythm_maker = abjad.rhythmos.IncisedRhythmMaker(
        ...     incise_specifier=abjad.rhythmos.InciseSpecifier(
        ...         prefix_talea=[-1],
        ...         prefix_counts=[0, 1],
        ...         suffix_talea=[-1],
        ...         suffix_counts=[1],
    ...
    def __init__(
        ...
        *,
        ...
        prototype = (rhythmos.InciseSpecifier, type(None))
    ...
    def _get_incise_specifier(self):
        ...
        return rhythmos.InciseSpecifier()
...
#        split_divisions_by_counts = counts[3]
    ...
    def _numeric_map_to_leaf_selections(self, numeric_map, lcd):
        ...
        class_ = rhythmos.TaleaRhythmMaker
