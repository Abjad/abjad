...
class TaleaRhythmMaker(RhythmMaker):
    ...
    ..  container:: example
        ...
        >>> rhythm_maker = abjad.rhythmos.TaleaRhythmMaker(
    ...
    def __init__(
        ...
        *,
        ...
        prototype = (rhythmos.Talea, type(None))
        ...
        prototype = (rhythmos.BurnishSpecifier, type(None))
    ...
    def __format__(self, format_specification=''):
        ...
        ..  container:: example
            ...
            abjad.rhythmos.TaleaRhythmMaker(
                talea=abjad.rhythmos.Talea(
                    counts=[1, 2, 3, 4],
                    denominator=16,
                    ),
    ...
    def _get_burnish_specifier(self):
        ...
        return rhythmos.BurnishSpecifier()
