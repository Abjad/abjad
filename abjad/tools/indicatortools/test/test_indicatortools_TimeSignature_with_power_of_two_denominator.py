...
def test_indicatortools_TimeSignature_with_power_of_two_denominator_01():
    ...
    assert abjad.TimeSignature((3, 12)).with_power_of_two_denominator() == (2, 8)
    assert abjad.TimeSignature((4, 12)).with_power_of_two_denominator() == (4, 12)
    assert abjad.TimeSignature((5, 12)).with_power_of_two_denominator() == (5, 12)
    assert abjad.TimeSignature((6, 12)).with_power_of_two_denominator() == (4, 8)
...
def test_indicatortools_TimeSignature_with_power_of_two_denominator_02():
    ...
    assert abjad.TimeSignature((3, 14)).with_power_of_two_denominator() == (3, 14)
    assert abjad.TimeSignature((4, 14)).with_power_of_two_denominator() == (4, 14)
    assert abjad.TimeSignature((5, 14)).with_power_of_two_denominator() == (5, 14)
    assert abjad.TimeSignature((6, 14)).with_power_of_two_denominator() == (6, 14)
    assert abjad.TimeSignature((7, 14)).with_power_of_two_denominator() == (4, 8)
