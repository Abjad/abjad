...
from abjad.tools.instrumenttools import Performer


def test_instrumenttools_Performer___hash___01():
    r'''If two Performers compare equally, their hashes also compare equally.
    '''
