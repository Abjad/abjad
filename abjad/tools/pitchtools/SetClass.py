...
class SetClass(AbjadValueObject):
    ...
    ..  container:: example
        ...
        **Example 1.** Initializes transposition-inversion set-class (with
        Forte rank):
    ...
    ..  container:: example
        ...
        **Example 2.** Initializes transposition-inversion
    ...
    ..  container:: example
        ...
        **Example 3.** Initializes transposition-only set-class:
    ...
    def __str__(self):
        ...
        ..  container:: example
            ...
            **Example 1.** Gets string of transposition-inversion set-class
            (with Forte rank):
        ...
        ..  container:: example
            ...
            **Example 2.** Gets string of transposition-inversion set-class
            (with lex rank):
        ...
        ..  container:: example
            ...
            **Example 3.** Gets string of transposition-only set-class:
    ...
    def cardinality(self):
        ...
        ..  container:: example
            ...
            **Example 1.** Gets cardinality of transposition-inversion
        ...
        ..  container:: example
            ...
            **Example 2.** Gets cardinality of transposition-inversion
            set-class (with lex rank):
        ...
        ..  container:: example
            ...
            **Example 3.** Gets cardinality of transposition-only set-class:
    ...
    def is_inversion_equivalent(self):
        ...
        ..  container:: example
            ...
            **Example 1.** Is inversion-equivalent:
        ...
        ..  container:: example
            ...
            **Example 2.** Is inversion-equivalent:
        ...
        ..  container:: example
            ...
            **Example 3.** Is not inversion-equivalent:
    ...
    def lex_rank(self):
        ...
        ..  container:: example
            ...
            **Example 3.** Transposition-only set-classes always use lex rank:
    ...
    def prime_form(self):
        ...
        ..  container:: example
            ...
            **Example 1.** Gets prime form of transposition-inversion set-class
            (with Forte rank):
        ...
        ..  container:: example
            ...
            **Example 2.** Gets prime form of transposition-inversion set-class
            (with lex rank):
        ...
        ..  container:: example
            ...
            **Example 3.** Gets prime form of transposition-only set-class:
    ...
    def rank(self):
        ...
        ..  container:: example
            ...
            **Example 1.** Gets rank of transposition-inversion set-class (with
            Forte rank):
        ...
        ..  container:: example
            ...
            **Example 2.** Gets rank of transposition-inversion
            set-class (with lex rank):
        ...
        ..  container:: example
            ...
            **Example 3.** Gets rank of transposition-only set-class:
    ...
    def transposition_only(self):
        ...
        ..  container:: example
            ...
            **Example 2.** Initializes transposition-inversion set-class (with
            lex rank):
    ...
    def list_set_classes(
        ...
        ..  container:: example
            ...
            **Example 1.** Lists transposition-inversion set-classes of
        ...
        ..  container:: example
            ...
            **Example 2.** Lists transposition-inversion set-classes of
        ...
        ..  container:: example
            ...
            **Example 3.** Lists transposition-only set-classes of cardinality
            4:
