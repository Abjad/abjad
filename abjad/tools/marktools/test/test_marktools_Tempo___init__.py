...
def test_TempoMark___init___01():
    ...
    tempo_mark = Tempo(Duration(3, 32), 52)
...
def test_TempoMark___init___02():
    ...
    tempo_mark = Tempo(Duration(3, 32), 52.5)
...
def test_TempoMark___init___07():
    ...
    tempo_mark = Tempo('Quick', Duration(1, 4), (120, 133))
...
def test_TempoMark___init___08():
    ...
    tempo_mark = Tempo((Duration(1, 4), (120, 133)))
