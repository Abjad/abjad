...
def test_scoretools_Iteration_by_logical_voice_01():
...
def test_scoretools_Iteration_by_logical_voice_02():
...
def test_scoretools_Iteration_by_logical_voice_03():
...
def test_scoretools_Iteration_by_logical_voice_04():
...
def test_scoretools_Iteration_by_logical_voice_05():
...
def test_scoretools_Iteration_by_logical_voice_06():
...
def test_scoretools_Iteration_by_logical_voice_07():
    r'''Yields only notes matching the given logical voice.
    '''
...
def test_scoretools_Iteration_by_logical_voice_08():
    r'''Yields nothing when class not present.
    '''
...
def test_scoretools_Iteration_by_logical_voice_09():
    r'''Yields internal nodes only.
    '''
...
def test_scoretools_Iteration_by_logical_voice_10():
    r'''Yields exact leaves.
    '''
...
def test_scoretools_Iteration_by_logical_voice_11():
    r'''Yields leaves based on names higher in inheritence hierarchy.
    '''
...
def test_scoretools_Iteration_by_logical_voice_12():
    r'''Yields notes in two contiguous Voices with the same name.
    '''
...
def test_scoretools_Iteration_by_logical_voice_13():
    r'''Yields only notes matching the given logical voice.
    '''
...
def test_scoretools_Iteration_by_logical_voice_14():
    r'''Yields only notes matching the given logical voice.
    '''
