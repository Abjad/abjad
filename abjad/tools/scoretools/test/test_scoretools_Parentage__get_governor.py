...
def test_scoretools_Parentage__get_governor_01( ):
...
def test_scoretools_Parentage__get_governor_02( ):
...
def test_scoretools_Parentage__get_governor_03( ):
    r'''Returns the last sequential container in the parentage of client
    such that the next element in the parentage of client is
    either a simultaneous container or None.
    '''
...
def test_scoretools_Parentage__get_governor_04( ):
    r'''Returns the last sequential container in the parentage of client
    such that the next element in the parentage of client is
    either a simultaneous container or None.
    '''
