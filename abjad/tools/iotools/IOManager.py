...
class IOManager(object):
    ...
    def log_render_lilypond_input(
        ...
        IOManager.run_lilypond(name, abjad_configuration['lilypond_path'])
        stop_time = time.time()
    ...
    def view_last_log():
        ...
        ::
            ...
            >>> iotools.IOManager.view_last_log() # doctest: +SKIP
        ...
        ..  container:: example
            ...
            **Example 1.** Open the last LilyPond output file:
            ...
            ::
                ...
                >>> iotools.IOManager.view_last_ly() # doctest: +SKIP
        ...
        ..  container:: example
            ...
            **Example 2.** Open the next-to-last LilyPond output file:
            ...
            ::
                ...
                >>> iotools.IOManager.view_last_ly(-2) # doctest: +SKIP
