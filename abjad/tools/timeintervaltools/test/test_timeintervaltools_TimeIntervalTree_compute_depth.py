...
def test_timeintervaltools_TimeIntervalTree_compute_depth_01():
...
def test_timeintervaltools_TimeIntervalTree_compute_depth_02():
...
def test_timeintervaltools_TimeIntervalTree_compute_depth_03():
    a = timeintervaltools.TimeInterval(0, 3)
    b = timeintervaltools.TimeInterval(6, 12)
    c = timeintervaltools.TimeInterval(9, 15)
    tree = timeintervaltools.TimeIntervalTree([a, b, c])
...
def test_timeintervaltools_TimeIntervalTree_compute_depth_04():
    a = timeintervaltools.TimeInterval(0, 3)
    b = timeintervaltools.TimeInterval(6, 12)
    c = timeintervaltools.TimeInterval(9, 15)
    tree = timeintervaltools.TimeIntervalTree([a, b, c])
