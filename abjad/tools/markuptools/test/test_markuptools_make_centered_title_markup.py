...
def test_markuptools_make_centered_title_markup_01():
    ...
    assert format(markup) == '\\markup { \\override #\'(font-name . "Times") \\fontsize #18 \\column { \\center-align { { \\vspace #6 \\line { "String Quartet" } \\vspace #12 } } } }'
...
def test_markuptools_make_centered_title_markup_02():
    ...
    assert format(markup) == '\\markup { \\override #\'(font-name . "Times") \\fontsize #18 \\column { \\center-align { { \\vspace #6 \\line { "String Quartet" } \\line { "for the JACK Quartet" } \\vspace #12 } } } }'
