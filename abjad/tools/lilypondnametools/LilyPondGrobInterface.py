...
class LilyPondGrobInterface(abctools.AbjadValueObject):
    ...
    def __init__(self, name='grob-interface'):
    ...
    @property
    def name(self):
        r'''Gets name of LilyPond grob interface.
    ...
    def property_names(self):
        r'''Gets property names of LilyPond grob interface.
        ...
        '''
        from abjad.ly import interface_properties
        return tuple(interface_properties[self.name])
