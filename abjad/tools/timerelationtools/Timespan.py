...
class Timespan(BoundedObject):
    ...
    ..  container:: example
        ...
        ::
                ...
                >>> timespan_2 = timerelationtools.Timespan(5, 12)
                >>> timespan_3 = timerelationtools.Timespan(-2, 2)
                >>> timespan_4 = timerelationtools.Timespan(10, 20)
    ...
    def __and__(self, expr):
        ...
        if not self.intersects_timespan(expr):
            return timerelationtools.TimespanInventory()
        ...
        return timerelationtools.TimespanInventory([timespan])
    ...
    def __eq__(self, timespan):
        ...
        ::
            ...
            >>> timerelationtools.Timespan(1, 3) == timerelationtools.Timespan(1, 3)
            True
        ...
        ::
            ...
            >>> timerelationtools.Timespan(1, 3) == timerelationtools.Timespan(2, 3)
            False
    ...
    def __ne__(self, timespan):
        ...
        ::
            ...
            >>> timerelationtools.Timespan(1, 3) != timerelationtools.Timespan(2/2, (3, 1))
            False
    ...
    def __or__(self, expr):
        ...
        if not self.intersects_timespan(expr) and \
            ...
            result = timerelationtools.TimespanInventory([self, expr])
            result.sort()
            return result
    ...
    def delays_timespan(self, timespan):
        ...
        ::
            ...
            >>> timespan_3 = timerelationtools.Timespan(10, 20)
    ...
    def divide_by_ratio(self, ratio):
        ...
        ::
            ...
            >>> timespan = timerelationtools.Timespan((1, 2), (3, 2))
    ...
    def get_overlap_with_timespan(self, timespan):
        ...
        ::
            ...
            >>> timespan_2 = timerelationtools.Timespan(5, 10)
            >>> timespan_3 = timerelationtools.Timespan(6, 6)
            >>> timespan_4 = timerelationtools.Timespan(12, 22)
    ...
    def intersects_timespan(self, timespan):
        ...
        ::
            ...
            >>> timespan_1 = timerelationtools.Timespan(0, 10)
            >>> timespan_2 = timerelationtools.Timespan(5, 15)
            >>> timespan_3 = timerelationtools.Timespan(10, 15)
    ...
    def overlaps_all_of_timespan(self, timespan):
        ...
        ::
            ...
            >>> timespan_1 = timerelationtools.Timespan(0, 10)
            >>> timespan_2 = timerelationtools.Timespan(5, 6)
            >>> timespan_3 = timerelationtools.Timespan(5, 10)
    ...
    def overlaps_only_start_of_timespan(self, timespan):
        ...
        ::
            ...
            >>> timespan_1 = timerelationtools.Timespan(0, 10)
            >>> timespan_2 = timerelationtools.Timespan(-5, 5)
            >>> timespan_3 = timerelationtools.Timespan(4, 6)
            >>> timespan_4 = timerelationtools.Timespan(5, 15)
        ...
        ..  container:: example
            ...
            **Example 1.** Reverse timespan about timespan axis:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 6).reflect()
        ...
        ..  container:: example
            ...
            **Example 2.** Reverse timespan about arbitrary axis:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 6).reflect(axis=Offset(10))
    ...
    def round_offsets(self, multiplier, anchor=Left, must_be_well_formed=True):
        ...
        ::
            ...
            >>> timespan = timerelationtools.Timespan((1, 5), (4, 5))
    ...
    def scale(self, multiplier, anchor=Left):
        r'''Scales timespan by `multiplier`.
            ...
            >>> timespan = timerelationtools.Timespan(3, 6)
    ...
    def split_at_offset(self, offset):
        ...
        ::
            ...
            >>> timespan = timerelationtools.Timespan(0, 5)
    ...
    def starts_after_timespan_stops(self, timespan):
        ...
        ::
            ...
            >>> timespan_2 = timerelationtools.Timespan(5, 15)
            >>> timespan_3 = timerelationtools.Timespan(10, 20)
            >>> timespan_4 = timerelationtools.Timespan(15, 25)
        ...
        .. container:: example
            ...
            **Example 1.** Stretch relative to timespan start offset:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 10).stretch(Multiplier(2))
        ...
        .. container:: example
            ...
            **Example 2.** Stretch relative to timespan stop offset:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 10).stretch(Multiplier(2), Offset(10))
        ...
        .. container:: example
            ...
            **Example 3.** Stretch relative to offset prior to timespan:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 10).stretch(Multiplier(2), Offset(0))
        ...
        .. container:: example
            ...
            **Example 4.** Stretch relative to offset after timespan:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 10).stretch(Multiplier(3), Offset(12))
        ...
        .. container:: example
            ...
            **Example 5.** Stretch relative to offset that happens during timespan:
            ...
            ::
                ...
                >>> timerelationtools.Timespan(3, 10).stretch(Multiplier(2), Offset(4))
