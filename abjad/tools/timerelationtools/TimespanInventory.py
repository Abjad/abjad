...
class TimespanInventory(TypedList):
    ...
    ..  container:: example
        ...
        **Example 1:**
        ...
        ::
            ...
            >>> timespan_inventory_1 = timerelationtools.TimespanInventory([
            ...     timerelationtools.Timespan(0, 3),
            ...     timerelationtools.Timespan(3, 6),
            ...     timerelationtools.Timespan(6, 10),
            ...     ])
    ...
    ..  container:: example
        ...
        **Example 2:**
        ...
        ::
            ...
            >>> timespan_inventory_2 = timerelationtools.TimespanInventory([
            ...     timerelationtools.Timespan(0, 10),
            ...     timerelationtools.Timespan(3, 6),
            ...     timerelationtools.Timespan(15, 20),
            ...     ])
    ...
    ..  container:: example
        ...
        **Example 3.** Empty timespan inventory:
        ...
        ::
            ...
            >>> timespan_inventory_3 = timerelationtools.TimespanInventory()
    ...
    def __and__(self, timespan):
        ...
        ::
            ...
            ...     timerelationtools.Timespan(0, 16),
            ...     timerelationtools.Timespan(5, 12),
            ...     timerelationtools.Timespan(-2, 8),
            ...     ])

        ::

            >>> timespan = timerelationtools.Timespan(5, 10)
    ...
    def compute_logical_or(self):
        ...
        ..  container:: example
            ...
            **Example 4:**
                ...
                ...     timerelationtools.Timespan(0, 10),
                ...     timerelationtools.Timespan(5, 12),
                ...     timerelationtools.Timespan(-2, 2),
                ...     ])
        ...
        ..  container:: example
            ...
            **Example 5:**
                ...
                >>> timespan_inventory = timerelationtools.TimespanInventory([
                ...     timerelationtools.Timespan(-2, 2),
                ...     timerelationtools.Timespan(10, 20),
                ...     ])
    ...
    def compute_logical_xor(self):
        ...
        ..  container:: example
            ...
            **Example 6:**
                ...
                >>> timespan_inventory = timerelationtools.TimespanInventory([
                ...     timerelationtools.Timespan(0, 10),
                ...     timerelationtools.Timespan(4, 8),
                ...     timerelationtools.Timespan(2, 6),
                ...     ])
    ...
    def compute_overlap_factor(self, timespan=None):
        ...
        ::
            ...
            ...     timerelationtools.Timespan(20, 30),
            ...     ])
        ...
        ..  container:: example
            ...
            **Example 2a.** Compute overlap factor within a specific timespan:
            ...
            ::
                ...
                >>> timespan_inventory.compute_overlap_factor(
                ...     timespan=timerelationtools.Timespan(-15, 0))
                Multiplier(0, 1)
        ...
        ..  container:: example
            ...
            **Example 2b:**
            ...
            ::
                ...
                >>> timespan_inventory.compute_overlap_factor(
                ...     timespan=timerelationtools.Timespan(-10, 5))
                Multiplier(1, 3)
        ...
        ..  container:: example
            ...
            **Example 2d:**
            ...
            ::
                ...
                >>> timespan_inventory.compute_overlap_factor(
                ...     timespan=timerelationtools.Timespan(0, 15))
                Multiplier(4, 3)
        ...
        ..  container:: example
            ...
            **Example 2e:**
            ...
            ::
                ...
                >>> timespan_inventory.compute_overlap_factor(
                ...     timespan=timerelationtools.Timespan(5, 20))
                Multiplier(1, 1)
        ...
        ..  container:: example
            ...
            **Example 2f:**
            ...
            ::
                ...
                >>> timespan_inventory.compute_overlap_factor(
                ...     timespan=timerelationtools.Timespan(10, 25))
                Multiplier(1, 1)
        ...
        ..  container:: example
            ...
            **Example 2g:**
            ...
            ::
                ...
                >>> timespan_inventory.compute_overlap_factor(
                ...     timespan=timerelationtools.Timespan(15, 30))
                Multiplier(1, 1)
        ...
        ..  container:: example
            ...
            **Example 3:**
            ...
            ::
                ...
                >>> timespan_inventory = timerelationtools.TimespanInventory([
                ...     timerelationtools.Timespan(0, 3),
                ...     timerelationtools.Timespan(0, 6),
                ...     timerelationtools.Timespan(0, 9),
                ...     ])
                >>> for offset, count in sorted(
    ...
    def explode(self, inventory_count=None):
        ...
        ::
            ...
            >>> timespan_inventory = timerelationtools.TimespanInventory([
            ...     timerelationtools.Timespan(0, 3),
            ...     timerelationtools.Timespan(5, 13),
            ...     timerelationtools.Timespan(6, 10),
            ...     timerelationtools.Timespan(8, 9),
            ...     timerelationtools.Timespan(15, 23),
            ...     timerelationtools.Timespan(16, 21),
            ...     timerelationtools.Timespan(17, 19),
            ...     timerelationtools.Timespan(19, 20),
            ...     timerelationtools.Timespan(25, 30),
            ...     timerelationtools.Timespan(26, 29),
            ...     timerelationtools.Timespan(32, 34),
            ...     timerelationtools.Timespan(34, 37),
            ...     ])
    ...
    def get_timespan_that_satisfies_time_relation(self, time_relation):
        ...
        ::
            ...
            >>> timespan_1 = timerelationtools.Timespan(2, 5)
            >>> time_relation = \
    ...
    def get_timespans_that_satisfy_time_relation(self, time_relation):
        ...
        ::
            ...
            >>> timespan_1 = timerelationtools.Timespan(2, 8)
            >>> time_relation = \
            ...     timerelationtools.timespan_2_starts_during_timespan_1(
            ...     timespan_1=timespan_1)
    ...
    def has_timespan_that_satisfies_time_relation(self, time_relation):
        ...
        ::
            ...
            >>> timespan_1 = timerelationtools.Timespan(10, 20)
            >>> time_relation = \
            ...     timerelationtools.timespan_2_starts_during_timespan_1(
            ...     timespan_1=timespan_1)
    ...
    def remove_degenerate_timespans(self):
        ...
        ::
            ...
            >>> timespan_inventory = timerelationtools.TimespanInventory([
            ...     timerelationtools.Timespan(5, 5),
            ...     timerelationtools.Timespan(5, 10),
            ...     timerelationtools.Timespan(5, 25),
            ...     ])
        ...
        ..  container:: example
            ...
            **Example 1.** Rotate by one timespan to the left:
            ...
            ::
                ...
                >>> timespan_inventory = timerelationtools.TimespanInventory([
                ...     timerelationtools.Timespan(0, 3),
                ...     timerelationtools.Timespan(3, 4),
                ...     timerelationtools.Timespan(4, 10),
                ...     ])
        ...
        ..  container:: example
            ...
            **Example 1:**
            ...
            ::
                ...
                >>> timespan_inventory = timerelationtools.TimespanInventory([
                ...     timerelationtools.Timespan(0, 2),
                ...     timerelationtools.Timespan(3, 6),
                ...     timerelationtools.Timespan(6, 10),
                ...     ])
