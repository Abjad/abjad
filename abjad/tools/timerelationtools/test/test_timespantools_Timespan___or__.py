...
def test_timerelationtools_Timespan___or___01():
...
def test_timerelationtools_Timespan___or___02():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___03():
    timespan_1 = timerelationtools.Timespan(0, 15)
    timespan_2 = timerelationtools.Timespan(-10, 5)
    result = timespan_1 | timespan_2
    assert result == timerelationtools.TimespanInventory([
...
def test_timerelationtools_Timespan___or___04():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___05():
    timespan_1 = timerelationtools.Timespan(0, 15)
    timespan_2 = timerelationtools.Timespan(-10, 25)
    result = timespan_1 | timespan_2
    assert result == timerelationtools.TimespanInventory([
        timerelationtools.Timespan(-10, 25)
    ])

def test_timerelationtools_Timespan___or___06():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___07():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___08():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___09():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___10():
    timespan_1 = timerelationtools.Timespan(0, 15)
    timespan_2 = timerelationtools.Timespan(0, 25)
    result = timespan_1 | timespan_2
    assert result == timerelationtools.TimespanInventory([
        timerelationtools.Timespan(0, 25)
    ])

def test_timerelationtools_Timespan___or___11():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___12():
    timespan_1 = timerelationtools.Timespan(0, 15)
...
def test_timerelationtools_Timespan___or___13():
    timespan_1 = timerelationtools.Timespan(0, 15)
