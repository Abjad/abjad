...
def test_rhythmmakertools_BooleanPattern_matches_index_07():
...
def test_rhythmmakertools_BooleanPattern_matches_index_08():
...
def test_rhythmmakertools_BooleanPattern_matches_index_09():
...
def test_rhythmmakertools_BooleanPattern_matches_index_10():
    ...
    assert mask.matches_index(6, length)
    assert not mask.matches_index(7, length)
    assert mask.matches_index(8, length)
    assert not mask.matches_index(9, length)
    assert not mask.matches_index(10, length)