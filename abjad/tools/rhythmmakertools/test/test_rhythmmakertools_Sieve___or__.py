...
def test_rhythmmakertools_Sieve___or___02():
    ...
    assert compound_sieve_2.logical_operator == 'or'
...
def test_rhythmmakertools_Sieve___or___03():
...
def test_rhythmmakertools_Sieve___or___04():
    ...
    assert compound_sieve_3.logical_operator == 'or'
...
def test_rhythmmakertools_Sieve___or___05():

    compound_sieve = rhythmmakertools.Sieve(2, 0) | rhythmmakertools.Sieve(3, 0)

    assert compound_sieve.logical_operator == 'or'
    assert compound_sieve.boolean_train == [1, 0, 1, 1, 1, 0]
    assert compound_sieve.indices == [0, 2, 3, 4]


def test_rhythmmakertools_Sieve___or___06():

    compound_sieve = rhythmmakertools.Sieve(2, 1) | rhythmmakertools.Sieve(3, 0)

    assert compound_sieve.boolean_train == [1, 1, 0, 1, 0, 1]
    assert compound_sieve.indices == [0, 1, 3, 5]