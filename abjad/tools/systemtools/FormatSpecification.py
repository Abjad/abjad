...
class FormatSpecification(AbjadValueObject):
    ...
    def __init__(
        ...
        self._storage_format_is_bracketed = self._coerce_boolean(storage_format_is_bracketed)
        self._storage_format_is_indented = self._coerce_boolean(storage_format_is_indented)
