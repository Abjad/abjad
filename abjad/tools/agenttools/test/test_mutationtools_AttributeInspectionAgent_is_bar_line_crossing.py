...
def test_mutationtools_AttributeInspectionAgent_is_bar_line_crossing_01():
    r'''Works with partial.
    '''

    staff = Staff("c'8 d'8 e'4 f'8")
    time_signature = TimeSignatureMark(
...
def test_mutationtools_AttributeInspectionAgent_is_bar_line_crossing_02():
