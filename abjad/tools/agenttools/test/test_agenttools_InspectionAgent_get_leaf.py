...
def test_agenttools_InspectionAgent_get_leaf_26():
    ...
    assert inspect(voice_2[0]).get_leaf(1) is voice_2[1]
    assert inspect(voice_2[1]).get_leaf(1) is voice_2[2]
    assert inspect(voice_1[0]).get_leaf(1) is None

    assert inspect(voice_2[1]).get_leaf(-1) is voice_2[0]
    assert inspect(voice_2[2]).get_leaf(-1) is voice_2[1]
    assert inspect(voice_1[1]).get_leaf(-1) is voice_2[-1]
