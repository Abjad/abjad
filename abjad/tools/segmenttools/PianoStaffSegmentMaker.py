...
class PianoStaffSegmentMaker(SegmentMaker):
    ...
    def __init__(
        ...
        if rh_rhythm_maker is None:
            rh_rhythm_maker = rmakers.NoteRhythmMaker()
        assert isinstance(rh_rhythm_maker, rmakers.RhythmMaker)
        self._rh_rhythm_maker = rh_rhythm_maker
        if lh_rhythm_maker is None:
            lh_rhythm_maker = rmakers.NoteRhythmMaker()
        assert isinstance(lh_rhythm_maker, rmakers.RhythmMaker)
