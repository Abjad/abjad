        ...
        target = stringtools.normalize(
            ...
            <document source="test">
                <literal_block xml:space="preserve">
                    ...
                    'HorizontalBracketSpanner', 'Inversion',
                    'KeyCluster', 'KeySignature',
                    'LaissezVibrer', 'LilyPondCommand',
                    'LilyPondComment', 'LilyPondFile',
                    ...
                    'Sequence', 'SetClass', 'Skip', 'Slur',
                    'Spanner', 'Staff', 'StaffChange',
                    'StaffGroup', 'StaffLinesSpanner',
