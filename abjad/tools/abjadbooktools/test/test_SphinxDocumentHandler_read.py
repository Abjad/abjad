        ...
        target = stringtools.normalize(
            ...
            <document source="test">
                <literal_block xml:space="preserve">
                    ...
                    'ComplexTrillSpanner', 'Container',
                    'Context', 'Crescendo', 'CyclicTuple',
                    'Decrescendo', 'DuratedComplexBeam',
                    'Duration', 'Dynamic', 'Expression',
                    'Fermata', 'FixedDurationTuplet',
                    'Fraction', 'GeneralizedBeam',
                    'Glissando', 'GraceContainer',
                    'Hairpin', 'HiddenStaffSpanner',
                    'HorizontalBracketSpanner', 'Infinity',
                    'Inversion', 'KeyCluster',
                    'KeySignature', 'LaissezVibrer',
                    'LilyPondCommand', 'LilyPondComment',
                    'LilyPondFile', 'LineSegment', 'Markup',
                    'MarkupList', 'Measure',
                    'MeasuredComplexBeam', 'Meter',
                    'MetricModulation', 'MultimeasureRest',
                    'MultipartBeam', 'Multiplication',
                    'Multiplier', 'NamedInterval',
                    'NamedIntervalClass', 'NamedPitch',
                    'NamedPitchClass', 'NonreducedFraction',
                    'NonreducedRatio', 'Note',
                    'NumberedInterval',
                    ...
                    'Repeat', 'Rest', 'Retrograde',
                    'Ritardando', 'Rotation', 'Scheme',
