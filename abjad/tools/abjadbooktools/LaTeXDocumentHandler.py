...
class LaTeXDocumentHandler(abctools.AbjadObject):
    ...
    ::
        ...
        >>> rebuilt_document = document_handler(
        ...     return_source=True,
        ...     verbose=True,
        ...     )
        Processing test.tex.raw:
            output file:     test.tex.raw
            asset directory: images
            asset prefix:    images
            latex root:      None
            stylesheet:      None
        Interpreting code blocks: 0 / 3
        Interpreting code blocks: 1 / 3
        Interpreting code blocks: 2 / 3
        Interpreting code blocks: 3 / 3
        >>> for line in rebuilt_document.splitlines():
        ...     line
        ...
        "Let's print something:"
        ''
        ...
        '>>> show(Note("c\'4"))'
        '\\end{lstlisting}'
        '\\noindent\\includegraphics{images/lilypond-65d03e56d1fdd997411f2f04c401fe16.pdf}'
        '%%% ABJADBOOK END %%%'
        ''
        "That's it!"
