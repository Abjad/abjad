...
class RhythmTreeMixin(abctools.AbjadObject):
    ...
    def parentage_ratios(self):
        ...
        >>> a = abjad.rhythmtree.RhythmTreeContainer(preprolated_duration=1)
        >>> b = abjad.rhythmtree.RhythmTreeContainer(preprolated_duration=2)
        >>> c = abjad.rhythmtree.RhythmTreeLeaf(preprolated_duration=3)
        >>> d = abjad.rhythmtree.RhythmTreeLeaf(preprolated_duration=4)
        >>> e = abjad.rhythmtree.RhythmTreeLeaf(preprolated_duration=5)
    ...
    def preprolated_duration(self):
        ...
        >>> node = abjad.rhythmtree.RhythmTreeLeaf(
