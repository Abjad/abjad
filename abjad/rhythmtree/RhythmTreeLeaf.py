...
class RhythmTreeLeaf(RhythmTreeMixin, uqbar.containers.UniqueTreeNode):
    ...
    ..  container:: example
        ...
        >>> leaf = abjad.rhythmtree.RhythmTreeLeaf(
    ...
    def __call__(self, pulse_duration):
        ...
        >>> leaf = abjad.rhythmtree.RhythmTreeLeaf(5)
        >>> leaf((1, 4))
    ...
    def rtm_format(self):
        ...
        >>> abjad.rhythmtree.RhythmTreeLeaf(1, is_pitched=True).rtm_format
        '1'
        >>> abjad.rhythmtree.RhythmTreeLeaf(5, is_pitched=False).rtm_format
        '-5'
