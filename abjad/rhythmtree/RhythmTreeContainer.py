...
import uqbar.graphs
from .RhythmTreeMixin import RhythmTreeMixin
...
class RhythmTreeContainer(RhythmTreeMixin, uqbar.containers.UniqueTreeContainer):
    ...
    ..  container:: example
        ...
        >>> container = abjad.rhythmtree.RhythmTreeContainer(
        ...     preprolated_duration=1,
        ...     children=[],
        ...     )

        >>> abjad.f(container)
        abjad.rhythmtree.RhythmTreeContainer(
            children=(),
    ...
    ..  container:: example
        ...
        >>> leaf_a = abjad.rhythmtree.RhythmTreeLeaf(preprolated_duration=1)
        >>> leaf_b = abjad.rhythmtree.RhythmTreeLeaf(preprolated_duration=2)
        >>> container.extend([leaf_a, leaf_b])
        >>> abjad.f(container)
        abjad.rhythmtree.RhythmTreeContainer(
            children=(
                abjad.rhythmtree.RhythmTreeLeaf(
                    preprolated_duration=abjad.Duration(1, 1),
                    is_pitched=True,
                    ),
                abjad.rhythmtree.RhythmTreeLeaf(
        ...
        >>> another_container = abjad.rhythmtree.RhythmTreeContainer(
        ...     preprolated_duration=2)
        >>> another_container.append(
        ...     abjad.rhythmtree.RhythmTreeLeaf(preprolated_duration=3))
    ...
    def __add__(self, argument):
        ...
        >>> a = abjad.rhythmtree.RhythmTreeParser()('(1 (1 1 1))')[0]
        >>> b = abjad.rhythmtree.RhythmTreeParser()('(2 (3 4))')[0]
        ...
        """
        from abjad.rhythmtree.RhythmTreeParser import RhythmTreeParser
    ...
    def __call__(self, pulse_duration):
        ...
        ..  container:: example
            ...
            >>> rtm = '(1 (1 (2 (1 1 1)) 2))'
            >>> tree = abjad.rhythmtree.RhythmTreeParser()(rtm)[0]
    ...
    def _leaf_class(self):
        import abjad
        return abjad.rhythmtree.RhythmTreeLeaf
