...
from scoremanager.iotools.ScoreInternalPackageWrangler import \
...
class MaterialPackageWrangler(ScoreInternalPackageWrangler):
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler = scoremanager.iotools.MaterialPackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler_in_score = scoremanager.iotools.MaterialPackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler_in_score
            MaterialPackageWrangler()
    ...
    def __init__(self, session=None):
        ...
        self._manager_class = iotools.MaterialPackageManager
    ...
    def _get_material_package_manager(self, class_name, path):
        ...
        command = 'manager = scoremanager.iotools.{}'
