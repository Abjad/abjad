...
from scoremanager.iotools.PackageWrangler import PackageWrangler
...
class ScorePackageWrangler(PackageWrangler):
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler = scoremanager.iotools.ScorePackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler_in_score = scoremanager.iotools.ScorePackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler_in_score
            ScorePackageWrangler()
    ...
    def __init__(self, session=None):
        ...
        self._manager_class = iotools.ScorePackageManager
