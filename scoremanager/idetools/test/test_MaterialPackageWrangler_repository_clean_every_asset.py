...
def test_MaterialPackageWrangler_repository_clean_every_asset_01():
    r'''In score.
    '''
    ...
    with systemtools.FilesystemState(remove=[foo_path]):
        ...
        input_ = 'red~example~score m rcn* y q'
        score_manager._run(input_=input_)
        assert not os.path.exists(foo_path)


def test_MaterialPackageWrangler_repository_clean_every_asset_02():
    r'''Out of score.
    '''
