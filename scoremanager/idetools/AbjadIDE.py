...
class AbjadIDE(Wrangler):
    ...
    def _list_storehouse_paths(self):
        paths = []
        paths.append(self._configuration.library_makers_directory)
        paths.append(self._configuration.example_material_packages_directory)
        paths.append(self._configuration.library_material_packages_directory)
        paths.append(self._configuration.abjad_stylesheets_directory)
        paths.append(self._configuration.library_stylesheets_directory)
