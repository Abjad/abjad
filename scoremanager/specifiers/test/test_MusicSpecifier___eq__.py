...
def test_MusicSpecifier___eq___01():
    ...
    mcs_3.append(specifiers.ArticulationSpecifier(
        articulation_handler_name='foo articulations'))

    mcs_4 = scoremanager.specifiers.MusicContributionSpecifier([])
    mcs_4.append(specifiers.ArticulationSpecifier(
        articulation_handler_name='bar articulations'))
