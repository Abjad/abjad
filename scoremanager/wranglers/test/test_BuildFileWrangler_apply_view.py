...
def test_BuildFileWrangler_apply_view_01():
    ...
    input_ += ' add red-example-score-segment-01.ly'
    input_ += ' add red-example-score-segment-02.ly'
    input_ += ' add red-example-score-segment-03.ly done default'
    ...
    lines = [
        ...
        '    2: red-example-score-segment-02.ly (Red Example Score)',
        '    3: red-example-score-segment-03.ly (Red Example Score)',
        '',
        '    files - copy (cp)',
        '    files - new (new)',
        '    files - remove (rm)',
