...
def test_ScorePackageManager__run_06():
    r'''Segment navigation works.
    '''

    score_manager = scoremanager.core.ScoreManager()

    input_ = 'red~example~score setup g q'
    score_manager._run(pending_user_input=input_, is_test=True)
    titles = [
...
def test_ScorePackageManager__run_07():
    r'''Material navigation works.
    '''

    score_manager = scoremanager.core.ScoreManager()

    input_ = 'red~example~score setup m q'
    score_manager._run(pending_user_input=input_, is_test=True)
    titles = [
        'Score manager - example scores',
        'Red Example Score (2013)',
    ...
    input_ = 'red~example~score stylesheets m q'
    score_manager._run(pending_user_input=input_, is_test=True)
    titles = [
        'Score manager - example scores',
        'Red Example Score (2013)',
...
def test_ScorePackageManager__run_08():
    ...
    input_ = 'red~example~score setup u q'
    score_manager._run(pending_user_input=input_, is_test=True)
    titles = [
        'Score manager - example scores',
        'Red Example Score (2013)',
