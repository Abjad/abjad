...
from scoremanager.ide.PackageWrangler import PackageWrangler
...
class ScorePackageWrangler(PackageWrangler):
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler = scoremanager.ide.ScorePackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler_in_score = scoremanager.ide.ScorePackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler_in_score
            ScorePackageWrangler()
    ...
    def __init__(self, session=None):
        ...
        self._manager_class = ide.ScorePackageManager
