...
::
    ...
    ...     leaf = abjad.Selection(score["RH_Voice"]).leaf(0)
    ...     abjad.attach(time_signature, leaf)
    ...     bar_line = abjad.BarLine("|.")
    ...     leaf = abjad.Selection(score["LH_Voice"]).leaf(-1)
    ...     abjad.attach(bar_line, leaf)
    ...     leaf = abjad.Selection(score["LH_Voice"]).leaf(0)
    ...     clef = abjad.Clef("bass")
    ...     abjad.attach(clef, leaf)
    ...     groups = abjad.Selection(score["RH_Voice"]).leaves().group_by_measure()
