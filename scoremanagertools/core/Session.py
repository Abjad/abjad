...
class Session(abctools.AbjadObject):
    ...
    def __init__(self, pending_user_input=None):
        ...
        self._io_manager = scoremanagertools.iotools.IOManager(self)
        self._session_once_had_user_input = False
        self._transcript = scoremanagertools.iotools.IOTranscript()
    ...
    def current_score_package_manager(self):
        ...
        '''
        from scoremanagertools.managers.ScorePackageManager \
