...
from scoremanagertools.wranglers.FileWrangler import \
    FileWrangler
...
#        'stylesheets')
    ...
    def list_asset_managers(
        ...
        ::
            ...
            FileManager('.../scoremanagertools/scorepackages/red_example_score/stylesheets/red-example-score-stylesheet.ily')
