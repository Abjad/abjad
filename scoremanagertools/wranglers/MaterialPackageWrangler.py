...
from scoremanagertools.wranglers.PackageWrangler \
...
class MaterialPackageWrangler(PackageWrangler):
    ...
    def list_asset_managers(
        ...
        ::
            ...
            ...     in_user_score_packages=False):
            ...     x
            MaterialPackageManager('.../scoremanagertools/materialpackages/black_music_specifier')
            MaterialPackageManager('.../scoremanagertools/materialpackages/green_music_specifier')
            MarkupInventoryMaterialPackageMaker('.../scoremanagertools/materialpackages/red_directives')
            DynamicHandlerMaterialPackageMaker('.../scoremanagertools/materialpackages/red_forte')
            ArticulationHandlerMaterialPackageMaker('.../scoremanagertools/materialpackages/red_marcati')
            MaterialPackageManager('.../scoremanagertools/materialpackages/red_notes')
            MaterialPackageManager('.../scoremanagertools/materialpackages/red_numbers')
            SargassoMeasureMaterialPackageMaker('.../scoremanagertools/materialpackages/red_sargasso_measures')
            MaterialPackageManager('.../scoremanagertools/materialpackages/sargasso_multipliers')
            TempoInventoryMaterialPackageMaker('.../scoremanagertools/scorepackages/red_example_score/materials/tempo_inventory')
    ...
    def list_asset_packagesystem_paths(
        ...
        ::
            ...
            ...     in_user_score_packages=False):
            ...     x
            'scoremanagertools.materialpackages.black_music_specifier'
            'scoremanagertools.materialpackages.green_music_specifier'
            'scoremanagertools.materialpackages.red_directives'
            'scoremanagertools.materialpackages.red_forte'
            'scoremanagertools.materialpackages.red_marcati'
            'scoremanagertools.materialpackages.red_notes'
            ...
            'scoremanagertools.materialpackages.red_sargasso_measures'
            'scoremanagertools.materialpackages.sargasso_multipliers'
            'scoremanagertools.scorepackages.red_example_score.materials.tempo_inventory'
    ...
    def list_asset_storehouse_filesystem_paths(
        ...
        ::
            ...
            ...     in_user_score_packages=False):
            ...     x
            '.../scoremanagertools/materialpackages'
            '.../scoremanagertools/scorepackages/blue_example_score/materials'
            '.../scoremanagertools/scorepackages/green_example_score/materials'
            '.../scoremanagertools/scorepackages/red_example_score/materials'
    ...
    def make_makermade_material_package(self,
        ...
        '''
        tags = tags or {}
        command = 'from scoremanagertools.materialpackagemakers '
