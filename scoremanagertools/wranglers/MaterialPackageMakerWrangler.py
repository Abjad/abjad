...
class MaterialPackageMakerWrangler(PackageWrangler):
    ...
    def _initialize_asset_manager(self, package_path):
        ...
        if material_package_maker_class_name is not None:
            ...
            command = 'from scoremanagertools'
    ...
    def list_asset_packagesystem_paths(
        ...
        ::
            ...
            'scoremanagertools.materialpackagemakers.TempoInventoryMaterialPackageMaker'
    ...
    def make_asset_class_file(self, package_name, generic_output_name):
        ...
        lines.append('from scoremanagertools.materialpackagemakers.MaterialPackageMaker import MaterialPackageMaker')
        lines.append('from scoremanagertools.editors.UserInputWrapper import UserInputWrapper')
