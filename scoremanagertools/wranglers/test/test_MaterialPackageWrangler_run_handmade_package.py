...
def test_MaterialPackageWrangler_run_handmade_package_01():
    ...
    try:
        ...
        assert score_manager.configuration.packagesystem_path_exists('scoremanagertools.materialpackages.testnotes')
        mpp = scoremanagertools.managers.MaterialPackageManager('scoremanagertools.materialpackages.testnotes')
