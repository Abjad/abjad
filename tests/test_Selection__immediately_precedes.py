...
def test_Selection__immediately_precedes_01():

    voice = abjad.Voice("c'8 d'8 e'8 f'8")

    assert abjad.Selection._immediately_precedes(voice[0], voice[1])
    assert abjad.Selection._immediately_precedes(voice[1], voice[2])
    assert abjad.Selection._immediately_precedes(voice[2], voice[3])


def test_Selection__immediately_precedes_02():

    staff = abjad.Staff("c'8 d'8 e'8 f'8")

    assert abjad.Selection._immediately_precedes(staff[0], staff[1])
    assert abjad.Selection._immediately_precedes(staff[1], staff[2])
    assert abjad.Selection._immediately_precedes(staff[2], staff[3])


def test_Selection__immediately_precedes_03():

    container = abjad.Container("c'8 d'8 e'8 f'8")

    assert abjad.Selection._immediately_precedes(container[0], container[1])
    assert abjad.Selection._immediately_precedes(container[1], container[2])
    assert abjad.Selection._immediately_precedes(container[2], container[3])


def test_Selection__immediately_precedes_04():

    tuplet = abjad.Tuplet((2, 3), "c'8 d'8 e'8")

    assert abjad.Selection._immediately_precedes(tuplet[0], tuplet[1])
    assert abjad.Selection._immediately_precedes(tuplet[1], tuplet[2])


def test_Selection__immediately_precedes_05():
    ...
    assert abjad.Selection._immediately_precedes(voice[0], voice[1])
    assert abjad.Selection._immediately_precedes(voice[0], voice[1][0])
    assert abjad.Selection._immediately_precedes(voice[0][-1], voice[1])
    assert abjad.Selection._immediately_precedes(voice[0][-1], voice[1][0])


def test_Selection__immediately_precedes_06():
...
def test_Selection__immediately_precedes_07():
    ...
    assert abjad.Selection._immediately_precedes(staff[0], staff[1])
    assert abjad.Selection._immediately_precedes(staff[0], staff[1][0])
    assert abjad.Selection._immediately_precedes(staff[0][-1], staff[1])
    assert abjad.Selection._immediately_precedes(staff[0][-1], staff[1][0])


def test_Selection__immediately_precedes_08():
...
def test_Selection__immediately_precedes_09():
...
def test_Selection__immediately_precedes_10():
...
def test_Selection__immediately_precedes_12():
    ...
    assert abjad.Selection._immediately_precedes(voice[0], voice[1])
    assert abjad.Selection._immediately_precedes(voice[0], voice[1][0])
    assert abjad.Selection._immediately_precedes(voice[0], voice[1][0][0])

    assert abjad.Selection._immediately_precedes(voice[0][0], voice[1])
    assert abjad.Selection._immediately_precedes(voice[0][0], voice[1][0])
    assert abjad.Selection._immediately_precedes(voice[0][0], voice[1][0][0])

    assert abjad.Selection._immediately_precedes(voice[0][0][-1], voice[1])
    assert abjad.Selection._immediately_precedes(voice[0][0][-1], voice[1][0])
    assert abjad.Selection._immediately_precedes(voice[0][0][-1], voice[1][0][0])
