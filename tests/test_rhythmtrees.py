...
def test_RhythmTreeContainer___init___01():
    ...
    assert container.start_offset() == abjad.Offset(abjad.Fraction(0))
...
def test_RhythmTreeContainer___init___03():
    ...
    leaf_b = abjad.rhythmtrees.RhythmTreeLeaf((2, 1))
    leaf_c = abjad.rhythmtrees.RhythmTreeLeaf((1, 1))
    assert leaf_a.start_offset() == abjad.Offset(abjad.Fraction(0))
    assert leaf_a.parent is None
    assert leaf_b.start_offset() == abjad.Offset(abjad.Fraction(0))
    assert leaf_b.parent is None
    assert leaf_c.start_offset() == abjad.Offset(abjad.Fraction(0))
    ...
    assert leaf_b.start_offset() == abjad.Offset(abjad.Fraction(1))
    assert leaf_b.parent is container
    assert leaf_c.start_offset() == abjad.Offset(abjad.Fraction(3))
...
def test_RhythmTreeContainer_contents_duration_01():
    ...
    assert container._get_contents_duration() == abjad.Duration(6)
    assert subcontainer._get_contents_duration() == abjad.Duration(5)
...
def test_RhythmTreeNode_offset_01():
    ...
    assert rtc.start_offset() == abjad.Offset(abjad.Fraction(0))
    assert rtc[0].start_offset() == abjad.Offset(abjad.Fraction(0))
    assert rtc[1].start_offset() == abjad.Offset(abjad.Fraction(1, 5))
    assert rtc[1][0].start_offset() == abjad.Offset(abjad.Fraction(1, 5))
    assert rtc[1][1].start_offset() == abjad.Offset(abjad.Fraction(11, 25))
    assert rtc[2].start_offset() == abjad.Offset(abjad.Fraction(3, 5))
    node = rtc.pop()
    assert node.start_offset() == abjad.Offset(abjad.Fraction(0))
    rtc[1].append(node)
    assert rtc.start_offset() == abjad.Offset(abjad.Fraction(0))
    assert rtc[0].start_offset() == abjad.Offset(abjad.Fraction(0))
    assert rtc[1].start_offset() == abjad.Offset(abjad.Fraction(1, 3))
    assert rtc[1][0].start_offset() == abjad.Offset(abjad.Fraction(1, 3))
    assert rtc[1][1].start_offset() == abjad.Offset(abjad.Fraction(13, 21))
    assert rtc[1][2].start_offset() == abjad.Offset(abjad.Fraction(17, 21))
    rtc.set_pair((19, 1))
    assert rtc.start_offset() == abjad.Offset(abjad.Fraction(0))
    assert rtc[0].start_offset() == abjad.Offset(abjad.Fraction(0))
    assert rtc[1].start_offset() == abjad.Offset(abjad.Fraction(19, 3))
    assert rtc[1][0].start_offset() == abjad.Offset(abjad.Fraction(19, 3))
    assert rtc[1][1].start_offset() == abjad.Offset(abjad.Fraction(247, 21))
    assert rtc[1][2].start_offset() == abjad.Offset(abjad.Fraction(323, 21))
