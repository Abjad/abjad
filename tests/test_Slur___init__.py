...
def test_Slur___init___01():
    """
    Initialize empty slur spanner.
    """
...
def test_Slur___init___02():
    """
    You can span across staves if they and
...
def test_Slur___init___03():
    """
    You can span over liked named staves so long as the voices nested in the
    staves are named the same.
    """
