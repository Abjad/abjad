...
def test_RhythmTreeContainer___eq___03():
    ...
    c = abjad.rhythmtrees.RhythmTreeContainer(preprolated_duration=1, children=[
        abjad.rhythmtrees.RhythmTreeLeaf(preprolated_duration=1)
        ])
    d = abjad.rhythmtrees.RhythmTreeContainer(preprolated_duration=2, children=[
        abjad.rhythmtrees.RhythmTreeLeaf(preprolated_duration=1)
        ])
    e = abjad.rhythmtrees.RhythmTreeContainer(preprolated_duration=2, children=[
