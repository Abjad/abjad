...
def test_IOManager_open_file_01(spawn_subprocess_mock,
                                             configuration,
                                             file_path,
                                             application):
...
@pytest.mark.parametrize('file_path', test_files)
@pytest.mark.parametrize('application', applications)
def test_IOManager_open_file_02(spawn_subprocess_mock,
                                             configuration,
                                             file_path,
                                             application):
    with mock.patch(*configuration):
...
@pytest.mark.parametrize('file_path', test_files)
@pytest.mark.parametrize('application', applications)
def test_IOManager_open_file_03(startfile_mock,
                                             configuration,
                                             file_path,
                                             application):
    with mock.patch(*configuration):
