...
def test_component_trim_by_duration_01( ):
   ...
   component_trim_by_duration(t, Rational(1, 8) + Rational(1, 20))
...
def test_component_trim_by_duration_02( ):

   t = Voice(scale(4))
   Beam(t[:])

   component_trim_by_duration(t, Rational(3, 16))
