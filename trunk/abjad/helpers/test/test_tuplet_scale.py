...
def test_tuplet_scale_01( ):
   '''Double tuplet.'''

   t = FixedDurationTuplet((2, 8), scale(3))
   tuplet_scale(t, Rational(2))
...
def test_tuplet_scale_02( ):
   '''Halve tuplet.'''

   t = FixedDurationTuplet((2, 8), scale(3))
   tuplet_scale(t, Rational(1, 2))
...
def test_tuplet_scale_03( ):
   '''Quadruple tuplet.'''

   t = FixedDurationTuplet((2, 8), scale(3))
   tuplet_scale(t, Rational(4))
...
def test_tuplet_scale_04( ):
   '''Quarter tuplet.'''

   t = FixedDurationTuplet((2, 8), scale(3))
   tuplet_scale(t, Rational(1, 4))
...
def test_tuplet_scale_05( ):
   '''Multiply tuplet by 3/2.'''

   t = FixedDurationTuplet((2, 8), scale(3))
   tuplet_scale(t, Rational(3, 2))
...
def test_tuplet_scale_06( ):
   '''Multiply tuplet by 3/5.'''

   t = FixedDurationTuplet((2, 8), scale(3))
   tuplet_scale(t, Rational(3, 5))
