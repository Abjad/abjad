...
def test_measure_scale_and_remeter_07( ):
   ...
   measure_scale_and_remeter(t, Rational(1, 2))
...
def test_measure_scale_and_remeter_09( ):
   '''Scale binary meter by two.
      Noteheads rewrite with double duration.
      Meter rewrites with half denominator.'''

   t = RigidMeasure((6, 16), scale(6, Rational(1, 16)))
   measure_scale_and_remeter(t, Rational(2))
