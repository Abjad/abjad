...
def test_OffsetProlatedInterface_start_01( ):
   ...
   t = Staff([Voice(leaftools.make_repeated_notes(4)), Voice(leaftools.make_repeated_notes(4))])
...
def test_OffsetProlatedInterface_start_02( ):
   ...
   t = Container([Staff(leaftools.make_repeated_notes(4)), Staff(leaftools.make_repeated_notes(4))])
...
def test_OffsetProlatedInterface_start_04( ):
   ...
   t = Voice(FixedDurationTuplet((1, 4), leaftools.make_repeated_notes(3)) * 3)
...
def test_OffsetProlatedInterface_start_07( ):
   ...
   vin = Voice(leaftools.make_repeated_notes(4))
...
def test_OffsetProlatedInterface_start_09( ):
   ...
   v1 = Voice(leaftools.make_repeated_notes(4))
   v2 = Voice(leaftools.make_repeated_notes(4))
   v1b= Voice(leaftools.make_repeated_notes(4))
   v2b= Voice(leaftools.make_repeated_notes(4))
