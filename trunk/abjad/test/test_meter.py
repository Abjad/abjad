...
def test_typical_meter_01( ):
   ...
   assert t.meter.duration == Duration(5, 8)
...
def test_typical_meter_02( ):
   ...
   assert t.meter.denominator == 8
   assert t.meter.duration == Duration(6, 8)
