...
def test_NoteHead___eq___01( ):
   ...
   assert NoteHead(None, pitchtools.NamedPitch('df', 5)) == NoteHead(None, pitchtools.NamedPitch('df', 5))
...
def test_NoteHead___eq___02( ):
   ...
   assert not NoteHead(None, pitchtools.NamedPitch('cs', 5)) == NoteHead(None, pitchtools.NamedPitch('df', 5))
