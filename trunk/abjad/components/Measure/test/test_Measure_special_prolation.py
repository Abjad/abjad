...
def test_Measure_special_prolation_02( ):
   ...
   t = Measure((4, 4), [
      ...
      Note(0, (1, 4))])
   assert t.leaves[0].duration.written == Fraction(1, 4)
   assert t.leaves[0].duration.prolated == Fraction(1, 4)
   assert t.leaves[1].duration.written == Fraction(1, 4)
   assert t.leaves[1].duration.prolated == Fraction(1, 6)
...
def test_Measure_special_prolation_03( ):
   ...
   assert t.leaves[0].duration.prolated == Fraction(1, 4)
   assert t.leaves[1].duration.written == Fraction(1, 4)
   assert t.leaves[1].duration.prolated == Fraction(1, 9)
...
def test_Measure_special_prolation_04( ):
   ...
   assert t[0].duration.written == Fraction(1, 4)
   assert t[0].duration.prolated == Fraction(1, 5)
...
def test_Measure_special_prolation_05( ):
   ...
   t = Measure((4, 5), [
      ...
      Note(0, (1, 4))])
   assert t.leaves[0].duration.written == Fraction(1, 4)
   assert t.leaves[0].duration.prolated == Fraction(1, 5)
   assert t.leaves[1].duration.written == Fraction(1, 4)
   assert t.leaves[1].duration.prolated == Fraction(2, 15)
...
def test_Measure_special_prolation_06( ):
   ...
   assert t.leaves[0].duration.prolated == Fraction(1, 5)
   assert t.leaves[1].duration.written == Fraction(1, 4)
   assert t.leaves[1].duration.prolated == Fraction(4, 45)
