...
def test_is_immediate_temporal_successor_of_06( ):
   ...
   assert t[0][-1]._navigator._isImmediateTemporalFollowed(t[1])
   assert t[0][-1]._navigator._isImmediateTemporalFollowed(t[1][0])
...
def test_is_immediate_temporal_successor_of_12( ):
   ...
   assert seq[0]._navigator._isImmediateTemporalSuccessorOf(t[1])
   assert seq[0]._navigator._isImmediateTemporalSuccessorOf(t[1][0])
   assert seq[0]._navigator._isImmediateTemporalSuccessorOf(t[1][0][0])
   
   assert seq[0][0]._navigator._isImmediateTemporalSuccessorOf(t[1])
   assert seq[0][0]._navigator._isImmediateTemporalSuccessorOf(t[1][0])
   assert seq[0][0]._navigator._isImmediateTemporalSuccessorOf(t[1][0][0])

   assert seq[0][0][-1]._navigator._isImmediateTemporalSuccessorOf(t[1])
   assert seq[0][0][-1]._navigator._isImmediateTemporalSuccessorOf(t[1][0])
   assert seq[0][0][-1]._navigator._isImmediateTemporalSuccessorOf(t[1][0][0])
