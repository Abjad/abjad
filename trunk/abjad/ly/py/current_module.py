...
current_module = {
    ...
    'book-output-suffix': 'book-output-suffix',
    ...
    'breve': _LilyPondDuration(Duration(2, 1), None),
    'cadenzaOff': {
        'name': 'SequentialMusic',
        'type': 'ly:prob?',
        'types': ('general-music', 'sequential-music',),
    ...
    'default-repeat-chord': 'default-repeat-chord',
    'defaultNoteHeads': {
        'signature': ('ly:music?',),
        'type': 'ly:music-function?',
    },
    ...
    'locrian': 'locrian',
    'longa': _LilyPondDuration(Duration(4, 1), None),
    'longfermata': {
    ...
    'make-repeat-chord-function': 'make-repeat-chord-function',
    ...
    'maxima': _LilyPondDuration(Duration(8, 1), None),
    'melisma': {
        'context-type': 'Bottom',
        'name': 'ContextSpeccedMusic',
        'type': 'ly:prob?',
    ...
    'tab-repeat-chord': 'tab-repeat-chord',
    'tabChordRepetition': {
        'signature': ('ly:music?',),
        'type': 'ly:music-function?',
    },
