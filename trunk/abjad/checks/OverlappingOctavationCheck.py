...
class OverlappingOctavationCheck(_Check):
   ...
   def _run(self, expr):
      ...
      for leaf in leaftools.iterate_leaves_forward_in_expr(expr):
         ...
         octavations = spannertools.get_all_spanners_attached_to_any_improper_child_of_component(
      ...
      total = spannertools.get_all_spanners_attached_to_any_improper_child_of_component(expr,
         OctavationSpanner)
