def zip_sequences_nontruncating(*lists):
   ...
   greater than or equal to ``1``. ::
      ...
      abjad> seqtools.zip_sequences_nontruncating([1, 2, 3, 4], [11, 12, 13])     
      [(1, 11), (2, 12), (3, 13), (4,)]

   ::

      abjad> seqtools.zip_sequences_nontruncating([1, 2, 3], [11, 12, 13, 14])
      [(1, 11), (2, 12), (3, 13), (14,)]
   ...
   Arbitrary numbers of lists are supported. ::
      ...
      abjad> seqtools.zip_sequences_nontruncating(k, l, m, n)
