...
def test_seqtools_CyclicMatrix___init___02():
    ...
    cyclic_matrix = seqtools.CyclicMatrix(columns = ((0, 10, 20), (1, 11, 21), (2, 12, 22), (3, 13, 23)))
...
def test_seqtools_CyclicMatrix___init___03():
    ...
    cyclic_matrix = seqtools.CyclicMatrix(((0, 1, 2, 3), (10, 11, 12, 13), (20, 21)))
...
def test_seqtools_CyclicMatrix___init___04():
    ...
    cyclic_matrix = seqtools.CyclicMatrix(columns = ((0, 10, 20), (1, 11, 21), (2, 12), (3, 13)))
