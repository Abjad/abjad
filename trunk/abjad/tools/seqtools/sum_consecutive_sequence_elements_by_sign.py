...
def sum_consecutive_sequence_elements_by_sign(sequence, sign = [-1, 0, 1]):
   ...
   ::
      ...
      abjad> seqtools.sum_consecutive_sequence_elements_by_sign(sequence)
      [0, -2, 5, -5, 8, -11]

   ::
   
      abjad> seqtools.sum_consecutive_sequence_elements_by_sign(sequence, sign = [-1])
      [0, 0, -2, 2, 3, -5, 1, 2, 5, -11]

   ::
   
      abjad> seqtools.sum_consecutive_sequence_elements_by_sign(sequence, sign = [0])
   ...
   ::
      ...
      abjad> seqtools.sum_consecutive_sequence_elements_by_sign(sequence, sign = [-1, 0])
      [0, -2, 2, 3, -5, 1, 2, 5, -11]

   ::
   
      abjad> seqtools.sum_consecutive_sequence_elements_by_sign(sequence, sign = [-1, 1])
      [0, 0, -2, 5, -5, 8, -11]
