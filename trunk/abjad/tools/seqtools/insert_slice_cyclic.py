def insert_slice_cyclic(l, s, overhang = (0, 0)):
   ...
   * When ``overhang[-1] == 1`` insert a copy of the elements of *s* \
   ...
   ::
      ...
      abjad> seqtools.insert_slice_cyclic(l, s)
      [0, 'A', 'B', 1, 'A', 'B', 2, 'A', 'B', 3, 'A', 'B', 4]

   ::

      abjad> seqtools.insert_slice_cyclic(l, s, overhang = (0, 1))
      [0, 'A', 'B', 1, 'A', 'B', 2, 'A', 'B', 3, 'A', 'B', 4, 'A', 'B']

   ::

      abjad> seqtools.insert_slice_cyclic(l, s, overhang = (1, 0))
      ['A', 'B', 0, 'A', 'B', 1, 'A', 'B', 2, 'A', 'B', 3, 'A', 'B', 4]

   ::

      abjad> seqtools.insert_slice_cyclic(l, s, overhang = (1, 1))
