...
def group_sequence_elements_cyclically_by_weights_at_most_without_overhang(sequence, weights):
   '''Group `sequence` elements cyclically by `weights` at most without overhang::

      abjad> sequence = [3, 3, 3, 3, 4, 4, 4, 4, 5]
      abjad> groups = seqtools.group_sequence_elements_cyclically_by_weights_at_most_without_overhang(sequence, [10, 5])
      [[3, 3, 3], [3], [4, 4], [4]]
