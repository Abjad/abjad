def splice_new_elements_between_sequence_elements(sequence, new_elements, overhang = (0, 0)):
    ...
    the last element of `sequence`::
        ...
        abjad> seqtools.splice_new_elements_between_sequence_elements(sequence, new_elements, overhang = (0, 1))
    ...
    between each of the other elements of `sequence`::
        ...
        abjad> seqtools.splice_new_elements_between_sequence_elements(sequence, new_elements, overhang = (1, 0))
    ...
    after the last element of `sequence` and between each of the other elements of `sequence`::
        ...
        abjad> seqtools.splice_new_elements_between_sequence_elements(sequence, new_elements, overhang = (1, 1))
