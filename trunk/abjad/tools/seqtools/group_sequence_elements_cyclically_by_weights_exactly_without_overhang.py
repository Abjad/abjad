...
def group_sequence_elements_cyclically_by_weights_exactly_without_overhang(sequence, weights):
   '''Group `sequence` elements cyclically by `weights` exactly without overhang::

      abjad> sequence = [3, 3, 3, 3, 4, 4, 4, 4, 5]
      abjad> groups = seqtools.group_sequence_elements_cyclically_by_weights_exactly_without_overhang(sequence, [12])
      [[3, 3, 3, 3], [4, 4, 4]]
