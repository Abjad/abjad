...
def partition_sequence_by_weights(l, weights, cyclic = False, overhang = False):
   ...
   * ``overhang``: boolean.
   ...
   With one-element ``weights`` list. ::
      ...
      abjad> l = [20, 20, 20, 20] 
      abjad> seqtools.partition_sequence_by_weights(l, [15])
      [[15]]

   ::

      abjad> l = [20, 20, 20, 20] 
      abjad> seqtools.partition_sequence_by_weights(l, [15], cyclic = True)
      [[15], [5, 10], [10, 5], [15], [15]]

   ::

      abjad> l = [20, 20, 20, 20] 
      abjad> seqtools.partition_sequence_by_weights(l, [15], overhang = True)
      [[15], [5, 20, 20, 20]]

   ::

      abjad> l = [20, 20, 20, 20]
      abjad> seqtools.partition_sequence_by_weights(l, [15], cyclic = True, overhang = True)
      [[15], [5, 10], [10, 5], [15], [15], [5]]

   With multi-element ``weights`` list. ::

      abjad> l = [20, 20, 20, 20]
      abjad> seqtools.partition_sequence_by_weights(l, [7, 15])
      [[7], [13, 2]]

   ::

      abjad> l = [20, 20, 20, 20]
      abjad> seqtools.partition_sequence_by_weights(l, [7, 15], cyclic = True)
      [[7], [13, 2], [7], [11, 4], [9, 6], [7]]

   ::

      abjad> l = [20, 20, 20, 20]
      abjad> seqtools.partition_sequence_by_weights(l, [7, 15], overhang = True)
      [[7], [13, 2], [18, 20, 20]]

   ::

      abjad> l = [20, 20, 20, 20]
      abjad> seqtools.partition_sequence_by_weights(l, [7, 15], cyclic = True, overhang = True)
