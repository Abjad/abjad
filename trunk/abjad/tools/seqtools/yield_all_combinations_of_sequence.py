...
def yield_all_combinations_of_sequence(sequence, min_length = None, max_length = None):
   ...
   Yield all combinations of `sequence` in binary string order::
      ...
      abjad> list(seqtools.yield_all_combinations_of_sequence([1, 2, 3, 4]))
   ...
   in binary string order::
      ...
      abjad> list(seqtools.yield_all_combinations_of_sequence([1, 2, 3, 4], min_length = 3))
      [[1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4], [1, 2, 3, 4]]

   Yield all combinations of `sequence` less than or equal to `max_length`
   in binary string order::

      abjad> list(seqtools.yield_all_combinations_of_sequence([1, 2, 3, 4], max_length = 2))
   ...
   less than or equal to `max_length` in lex order::
      ...
      abjad> list(seqtools.yield_all_combinations_of_sequence([1, 2, 3, 4], min_length = 2, max_length = 2))
