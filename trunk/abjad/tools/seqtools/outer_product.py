def outer_product(sequences):
   '''Return outer product of `sequences`::

      abjad> seqtools.outer_product([[1, 2, 3], ['a', 'b']])
      [[1, 'a'], [1, 'b'], [2, 'a'], [2, 'b'], [3, 'a'], [3, 'b']]

   ::

      abjad> seqtools.outer_product([[1, 2, 3], ['a', 'b'], ['X', 'Y']])
   ...
   ::
      ...
      abjad> seqtools.outer_product([[1, 2, 3], [4, 5], [6, 7, 8]])
