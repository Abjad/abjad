...
def yield_all_combinations_of_sequence_elements(sequence, min_length = None, max_length = None):
   ...
   in binary string order::
      ...
      abjad> list(seqtools.yield_all_combinations_of_sequence_elements([1, 2, 3, 4], min_length = 3))
   ...
   less than or equal to `max_length` in lex order::
      ...
      abjad> list(seqtools.yield_all_combinations_of_sequence_elements([1, 2, 3, 4], min_length = 2, max_length = 2))
   ...
   .. versionchanged:: 1.1.2
      renamed ``seqtools.yield_all_combinations_of_elements( )`` to
      ``seqtools.yield_all_combinations_of_sequence_elements( )``.
   '''
