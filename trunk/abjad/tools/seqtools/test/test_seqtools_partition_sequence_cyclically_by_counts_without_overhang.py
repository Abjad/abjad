...
def test_seqtools_partition_sequence_cyclically_by_counts_without_overhang_01( ):
   ...
   parts = seqtools.partition_sequence_cyclically_by_counts_without_overhang(range(16), [4, 6]) 
...
def test_seqtools_partition_sequence_cyclically_by_counts_without_overhang_02( ):
   ...
   counts = (0, 2, 0, 0, 4)
   parts = seqtools.partition_sequence_cyclically_by_counts_without_overhang(range(10), counts)
