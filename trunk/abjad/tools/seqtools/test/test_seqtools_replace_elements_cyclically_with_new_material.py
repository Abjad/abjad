...
def test_seqtools_replace_elements_cyclically_with_new_material_01( ):
   ...
   t = seqtools.replace_elements_cyclically_with_new_material(l, indices, material)

   assert t == ['A', 1, 'B', 3, 4, 5, 
      'A', 7, 'B', 9, 10, 11, 'A', 13, 'B', 15, 16, 17, 'A', 19]
   

def test_seqtools_replace_elements_cyclically_with_new_material_02( ):
   '''Overwrite elements in l at cyclic indices with cyclic material.
...
def test_seqtools_replace_elements_cyclically_with_new_material_03( ):
   '''Overwrite elements in l at cyclic indices with cyclic material.
...
def test_seqtools_replace_elements_cyclically_with_new_material_04( ):
   '''Overwrite elements in l at cyclic indices with cyclic material.
...
def test_seqtools_replace_elements_cyclically_with_new_material_05( ):
   '''Raise TypeError when l is not a list.'''

   assert py.test.raises(TypeError, 
      "seqtools.replace_elements_cyclically_with_new_material('foo', ([0], 2), ([10, 12], 3))")
