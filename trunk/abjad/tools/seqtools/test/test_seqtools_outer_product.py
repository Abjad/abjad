...
def test_seqtools_outer_product_01( ):
   t = seqtools.outer_product([[1, 2, 3], ['a', 'b']])      
   assert t == [[1, 'a'], [1, 'b'], [2, 'a'], [2, 'b'], [3, 'a'], [3, 'b']]


def test_seqtools_outer_product_02( ):
   t = seqtools.outer_product([[1, 2, 3], ['a', 'b'], ['X', 'Y']])
   assert t == [[1, 'a', 'X'], [1, 'a', 'Y'], [1, 'b', 'X'], [1, 'b', 'Y'], [2, 'a', 'X'] , [2, 'a', 'Y'], [2, 'b', 'X'], [2, 'b', 'Y'], [3, 'a', 'X'], [3, 'a', 'Y'], [3, 'b', 'X'], [3, 'b', 'Y']]


def test_seqtools_outer_product_03( ):
   t = seqtools.outer_product([[1, 2, 3], [4, 5], [6, 7, 8]])
