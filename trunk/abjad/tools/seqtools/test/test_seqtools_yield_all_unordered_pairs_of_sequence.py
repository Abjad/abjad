...
def test_seqtools_yield_all_unordered_pairs_of_sequence_01():
    ...
    t = list(seqtools.yield_all_unordered_pairs_of_sequence([1, 2, 3, 4]))
...
def test_seqtools_yield_all_unordered_pairs_of_sequence_02():
    ...
    assert list(seqtools.yield_all_unordered_pairs_of_sequence([1, 2])) == [(1, 2)]
...
def test_seqtools_yield_all_unordered_pairs_of_sequence_04():
    ...
    t = set([1, 2, 3])
    result = list(seqtools.yield_all_unordered_pairs_of_sequence(t) )
...
def test_seqtools_yield_all_unordered_pairs_of_sequence_05():
    ...
    assert list(seqtools.yield_all_unordered_pairs_of_sequence([1, 1])) == [(1, 1)]
    assert list(seqtools.yield_all_unordered_pairs_of_sequence([1, 1, 1])) == [(1, 1), (1, 1), (1, 1)]
