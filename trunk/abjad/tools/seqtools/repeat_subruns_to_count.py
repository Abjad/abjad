...
def repeat_subruns_to_count(l, indicators):
   ...
   insert ``5`` count of ``l[:2]`` at ``l[2:2]``::
      ...
      abjad> seqtools.repeat_subruns_to_count(l, [(0, 2, 5), (10, 2, 5)])
