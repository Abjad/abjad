...
def repeat_subruns_to_count(sequence, indicators):
   ...
   To insert ``10`` count of ``sequence[:2]`` at ``sequence[2:2]``::
      ...
      abjad> seqtools.repeat_subruns_to_count(range(20), [(0, 2, 10)])
   ...
   insert ``5`` count of ``sequence[:2]`` at ``sequence[2:2]``::
      ...
      abjad> seqtools.repeat_subruns_to_count(sequence, [(0, 2, 5), (10, 2, 5)])
   ...
   To insert ``2`` count of ``[18, 19, 0, 1]`` at ``sequence[2:2]``::
      ...
      abjad> seqtools.repeat_subruns_to_count(sequence, [(18, 4, 2)])
   ...
   To insert ``2`` count of ``[18, 19, 0, 1, 2, 3, 4]`` at ``sequence[4:4]``::
      ...
      abjad> seqtools.repeat_subruns_to_count(sequence, [(18, 8, 2)])
