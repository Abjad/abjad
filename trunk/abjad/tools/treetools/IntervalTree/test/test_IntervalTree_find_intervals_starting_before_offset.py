...
def test_IntervalTree_find_intervals_starting_before_offset_01( ):
...
def test_IntervalTree_find_intervals_starting_before_offset_02( ):
    blocks = _make_test_blocks( )
    target_offset = 9
...
def test_IntervalTree_find_intervals_starting_before_offset_03( ):
    blocks = _make_test_blocks( )
    target_offset = 14
    expected_payloads = ('a', 'b', 'c', 'd',)
    expected_blocks = tuple(sorted(filter(lambda x: x.data in expected_payloads, blocks),
...
def test_IntervalTree_find_intervals_starting_before_offset_04( ):
    blocks = _make_test_blocks( )
    target_offset = 19
...
def test_IntervalTree_find_intervals_starting_before_offset_05( ):
    blocks = _make_test_blocks( )
    target_offset = 26
...
def test_IntervalTree_find_intervals_starting_before_offset_06( ):
    blocks = _make_test_blocks( )
    target_offset = 30
    expected_payloads = ('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k',)
    expected_blocks = tuple(sorted(filter(lambda x: x.data in expected_payloads, blocks),
        key = lambda x: x.signature))
    for i in range(len(blocks)):
        blocks.append(blocks.pop(0)) # rotate to permute tree construction
