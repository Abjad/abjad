...
def test_treetools_shift_aggregate_offset_by_rational_01( ):
   rational = 0
...
def test_treetools_shift_aggregate_offset_by_rational_02( ):
...
def test_treetools_shift_aggregate_offset_by_rational_03( ):
   rational = Fraction(-1, 2)
   tree = IntervalTree(_make_test_blocks( ))
...
def test_treetools_shift_aggregate_offset_by_rational_04( ):
   rational = Fraction(-1, 2)
   tree = IntervalTree(_make_test_blocks( ))
