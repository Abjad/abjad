...
def test_treetools_mask_intervals_with_intervals_while_preserving_payloads_01( ):
    a = BoundedInterval(0, 9, 'a')
    b = BoundedInterval(6, 10, 'b')
    c = BoundedInterval(5, 10, 'c')
    masked = IntervalTree([a, b])
    mask = IntervalTree([c])
    result = mask_intervals_with_intervals_while_preserving_payloads(masked, mask)
...
def test_treetools_mask_intervals_with_intervals_while_preserving_payloads_02( ):
    a = BoundedInterval(0, 9, 'a')
    b = BoundedInterval(6, 10, 'b')
