...
from abjad.tools.treetools import compute_logical_xor_of_tree_or_trees
from abjad.tools.treetools._make_test_blocks import _make_test_blocks


def test_treetools_compute_logical_xor_of_tree_or_trees_01( ):
    tree = IntervalTree(_make_test_blocks( ))
    logical_xor = compute_logical_xor_of_tree_or_trees(tree)
