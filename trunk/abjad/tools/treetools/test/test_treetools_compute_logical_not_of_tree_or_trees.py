...
from abjad.tools.treetools import compute_logical_not_of_tree_or_trees
from abjad.tools.treetools._make_test_blocks import _make_test_blocks


def test_treetools_compute_logical_not_of_tree_or_trees_01( ):
    tree = IntervalTree(_make_test_blocks( ))
    logical_not = compute_logical_not_of_tree_or_trees(tree)
