...
def test_treetools_calculate_depth_of_intervals_in_interval_01( ):
...
def test_treetools_calculate_depth_of_intervals_in_interval_02( ):
   a = BoundedInterval(0, 3)
   b = BoundedInterval(6, 12)
   c = BoundedInterval(9, 15)
   tree = IntervalTree([a, b, c])
...
def test_treetools_calculate_depth_of_intervals_in_interval_03( ):
   a = BoundedInterval(0, 3)
   b = BoundedInterval(6, 12)
   c = BoundedInterval(9, 15)
   tree = IntervalTree([a, b, c])
