...
def test_MarkupCommand___init____01( ):
...
def test_MarkupCommand___init____02( ):
...
def test_MarkupCommand___init____03( ):
...
def test_MarkupCommand___init____04( ):
   '''`braced` defaults to `True`.'''
   a = markuptools.MarkupCommand('draw-circle', ['#1', '#0.1', '##f'], None)
   assert a.braced == True
