...
def leaves_forward_in_expr(expr, start = 0, stop = None):
   ...
   ::
      ...
      abjad> for leaf in iterate.leaves_forward_in_expr(staff):
      ...     leaf
      ... 
      Note(c', 8)
      Note(d', 8)
   ...
   the start and stop indices of iteration. ::
      ...
      abjad> for leaf in iterate.leaves_forward_in_expr(staff, start = 3):
      ...     leaf
      ... 
      Note(f', 8)
      Note(g', 8)
   ...
   ::
      ...
      abjad> for leaf in iterate.leaves_forward_in_expr(staff, start = 0, stop = 3):
      ...     leaf
      ... 
      Note(c', 8)
      Note(d', 8)
   ...
   ::
      ...
      abjad> for leaf in iterate.leaves_forward_in_expr(staff, start = 2, stop = 4):
      ...     leaf
      ... 
      Note(e', 8)
      Note(f', 8)
   ...
   .. versionchanged:: 1.1.2
      ...
      ``iterate.leaves_forward_in_expr( )``.
   '''
