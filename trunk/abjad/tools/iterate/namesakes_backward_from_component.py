def namesakes_backward_from_component(component, start = 0, stop = None):
   ...
   ::
      ...
      abjad> for staff in iterate.namesakes_backward_from_component(score[-1][0]):
      ...     print staff.format
      ... 
      \context Staff = "staff 1" {
              g'8
   ...
   .. versionchanged:: 1.1.2
      ...
      ``iterate.namesakes_backward_from_component( )``.
   '''
