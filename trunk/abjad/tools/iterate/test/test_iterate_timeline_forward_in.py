...
def test_iterate_timeline_forward_in_01( ):
   ...
   leaf_generator = iterate.timeline_forward_in(score_1)
...
def test_iterate_timeline_forward_in_02( ):
   '''Yield klass instances in expr sorted by score offset
   and score index.
   '''
   ...
   leaf_generator = iterate.timeline_forward_in(score)
   leaves = list(leaf_generator)
