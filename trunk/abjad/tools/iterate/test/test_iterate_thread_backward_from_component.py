...
def test_iterate_thread_backward_from_component_01( ):
   '''Iterate only notes.'''
   ...
   notes = iterate.thread_backward_from_component(staff.leaves[-1], Note)
   notes = list(notes)
...
def test_iterate_thread_backward_from_component_02( ):
   ...
   components = iterate.thread_backward_from_component(staff.leaves[-1])
