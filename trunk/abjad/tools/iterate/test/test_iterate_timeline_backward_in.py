...
def test_iterate_timeline_backward_in_01( ):
   ...
   leaf_generator = iterate.timeline_backward_in(score_1)
...
def test_iterate_timeline_backward_in_02( ):
   ...
   leaf_generator = iterate.timeline_backward_in(score)
   leaves = list(leaf_generator)
