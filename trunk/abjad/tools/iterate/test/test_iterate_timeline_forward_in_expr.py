...
def test_iterate_timeline_forward_in_expr_01( ):
   ...
   leaf_generator = iterate.timeline_forward_in_expr(score_1)
...
def test_iterate_timeline_forward_in_expr_02( ):
   '''Yield klass instances in expr sorted by score offset
   and score index.
   '''
   ...
   leaf_generator = iterate.timeline_forward_in_expr(score)
   leaves = list(leaf_generator)
