...
def test_iterate_leaf_pairs_forward_in_01( ):
   ...
   pairs = iterate.leaf_pairs_forward_in(score)
   pairs = list(pairs)

   assert len(pairs) == 15
   assert pairs[0] == set([score[0][0], score[1][0]])
   ...
   assert pairs[7] == set([score[0][2], score[1][1]])
   ...
   assert pairs[14] == set([score[0][4], score[1][2]])
