...
def test_iterate_pitch_pairs_forward_in_expr_01( ):
   ...
   pairs = iterate.pitch_pairs_forward_in_expr(score)
   pairs = list(pairs)
...
def test_iterate_pitch_pairs_forward_in_expr_02( ):
   ...
   pairs = iterate.pitch_pairs_forward_in_expr(staff)
   pairs = list(pairs)
