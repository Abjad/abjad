...
def test_iterate_timeline_backward_in_expr_01( ):
   ...
   leaf_generator = iterate.timeline_backward_in_expr(score_1)
...
def test_iterate_timeline_backward_in_expr_02( ):
   ...
   leaf_generator = iterate.timeline_backward_in_expr(score)
   leaves = list(leaf_generator)
