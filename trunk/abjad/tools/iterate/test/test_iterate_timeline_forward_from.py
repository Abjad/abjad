...
def test_iterate_timeline_forward_from_01( ):
   ...
   leaf_generator = iterate.timeline_forward_from(staff_2[2])
...
def test_iterate_timeline_forward_from_02( ):
   '''Yield klass instances in score of expr,
   sorted by score offset and score index,
   and starting from expr.
   '''
   ...
   leaf_generator = iterate.timeline_forward_from(staff_1[3])
   leaves = list(leaf_generator)
