...
def test_iterate_topmost_tie_chains_and_components_forward_in_expr_01( ):
   ...
   chained_contents = list(iterate.topmost_tie_chains_and_components_forward_in_expr(t))
