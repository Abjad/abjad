...
def test_iterate_namesakes_forward_from_component_01( ):
   ...
   staves = iterate.namesakes_forward_from_component(score[0][0])
   staves = list(staves)
...
def test_iterate_namesakes_forward_from_component_02( ):
   ...
   notes = iterate.namesakes_forward_from_component(score.leaves[0])
   notes = list(notes)
...
def test_iterate_namesakes_forward_from_component_03( ):
   ...
   g = iterate.namesakes_forward_from_component(t.leaves[1], 0, 3)
...
def test_iterate_namesakes_forward_from_component_04( ):
   '''Optional start and stop keywords.'''
   ...
   g = iterate.namesakes_forward_from_component(t.leaves[1], 2)
