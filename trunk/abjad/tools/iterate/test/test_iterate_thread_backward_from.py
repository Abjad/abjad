...
def test_iterate_thread_backward_from_01( ):
   '''Iterate only notes.'''
   ...
   notes = iterate.thread_backward_from(staff.leaves[-1], Note)
   notes = list(notes)
...
def test_iterate_thread_backward_from_02( ):
   ...
   components = iterate.thread_backward_from(staff.leaves[-1])
