...
def test_iterate_vertical_moments_backward_in_expr_01( ):
   ...
   moment_generator = iterate.vertical_moments_backward_in_expr(score)
...
def test_iterate_vertical_moments_backward_in_expr_02( ):
   ...
   moment_generator = iterate.vertical_moments_backward_in_expr(piano_staff)
   moments = list(moment_generator)
