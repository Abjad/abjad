...
def test_iterate_vertical_moments_backward_in_01( ):
   ...
   moment_generator = iterate.vertical_moments_backward_in(score)
...
def test_iterate_vertical_moments_backward_in_02( ):
   ...
   moment_generator = iterate.vertical_moments_backward_in(piano_staff)
   moments = list(moment_generator)
