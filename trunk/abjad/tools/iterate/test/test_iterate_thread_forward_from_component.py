...
def test_iterate_thread_forward_from_component_01( ):
   ...
   notes = iterate.thread_forward_from_component(staff.leaves[0], Note)
   notes = list(notes)
...
def test_iterate_thread_forward_from_component_02( ):
   ...
   components = iterate.thread_forward_from_component(staff.leaves[0])
