...
def test_iterate_measure_prev_01( ):
   ...
   assert iterate.measure_prev(t.leaves[0]) is t[0][0]
   assert iterate.measure_prev(t.leaves[1]) is t[0][0]
   assert iterate.measure_prev(t.leaves[2]) is t[0][1]
   assert iterate.measure_prev(t.leaves[3]) is t[0][1]
   assert iterate.measure_prev(t.leaves[4]) is t[1]
...
def test_iterate_measure_prev_02( ):
   ...
   t = [RigidMeasure((2, 8), leaftools.make_first_n_notes_in_ascending_diatonic_scale(2)), Note(0, (1, 4))]
