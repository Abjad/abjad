...
def vertical_moments_forward_in_expr(governor):
   ...
   Yield vertical moments forward in `governor`. ::
      ...
      \new Score <<
              ...
              >>
      >>
      abjad> for vertical_moment in iterate.vertical_moments_forward_in_expr(score):
      ...
      abjad> for vertical_moment in iterate.vertical_moments_forward_in_expr(piano_staff):
      ...     vertical_moment.leaves
      ... 
      (Note(a', 4), Note(f', 8))
      (Note(a', 4), Note(e', 8))
