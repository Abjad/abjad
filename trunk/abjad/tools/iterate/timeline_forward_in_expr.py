...
def timeline_forward_in_expr(expr, klass = _Leaf):
   ...
   sorted forward by prolated offset start time. ::
      ...
      >>
      abjad> for leaf in iterate.timeline_forward_in_expr(score):
      ...     leaf
      ... 
      Note(c', 4)
      Note(g', 8)
   ...
   .. versionchanged:: 1.1.2
      ...
      ``iterate.timeline_forward_in_expr( )``.
   '''

   component_generator = naive_forward_in_expr(expr, klass = klass)
