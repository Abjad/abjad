...
def tie_chains_backward_in_expr(expr):
   ...
   ::
      ...
      abjad> for x in iterate.tie_chains_backward_in_expr(t):
      ...     x
      ... 
      (Note(f', 4), Note(f', 16))
      (Note(e', 8),)
   ...
   .. versionchanged:: 1.1.2
      ...
      ``iterate.tie_chains_backward_in_expr( )``.
   '''

   for leaf in naive_backward_in_expr(expr, _Leaf):
