def timespan_2_overlaps_stop_of_timespan_1(timespan_1=None, timespan_2=None, hold=False):
    ...
    Make time relation template indicating that `timespan_2` overlaps stop of `timespan_1`:

    ::

        >>> z(timerelationtools.timespan_2_overlaps_stop_of_timespan_1())
        timerelationtools.TimespanTimespanTimeRelation(
            'timespan_2.start_offset < timespan_1.stop_offset < timespan_2.stop_offset',
