def timespan_2_curtails_timespan_1(timespan_1=None, timespan_2=None, hold=False):
    ...
    Make time relation indicating that `timespan_2` curtails `timespan_1`:
    ...
    ::
        ...
        timerelationtools.TimespanTimespanTimeRelation(
            ...
            ['timespan_1.start < timespan_2.start', 'timespan_2.start <= timespan_1.stop', 'timespan_1.stop <= timespan_2.stop']
            )
