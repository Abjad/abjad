...
def test_listtools_repeat_sequence_to_weight_02( ):
   ...
   l = [5, 5, 5]
   t = listtools.repeat_sequence_to_weight(l, 23, remainder = 'less')
...
def test_listtools_repeat_sequence_to_weight_03( ):
   ...
   l = [5, 5, 5]
   t = listtools.repeat_sequence_to_weight(l, 23, remainder = 'more')

   assert t == [5, 5, 5, 5, 5]


def test_listtools_repeat_sequence_to_weight_04( ):
