...
def test_listtools_generate_all_restricted_growth_functions_of_length_01( ):

   rgfs = listtools.generate_all_restricted_growth_functions_of_length(3)
...
def test_listtools_generate_all_restricted_growth_functions_of_length_02( ):

   rgfs = listtools.generate_all_restricted_growth_functions_of_length(4)
