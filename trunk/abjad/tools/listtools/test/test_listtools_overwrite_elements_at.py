...
def test_listtools_overwrite_elements_at_01( ):
   ...
   t = listtools.overwrite_elements_at(l, indices, material)

   assert t == ['A', 1, 'B', 3, 4, 5, 
      'A', 7, 'B', 9, 10, 11, 'A', 13, 'B', 15, 16, 17, 'A', 19]
   

def test_listtools_overwrite_elements_at_02( ):
   '''Overwrite elements in l at cyclic indices with cyclic material.
...
def test_listtools_overwrite_elements_at_03( ):
   '''Overwrite elements in l at cyclic indices with cyclic material.
...
def test_listtools_overwrite_elements_at_04( ):
   '''Overwrite elements in l at cyclic indices with cyclic material.
...
def test_listtools_overwrite_elements_at_05( ):
   '''Raise TypeError when l is not a list.'''

   assert py.test.raises(TypeError, 
      "listtools.overwrite_elements_at('foo', ([0], 2), ([10, 12], 3))")
