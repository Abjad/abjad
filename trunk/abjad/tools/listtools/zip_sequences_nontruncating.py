def zip_sequences_nontruncating(*lists):
   '''Zip but do not truncate like built-in Python :func:`zip`.

   Lengths of the tuples returned may differ but will always be 
   greater than or equal to ``1``. ::

      abjad> listtools.zip_sequences_nontruncating([1, 2, 3, 4], [11, 12, 13])     
      [(1, 11), (2, 12), (3, 13), (4,)]

   ::

      abjad> listtools.zip_sequences_nontruncating([1, 2, 3], [11, 12, 13, 14])
      [(1, 11), (2, 12), (3, 13), (14,)]
   ...
   Arbitrary numbers of lists are supported. ::
      ...
      abjad> listtools.zip_sequences_nontruncating(k, l, m, n)
      [(100, 200, 300, 400), (101, 301, 401), (102, 302, 402), (403,), (404,), (405,), (406,), (407,)]

   .. versionchanged:: 1.1.2
      renamed ``listtools.zip_nontruncating( )`` to
      ``listtools.zip_sequences_nontruncating( )``.
   '''
