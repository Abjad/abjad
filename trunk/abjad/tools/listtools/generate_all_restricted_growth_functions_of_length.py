def generate_all_restricted_growth_functions_of_length(n):
   '''.. versionadded:: 1.1.2

   Yield all restricted growth functions of length `n` in lex order. ::

      abjad> for rgf in listtools.generate_all_restricted_growth_functions_of_length(4):
      ...     rgf
      ... 
      [1, 1, 1, 1]
      [1, 1, 1, 2]
   ...
   .. versionchanged:: 1.1.2
      ...
      ``listtools.generate_all_restricted_growth_functions_of_length( )``.

   .. versionchanged:: 1.1.2
      renamed ``listtools.yield_all_restricted_growth_functions_of_length( )`` to
      ``listtools.generate_all_restricted_growth_functions_of_length( )``.
   '''
