...
def yield_all_combinations_of_iterable(l, min_length = None, max_length = None):
   '''.. versionadded:: 1.1.2
   ...
   .. note :: ``listtools.yield_all_combinations_of_iterable`` will deprecate when Abjad migrates to
