...
def partition_sequence_by_restricted_growth_function(l, restricted_growth_function):
   ...
   Partition `l` by `restricted_growth_function`. ::
      ...
      abjad> listtools.partition_sequence_by_restricted_growth_function(l, rgf)
      [[0, 1, 4], [2, 3, 5, 8], [6, 7], [9]]
   ...
   .. versionchanged:: 1.1.2
      renamed ``listtools.partition_by_restricted_growth_function( )`` to
      ``listtools.partition_sequence_by_restricted_growth_function( )``.
   '''
