def get_context_mark_format_contributions(component, slot):
    r'''.. versionadded:: 2.0
    ...
    for candidate in candidates:
        if candidate._format_slot == slot and candidate_start_component is not None:
