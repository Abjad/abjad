...
def test_TonalAnalysisSelection_analyze_tonal_functions_01():
    ...
    tonal_function = tonalanalysistools.TonalFunction(1, 'major', 5, 1)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]

    chord = Chord(['g', "c'", "e'"], (1, 4))
    tonal_function = tonalanalysistools.TonalFunction(1, 'major', 5, 2)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]
...
def test_TonalAnalysisSelection_analyze_tonal_functions_02():
    ...
    tonal_function = tonalanalysistools.TonalFunction(1, 'minor', 5, 0)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]

    chord = Chord(['ef', 'g', "c'"], (1, 4))
    tonal_function = tonalanalysistools.TonalFunction(1, 'minor', 5, 1)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]

    chord = Chord(['g', "c'", "ef'"], (1, 4))
    tonal_function = tonalanalysistools.TonalFunction(1, 'minor', 5, 2)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]
...
def test_TonalAnalysisSelection_analyze_tonal_functions_03():
    ...
    tonal_function = tonalanalysistools.TonalFunction(1, 'dominant', 7, 0)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]

    chord = Chord(['e', 'g', 'bf', "c'"], (1, 4))
    tonal_function = tonalanalysistools.TonalFunction(1, 'dominant', 7, 1)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]

    chord = Chord(['g', 'bf', "c'", "e'"], (1, 4))
    tonal_function = tonalanalysistools.TonalFunction(1, 'dominant', 7, 2)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]

    chord = Chord(['bf', "c'", "e'", "g'"], (1, 4))
    tonal_function = tonalanalysistools.TonalFunction(1, 'dominant', 7, 3)
    selection = tonalanalysistools.select(chord)
    result = selection.analyze_tonal_functions(key_signature)
    assert result == [tonal_function]
