...
def test_notetools_make_repeated_notes_with_shorter_notes_at_end_01( ):
   ...
   t = Voice(notetools.make_repeated_notes_with_shorter_notes_at_end(0, Rational(1, 16), Rational(1, 4)))
...
def test_notetools_make_repeated_notes_with_shorter_notes_at_end_02( ):
   ...
   t = Voice(notetools.make_repeated_notes_with_shorter_notes_at_end(0, Rational(1, 16), Rational(9, 32)))
...
def test_notetools_make_repeated_notes_with_shorter_notes_at_end_03( ):
   ...
   t = Voice(notetools.make_repeated_notes_with_shorter_notes_at_end(0, Rational(1, 16), Rational(1, 128)))
...
def test_notetools_make_repeated_notes_with_shorter_notes_at_end_04( ):
   ...
   t = Voice(notetools.make_repeated_notes_with_shorter_notes_at_end(0, Rational(1, 16), Rational(4, 10)))
