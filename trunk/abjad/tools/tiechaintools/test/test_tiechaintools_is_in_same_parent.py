...
def test_tiechaintools_is_in_same_parent_01( ):
   '''False for unincorporated components.'''

   t = run(4)
   Tie(t[:])

   assert tiechaintools.is_in_same_parent(t[0].tie.chain)


def test_tiechaintools_is_in_same_parent_02( ):
...
def test_tiechaintools_is_in_same_parent_03( ):
...
def test_tiechaintools_is_in_same_parent_04( ):
   ...
   assert tiechaintools.is_in_same_parent(t.leaves[0].tie.chain)
   assert tiechaintools.is_in_same_parent(t.leaves[1].tie.chain)
   assert not tiechaintools.is_in_same_parent(t.leaves[2].tie.chain)
   assert not tiechaintools.is_in_same_parent(t.leaves[3].tie.chain)
   assert tiechaintools.is_in_same_parent(t.leaves[4].tie.chain)
   assert tiechaintools.is_in_same_parent(t.leaves[5].tie.chain)
