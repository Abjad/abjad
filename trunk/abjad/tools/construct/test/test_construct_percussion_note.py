...
def test_construct_percussion_note_01( ):
   '''tied total_duration < max_note_duration.'''

   t = construct.percussion_note(1, (5, 64), (1, 1))
...
def test_construct_percussion_note_02( ):
   '''tied total_duration > max_note_duration.'''

   t = construct.percussion_note(1, (5, 64), (1, 64))
...
def test_construct_percussion_note_03( ):
   '''non-tied total_duration < max_note_duration.'''

   t = construct.percussion_note(1, (3, 64), (1, 1))
...
def test_construct_percussion_note_04( ):
   '''non-tied total_duration > max_note_duration.'''

   t = construct.percussion_note(1, (3, 64), (1, 64))
