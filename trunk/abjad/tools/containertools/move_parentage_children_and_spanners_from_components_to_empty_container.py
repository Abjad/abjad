...
def move_parentage_children_and_spanners_from_components_to_empty_container(components, container):
    ...
    from abjad.tools.componenttools._give_position_in_parent_from_donor_components_to_recipient_components import \
        _give_position_in_parent_from_donor_components_to_recipient_components
