...
def replace_smaller_right_half_of_elements_in_container_with_little_endian_rests(container):
   ...
   Replace smaller right half of elements in `container` with little-endian rests::
   ...
   return _replace_half_of_elements_in_container_with_rests(container, 'right', 'left', 'little-endian')
