...
def get_first_element_starting_strictly_before_offset(
    container, prolated_offset):
    '''Get first `container` element starting strictly before 
    `prolated_offset`:
    ...
    Return none when `container` element starts stirctly before 
    `prolated_offset`.
    '''
