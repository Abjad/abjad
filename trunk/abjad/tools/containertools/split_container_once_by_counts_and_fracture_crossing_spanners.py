def split_container_once_by_counts_and_fracture_crossing_spanners(container, counts):
    r'''Split `container` once by `counts` and fracture crossing spanners::
    ...
    ::
        ...
        >>> containertools.split_container_once_by_counts_and_fracture_crossing_spanners(container, [1, 3])
    ...
    return containertools.split_container_by_counts(container, counts, fracture_spanners=True)
