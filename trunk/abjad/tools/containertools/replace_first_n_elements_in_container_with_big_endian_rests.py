...
def replace_first_n_elements_in_container_with_big_endian_rests(container, n):
   r'''.. versionadded:: 1.1.2

   For positive `n` replace first `n` elements in `container` with big-endian rests::

      abjad> staff = Staff(macros.scale(6))
      abjad> containertools.replace_first_n_elements_in_container_with_big_endian_rests(staff, 5)
      abjad> f(staff)
      \new Staff {
         r2
         r8
