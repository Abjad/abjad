...
def replace_larger_left_half_of_elements_in_container_with_big_endian_rests(container):
    r'''.. versionadded:: 2.0

    Replace larger left half of elements in `container` with big-endian rests::
    ...
    return _replace_half_of_elements_in_container_with_rests(container, 'left', 'left', 'big-endian')
