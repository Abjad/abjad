...
def test_containertools_get_first_element_starting_strictly_after_prolated_offset_01( ):
   ...
   element = containertools.get_first_element_starting_strictly_after_prolated_offset(staff, Fraction(1, 8))
...
def test_containertools_get_first_element_starting_strictly_after_prolated_offset_02( ):
   ...
   staff = Staff(macros.scale(4))
   element = containertools.get_first_element_starting_strictly_after_prolated_offset(staff, Fraction(3, 16))
