...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_01():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_02():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_03():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_04():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_05():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_06():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_07():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_08():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_09():
    '''Index split tuplet in score and do not fracture spanners.'''
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_10():
...
def test_containertoolssplit_container_at_index_and_do_not_fracture_crossing_spanners_11():
