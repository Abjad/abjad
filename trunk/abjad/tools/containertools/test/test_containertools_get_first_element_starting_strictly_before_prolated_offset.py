...
def test_containertools_get_first_element_starting_strictly_before_prolated_offset_01( ):
   ...
   element = containertools.get_first_element_starting_strictly_before_prolated_offset(staff, Rational(1, 8))
...
def test_containertools_get_first_element_starting_strictly_before_prolated_offset_02( ):
   ...
   staff = Staff(leaftools.make_first_n_notes_in_ascending_diatonic_scale(4))
   element = containertools.get_first_element_starting_strictly_before_prolated_offset(staff, Rational(3, 16))
...
def test_containertools_get_first_element_starting_strictly_before_prolated_offset_04( ):
   ...
   staff = Staff(leaftools.make_first_n_notes_in_ascending_diatonic_scale(4))
   element = containertools.get_first_element_starting_strictly_before_prolated_offset(staff, Rational(0))
