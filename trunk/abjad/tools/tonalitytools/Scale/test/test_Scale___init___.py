...
def test_Scale___init____01( ):
   ...
   assert scale.key_signature == tonalitytools.KeySignature('g', 'major')


def test_Scale___init____02( ):
   '''Init with key signature instance.'''

   key_signature = tonalitytools.KeySignature('g', 'major')
...
def test_Scale___init____03( ):
   ...
   assert new.key_signature == tonalitytools.KeySignature('g', 'major')
