...
def test_timeintervaltools_compute_logical_and_of_intervals_in_interval_01():
    ...
    logic = timeintervaltools.compute_logical_and_of_intervals_in_interval(tree, d)
    assert [x.signature for x in logic] == [(9, 12)]


def test_timeintervaltools_compute_logical_and_of_intervals_in_interval_02():
    a = timeintervaltools.TimeInterval(0, 3)
    b = timeintervaltools.TimeInterval(6, 12)
    c = timeintervaltools.TimeInterval(9, 15)
    tree = timeintervaltools.TimeIntervalTree([a, b, c])
...
def test_timeintervaltools_compute_logical_and_of_intervals_in_interval_03():
    a = timeintervaltools.TimeInterval(0, 3)
    b = timeintervaltools.TimeInterval(6, 12)
    c = timeintervaltools.TimeInterval(9, 15)
    tree = timeintervaltools.TimeIntervalTree([a, b, c])
