...
def test_timeintervaltools_TimeIntervalTree_compute_logical_xor_01():
...
def test_timeintervaltools_TimeIntervalTree_compute_logical_xor_02():
...
def test_timeintervaltools_TimeIntervalTree_compute_logical_xor_03():
...
def test_timeintervaltools_TimeIntervalTree_compute_logical_xor_04():
    time_interval_1 = timeintervaltools.TimeInterval(0, 3)
    time_interval_2 = timeintervaltools.TimeInterval(6, 12)
    time_interval_3 = timeintervaltools.TimeInterval(9, 15)
    tree = timeintervaltools.TimeIntervalTree([time_interval_1, time_interval_2, time_interval_3])
...
def test_timeintervaltools_TimeIntervalTree_compute_logical_xor_05():
    time_interval_1 = timeintervaltools.TimeInterval(0, 3)
    time_interval_2 = timeintervaltools.TimeInterval(6, 12)
    time_interval_3 = timeintervaltools.TimeInterval(9, 15)
    tree = timeintervaltools.TimeIntervalTree([time_interval_1, time_interval_2, time_interval_3])
