...
def test_TimeIntervalTree_find_intervals_starting_after_offset_01():
...
def test_TimeIntervalTree_find_intervals_starting_after_offset_02():
    blocks = _make_test_intervals()
    target_offset = 9
...
def test_TimeIntervalTree_find_intervals_starting_after_offset_03():
    blocks = _make_test_intervals()
    target_offset = 14
    expected_payloads = ('e', 'f', 'g', 'h', 'i', 'j', 'k', 'l',)
    expected_blocks = TimeIntervalTree([x for x in blocks if x['name'] in expected_payloads])
...
def test_TimeIntervalTree_find_intervals_starting_after_offset_04():
    blocks = _make_test_intervals()
    target_offset = 19
...
def test_TimeIntervalTree_find_intervals_starting_after_offset_05():
    blocks = _make_test_intervals()
    target_offset = 26
...
def test_TimeIntervalTree_find_intervals_starting_after_offset_06():
    blocks = _make_test_intervals()
    target_offset = 30
    expected_payloads = ('k', 'l',)
    expected_blocks = TimeIntervalTree([x for x in blocks if x['name'] in expected_payloads])
