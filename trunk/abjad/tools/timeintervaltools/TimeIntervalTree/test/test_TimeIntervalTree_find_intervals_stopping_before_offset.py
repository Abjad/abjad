...
def test_TimeIntervalTree_find_intervals_stopping_before_offset_01():
...
def test_TimeIntervalTree_find_intervals_stopping_before_offset_02():
    blocks = _make_test_intervals()
    target_offset = 9
    expected_payloads = ('a',)
    expected_blocks = TimeIntervalTree([x for x in blocks if x['name'] in expected_payloads])
...
def test_TimeIntervalTree_find_intervals_stopping_before_offset_03():
    blocks = _make_test_intervals()
    target_offset = 14
...
def test_TimeIntervalTree_find_intervals_stopping_before_offset_04():
    blocks = _make_test_intervals()
    target_offset = 19
    expected_payloads = ('a', 'b', 'c', 'd',)
    expected_blocks = TimeIntervalTree([x for x in blocks if x['name'] in expected_payloads])
...
def test_TimeIntervalTree_find_intervals_stopping_before_offset_05():
    blocks = _make_test_intervals()
    target_offset = 26
...
def test_TimeIntervalTree_find_intervals_stopping_before_offset_06():
    blocks = _make_test_intervals()
    target_offset = 30
