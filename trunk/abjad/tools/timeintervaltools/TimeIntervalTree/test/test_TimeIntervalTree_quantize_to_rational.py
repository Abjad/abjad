...
def test_TimeIntervalTree_quantize_to_rational_01():
...
def test_TimeIntervalTree_quantize_to_rational_02():
    tree = TimeIntervalTree([
        TimeInterval(Fraction(1, 4), Fraction(7, 8)),
        TimeInterval(Fraction(1, 3), Fraction(5, 3))
    ])
...
def test_TimeIntervalTree_quantize_to_rational_03():
    tree = TimeIntervalTree([
        TimeInterval(Fraction(1, 4), Fraction(7, 8)),
        TimeInterval(Fraction(1, 3), Fraction(5, 3))
    ])
...
def test_TimeIntervalTree_quantize_to_rational_04():
    tree = TimeIntervalTree([
        TimeInterval(Fraction(1, 4), Fraction(7, 8)),
        TimeInterval(Fraction(1, 3), Fraction(5, 3))
    ])
...
def test_TimeIntervalTree_quantize_to_rational_05():
    tree = TimeIntervalTree([])
    result = tree.quantize_to_rational(1)
    assert result == tree
