...
def test_timeintervaltools_TimeIntervalTree_find_intervals_stopping_after_offset_01():
...
def test_timeintervaltools_TimeIntervalTree_find_intervals_stopping_after_offset_02():
    blocks = timeintervaltools.make_test_intervals()
    target_offset = 9
...
def test_timeintervaltools_TimeIntervalTree_find_intervals_stopping_after_offset_03():
    blocks = timeintervaltools.make_test_intervals()
    target_offset = 14
...
def test_timeintervaltools_TimeIntervalTree_find_intervals_stopping_after_offset_04():
    blocks = timeintervaltools.make_test_intervals()
    target_offset = 19
...
def test_timeintervaltools_TimeIntervalTree_find_intervals_stopping_after_offset_05():
    blocks = timeintervaltools.make_test_intervals()
    target_offset = 26
...
def test_timeintervaltools_TimeIntervalTree_find_intervals_stopping_after_offset_06():
    blocks = timeintervaltools.make_test_intervals()
    target_offset = 30
