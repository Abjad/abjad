...
def test_timeintervaltools_TimeIntervalTree_scale_by_rational_01():
...
def test_timeintervaltools_TimeIntervalTree_scale_by_rational_02():
...
def test_timeintervaltools_TimeIntervalTree_scale_by_rational_03():
...
def test_timeintervaltools_TimeIntervalTree_scale_by_rational_04():
    a = timeintervaltools.TimeInterval(durationtools.Multiplier(-1, 2), 1)
    b = timeintervaltools.TimeInterval(2, durationtools.Multiplier(7, 3))
    tree = timeintervaltools.TimeIntervalTree([a, b])
    rational = -1
...
def test_timeintervaltools_TimeIntervalTree_scale_by_rational_05():
    a = timeintervaltools.TimeInterval(durationtools.Multiplier(-1, 2), 1)
    b = timeintervaltools.TimeInterval(2, durationtools.Multiplier(7, 3))
    tree = timeintervaltools.TimeIntervalTree([a, b])
    rational = 0
