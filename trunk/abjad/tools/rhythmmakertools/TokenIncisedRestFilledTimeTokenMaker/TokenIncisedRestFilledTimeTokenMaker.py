from abjad.tools.rhythmmakertools.TokenIncisedTimeTokenMaker import TokenIncisedTimeTokenMaker
...
class TokenIncisedRestFilledTimeTokenMaker(TokenIncisedTimeTokenMaker):
    ...
    ::
        ...
        >>> denominator = 32
        >>> maker = rhythmmakertools.TokenIncisedRestFilledTimeTokenMaker(
