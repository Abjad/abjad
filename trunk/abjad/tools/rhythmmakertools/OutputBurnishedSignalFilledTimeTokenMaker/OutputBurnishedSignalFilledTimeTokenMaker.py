...
from abjad.tools.rhythmmakertools.BurnishedTimeTokenMaker import BurnishedTimeTokenMaker
...
class OutputBurnishedSignalFilledTimeTokenMaker(BurnishedTimeTokenMaker):
    ...
    ::
        ...
        >>> maker = rhythmmakertools.OutputBurnishedSignalFilledTimeTokenMaker(
