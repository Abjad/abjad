...
def test_SignalFilledTimeTokenMaker___call___01():
    ...
    maker = rhythmmakertools.SignalFilledTimeTokenMaker(pattern, denominator, prolation_addenda)
...
def test_SignalFilledTimeTokenMaker___call___02():
    ...
    maker = rhythmmakertools.SignalFilledTimeTokenMaker(pattern, denominator, prolation_addenda, secondary_divisions)
