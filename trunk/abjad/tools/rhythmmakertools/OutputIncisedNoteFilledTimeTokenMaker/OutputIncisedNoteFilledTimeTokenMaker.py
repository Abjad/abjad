from abjad.tools.rhythmmakertools.OutputIncisedTimeTokenMaker import OutputIncisedTimeTokenMaker
...
class OutputIncisedNoteFilledTimeTokenMaker(OutputIncisedTimeTokenMaker):
    ...
    ::
        ...
        >>> denominator = 32
        >>> maker = rhythmmakertools.OutputIncisedNoteFilledTimeTokenMaker(
