from abjad.tools.rhythmmakertools.TokenIncisedRestFilledTimeTokenMaker import TokenIncisedRestFilledTimeTokenMaker
...
class RestFilledTimeTokenMaker(TokenIncisedRestFilledTimeTokenMaker):
    ...
    ::
        ...
        >>> maker = rhythmmakertools.RestFilledTimeTokenMaker()
