...
def test_TaleaFilledRhythmMaker___eq___01():

    kaleid_1 = rhythmmakertools.TaleaFilledRhythmMaker([-1, 2, -3, 4], 16,
        prolation_addenda=[2, 3],
        secondary_divisions=[6],
        )

    kaleid_2 = rhythmmakertools.TaleaFilledRhythmMaker([-1, 2, -3, 4], 16,
        prolation_addenda=[2, 3],
        secondary_divisions=[6],
        )
