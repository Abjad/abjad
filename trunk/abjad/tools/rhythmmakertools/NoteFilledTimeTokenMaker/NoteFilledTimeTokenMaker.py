from abjad.tools.rhythmmakertools.TokenIncisedNoteFilledTimeTokenMaker import TokenIncisedNoteFilledTimeTokenMaker
...
class NoteFilledTimeTokenMaker(TokenIncisedNoteFilledTimeTokenMaker):
    ...
    ::
        ...
        >>> maker = rhythmmakertools.NoteFilledTimeTokenMaker()
