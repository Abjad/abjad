...
def tie_chain_into_arbitrary_diminution_undotted(tie_chain, proportions):
   ...
   do not allow tupletted notes to carry dots. ::
      ...
      abjad> Beam(staff[:])
      Beam(c'8, c'16, c'16)
      abjad> divide.tie_chain_into_arbitrary_diminution_undotted(staff[0].tie.chain, [1])
   ...
   ::
      ...
      abjad> Beam(staff[:])
      Beam(c'8, c'16, c'16)
      abjad> divide.tie_chain_into_arbitrary_diminution_undotted(staff[0].tie.chain, [1, 2, 2])
