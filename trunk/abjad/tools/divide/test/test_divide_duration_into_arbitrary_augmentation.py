...
def test_divide_duration_into_arbitrary_augmentation_01( ):

   duration = Rational(3, 16)

   t = divide.duration_into_arbitrary_augmentation(duration, [1])
   assert t.format == "\tc'8."
   ...
   t = divide.duration_into_arbitrary_augmentation(duration, [1, 2, 2, 3, 3])
   assert t.format == "\\fraction \\times 12/11 {\n\tc'64\n\tc'32\n\tc'32\n\tc'32.\n\tc'32.\n}"

   t = divide.duration_into_arbitrary_augmentation(duration, [1, 2, 2, 3, 3, 4])
