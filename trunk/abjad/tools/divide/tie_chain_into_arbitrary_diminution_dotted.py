...
def tie_chain_into_arbitrary_diminution_dotted(tie_chain, proportions):
   ...
   tupletted notes to carry dots. ::
      ...
      abjad> Beam(staff[:])
      Beam(c'8, c'16, c'16)
      abjad> divide.tie_chain_into_arbitrary_diminution_dotted(staff[0].tie.chain, [1])
   ...
   ::
      ...
      abjad> Beam(staff[:])
      Beam(c'8, c'16, c'16)
      abjad> divide.tie_chain_into_arbitrary_diminution_dotted(staff[0].tie.chain, [1, 2])
   ...
   ::
      ...
      abjad> Beam(staff[:])
      Beam(c'8, c'16, c'16)
      abjad> divide.tie_chain_into_arbitrary_diminution_dotted(staff[0].tie.chain, [1, 2, 2])
