...
def test_Inspector_get_effective_context_mark_01():
...
def test_Inspector_get_effective_context_mark_03():
    r'''Clef defaults to none.
...
def test_Inspector_get_effective_context_mark_04():
    r'''Clefs carry over to notes following.
    '''
...
def test_Inspector_get_effective_context_mark_05():
...
def test_Inspector_get_effective_context_mark_06():
...
def test_Inspector_get_effective_context_mark_07():
...
def test_Inspector_get_effective_context_mark_08():
...
def test_Inspector_get_effective_context_mark_12():
...
def test_Inspector_get_effective_context_mark_14():
...
def test_Inspector_get_effective_context_mark_15():
...
def test_Inspector_get_effective_context_mark_16():
    r'''Detach tempo mark.
    '''
...
def test_Inspector_get_effective_context_mark_17():
...
def test_Inspector_get_effective_context_mark_18():
...
def test_Inspector_get_effective_context_mark_19():
    r'''InputSetExpression and then clearing works as expected.
    '''
