...
def test_Inspector_select_descendants_01():
    ...
    cross_offset = more(staff).get_timespan().start_offset + Duration(1, 8)
...
def test_Inspector_select_descendants_02():
    ...
    cross_offset = more(staff).get_timespan().start_offset + Duration(1, 16)
    result = more(staff).select_descendants(cross_offset=cross_offset)
...
def test_Inspector_select_descendants_03():
    ...
    cross_offset = more(staff).get_timespan().start_offset + Duration(0)
    result = more(staff).select_descendants(cross_offset=cross_offset)
...
def test_Inspector_select_descendants_04():
    ...
    cross_offset = more(staff).get_timespan().start_offset + Duration(100)
    result = more(staff).select_descendants(cross_offset=cross_offset)
