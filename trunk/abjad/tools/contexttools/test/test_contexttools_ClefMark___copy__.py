...
def test_contexttools_ClefMark___copy___01():
    ...
    assert inspect(staff[0]).get_effective_context_mark(
        contexttools.ClefMark) == contexttools.ClefMark('treble')
    ...
    assert inspect(staff[4]).get_effective_context_mark(
        contexttools.ClefMark) == contexttools.ClefMark('bass')
...
def test_contexttools_ClefMark___copy___02():
