...
from abjad.tools.musicxmltools._get_voice_id_in_note_node \
   import _get_voice_id_in_note_node
from abjad.tools.musicxmltools._get_voice_ids_in_note_nodes \
   import _get_voice_ids_in_note_nodes
