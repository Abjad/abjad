...
def prolated_to_prolated(prolated_duration_1, 
   ...
   at tempo 2. ::
      ...
      abjad> durtools.prolated_to_prolated(Rational(1, 12), tempo_indication_1, tempo_indication_2):
      Rational(1, 8)

   Conversely, a regular eighth not at tempo 1 equals a dotted
   sixteenth at tempo 2. ::

      abjad> durtools.prolated_to_prolated(Rational(1, 8), tempo_indication_1, tempo_indication_2):
      Rational(3, 16)
   '''
