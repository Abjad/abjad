def rewrite_rational_under_new_tempo(prolated_duration_1, tempo_mark_1, tempo_mark_2):
   ...
   at tempo 2. ::
      ...
      abjad> durtools.rewrite_rational_under_new_tempo(Duration(1, 12), tempo_mark_1, tempo_mark_2)
      Duration(1, 8)

   Conversely, a regular eighth not at tempo 1 equals a dotted
   sixteenth at tempo 2. ::

      abjad> durtools.rewrite_rational_under_new_tempo(Duration(1, 8), tempo_mark_1, tempo_mark_2)
      Duration(3, 16)
