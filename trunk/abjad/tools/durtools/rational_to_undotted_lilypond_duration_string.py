...
def rational_to_undotted_lilypond_duration_string(rational):
   ...
   Convert `rational` to LilyPond-style undotted duration string. ::
      ...
      ...             undotted_duration_string = durtools.rational_to_undotted_lilypond_duration_string(rational)
   ...
   ::
      ...
      abjad> durtools.rational_to_undotted_lilypond_duration_string(Rational(2, 1))
      '\\breve'
   
   Raise assignability error when `rational` is not note-head-assignable. ::

      abjad> durtools.rational_to_undotted_lilypond_duration_string(Rational(5, 16))
      AssignabilityError

   .. versionchanged:: 1.1.2
      renamed ``durtools.rational_to_undotted_duration_string( )`` to
