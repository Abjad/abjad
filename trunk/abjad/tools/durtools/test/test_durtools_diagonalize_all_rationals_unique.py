...
def test_durtools_diagonalize_all_rationals_unique_01( ):

   generator = durtools.diagonalize_all_rationals_unique( )
   ...
   assert generator.next( ) == Rational(5, 2)
   assert generator.next( ) == Rational(4, 3)
   assert generator.next( ) == Rational(3, 4)
   assert generator.next( ) == Rational(2, 5)
