...
def test_durtools_rational_to_proper_fraction_01( ):
    ...
    assert durtools.rational_to_proper_fraction(Fraction(7, 5)) == (1, Fraction(2, 5))
    assert durtools.rational_to_proper_fraction(Fraction(8, 5)) == (1, Fraction(3, 5))
    assert durtools.rational_to_proper_fraction(Fraction(9, 5)) == (1, Fraction(4, 5))

    assert durtools.rational_to_proper_fraction(Fraction(10, 5)) == (2, 0)
    assert durtools.rational_to_proper_fraction(Fraction(11, 5)) == (2, Fraction(1, 5))
