...
def test_pitch_and_rhythm_skeleton_01( ):
   ...
   rest = Rest((1, 4))
   skeleton = persistencetools.pitch_and_rhythm_skeleton(rest)
   assert skeleton == "Rest(Rational(1, 4))"

   chord = Chord([0, 2, 4], (1, 4))
   skeleton = persistencetools.pitch_and_rhythm_skeleton(chord)
   assert skeleton == "Chord((('c', 4), ('d', 4), ('e', 4)), Rational(1, 4))"

   skip = Skip((1, 4))
   skeleton = persistencetools.pitch_and_rhythm_skeleton(skip)
...
def test_pitch_and_rhythm_skeleton_03( ):
   ...
   skeleton = persistencetools.pitch_and_rhythm_skeleton(score)
