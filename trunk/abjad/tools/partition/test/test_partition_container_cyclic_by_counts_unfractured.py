...
def test_partition_container_by_counts_unfractured_01( ):
   ...
   partition.container_cyclic_by_counts_unfractured(t[0], [1, 3])
...
def test_partition_container_by_counts_unfractured_02( ):
   ...
   partition.container_cyclic_by_counts_unfractured(t[0], [1])
