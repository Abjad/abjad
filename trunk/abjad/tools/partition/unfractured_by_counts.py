...
def unfractured_by_counts(components, counts):
   ...
   ::
      ...
      abjad> parts = partition.unfractured_by_counts(t[:], [1, 3])
      abjad> f(t)
      \new Voice {
         {
            c'8 [ (
   ...
   return partition__by_counts(components, counts, spanners = 'unfractured')
