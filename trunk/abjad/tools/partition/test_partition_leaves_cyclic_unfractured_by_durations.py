...
def test_split_leaves_cyclic_by_durations_01( ):
   ...
   split.leaves_cyclic_by_durations(t.leaves, [(1, 16)])
...
def test_split_leaves_cyclic_by_durations_02( ):
   ...
   split.leaves_cyclic_by_durations(t.leaves, [(1, 4)])
