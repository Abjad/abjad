...
def test_leaftools_iterate_notes_and_chords_in_expr_01():

    staff = Staff("<e' g' c''>8 a'8 r8 <d' f' b'>8 r2")

    notes_and_chords = leaftools.iterate_notes_and_chords_in_expr(staff, reverse=True)
...
def test_leaftools_iterate_notes_and_chords_in_expr_02():

    staff = Staff("<e' g' c''>8 a'8 r8 <d' f' b'>8 r2")

    notes_and_chords = leaftools.iterate_notes_and_chords_in_expr(staff)
    notes_and_chords = list(notes_and_chords)
