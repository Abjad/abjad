...
def test_Performer__tools_package_qualified_indented_repr_01():
    ...
    assert performer._tools_package_qualified_repr == "scoretools.Performer(name='Flute', instruments=instrumenttools.InstrumentInventory([instrumenttools.Flute(), instrumenttools.AltoFlute()]))"
