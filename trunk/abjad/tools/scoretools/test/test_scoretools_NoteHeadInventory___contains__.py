...
def test_scoretools_NoteHeadInventory___contains___01():
    ...
    assert pitchtools.NamedPitch(17) in chord.note_heads
    assert pitchtools.NamedPitch("f''") in chord.note_heads
...
def test_scoretools_NoteHeadInventory___contains___02():
    ...
    assert not pitchtools.NamedPitch(18) in chord.note_heads
    assert not pitchtools.NamedPitch("fs''") in chord.note_heads
