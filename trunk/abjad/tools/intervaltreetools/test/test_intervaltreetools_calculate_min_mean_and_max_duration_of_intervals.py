...
def test_intervaltreetools_calculate_min_mean_and_max_duration_of_intervals_01():
    tree = IntervalTree([])
    result = calculate_min_mean_and_max_duration_of_intervals(tree)
    assert result is None


def test_intervaltreetools_calculate_min_mean_and_max_duration_of_intervals_02():
