...
def test_tuplettools_make_tuplet_from_proportions_and_pair_25():
    py.test.raises(Exception, 'tuplettools.make_tuplet_from_proportions_and_pair([], (3, 16))')

def test_tuplettools_make_tuplet_from_proportions_and_pair_26():
    py.test.raises(Exception, 'tuplettools.make_tuplet_from_proportions_and_pair([0], (3, 16))')

def test_tuplettools_make_tuplet_from_proportions_and_pair_27():
    py.test.raises(Exception, 'tuplettools.make_tuplet_from_proportions_and_pair([1, 1, 0, 1], (3, 16))')
