...
def test_Tuplet_01( ):
   ...
   assert len(u) == 3
   assert u.duration.multiplier == Duration(2, 3)
   assert u.duration.preprolated == Duration(1, 4)
   assert u.duration.prolated == Duration(1, 4)
...
def test_Tuplet_03( ):
   ...
   assert len(u) == 3
   assert u.duration.preprolated == Duration(1, 2)
   assert u.duration.multiplier == Duration(2, 3)
   assert u.duration.prolated == Duration(1, 2)
   assert repr(u[0]) == "Tuplet(4/5, [c'16, c'16, c'16, c'16, c'16])"
   assert str(u[0]) == "{* 5:4 c'16, c'16, c'16, c'16, c'16 *}"
   assert len(u[0]) == 5
   assert u[0].duration.preprolated == Duration(1, 4)
   assert u[0].duration.multiplier == Duration(4, 5)
   assert u[0].duration.prolated == Duration(1, 6)
...
def test_Tuplet_04( ):
   ...
   assert len(u) == 3
   assert u.duration.preprolated == Duration(1, 3)
   assert u.duration.multiplier == Duration(2, 3)
   assert u.duration.prolated == Duration(1, 3)
   assert repr(u[0]) == 'Tuplet(4/5, [ ])'
   assert str(u[0]) == '{* 4/5 *}'
   assert len(u[0]) == 0
   assert u[0].duration.preprolated == Duration(0)
   assert u[0].duration.multiplier == Duration(4, 5)
   assert u[0].duration.prolated == Duration(0)
