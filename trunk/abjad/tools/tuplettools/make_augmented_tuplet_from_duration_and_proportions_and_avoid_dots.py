def make_augmented_tuplet_from_duration_and_proportions_and_avoid_dots(duration, proportions, big_endian=True):
    '''.. versionadded:: 2.0
    ...
    Return tupletted leaves strictly without dots when all `proportions` equal ``1``::
        ...
        >>> print tuplettools.make_augmented_tuplet_from_duration_and_proportions_and_avoid_dots(
...
#        duration, proportions, 'augmentation', big_endian=big_endian)
    ...
    return tuplettools.make_tuplet_from_duration_and_proportions(
        duration, proportions, avoid_dots=True, big_endian=big_endian, is_diminution=False) 
