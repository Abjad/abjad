...
def test_spannertools_get_spanners_attached_to_any_improper_parent_of_component_01():
    ...
    assert spannertools.get_spanners_attached_to_any_improper_parent_of_component(container[0]) == \
        set([beam, slur, trill])
    assert spannertools.get_spanners_attached_to_any_improper_parent_of_component(container) == \
        set([trill])
