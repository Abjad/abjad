from abjad.tools.spannertools.ProportionalTempoSpanner._ProportionalTempoSpannerFormatInterface \
    import _ProportionalTempoSpannerFormatInterface
from abjad.tools.spannertools.TempoSpanner.TempoSpanner import TempoSpanner
import types
...
class ProportionalTempoSpanner(TempoSpanner):
   ...
   ::
      ...
      abjad> tempo_indication = tempotools.TempoIndication(Rational(1, 4), 60)   
      abjad> proportional_tempo_spanner = Proportionalspannertools.TempoSpanner(t[0][:2], tempo_indication)   
