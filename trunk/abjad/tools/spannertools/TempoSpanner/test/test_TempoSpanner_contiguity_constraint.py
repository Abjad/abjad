...
def test_TempoSpanner_contiguity_constraint_01( ):
   ...
   staff_chunk = Container(Staff(macros.scale(2)) * 2)
   ...
   assert py.test.raises(AssertionError, 'spannertools.TempoSpanner([score[0][0], score[1][0]])')

   tempo = spannertools.TempoSpanner([ ], tempotools.TempoIndication(Rational(1, 4), 48))
