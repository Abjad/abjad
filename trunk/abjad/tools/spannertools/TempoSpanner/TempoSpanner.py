...
from abjad.tools.spannertools.TempoSpanner._TempoSpannerFormatInterface import _TempoSpannerFormatInterface
...
class TempoSpanner(Spanner):
   ...
   Invoke LilyPond ``\newSpacingSection`` command. ::
      ...
      abjad> p = spannertools.TempoSpanner(t[:], tempo_indication)
      abjad> f(t)
      \new Voice {
              \tempo 8=38
              c'8
