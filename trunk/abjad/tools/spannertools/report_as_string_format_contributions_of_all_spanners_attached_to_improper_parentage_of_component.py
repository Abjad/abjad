from abjad.tools.spannertools.get_all_spanners_attached_to_improper_parentage_of_component import \
   get_all_spanners_attached_to_improper_parentage_of_component
...
def report_as_string_format_contributions_of_all_spanners_attached_to_improper_parentage_of_component(
   ...
   spanners = list(get_all_spanners_attached_to_improper_parentage_of_component(component, klass))
