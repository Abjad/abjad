...
class MeasuredComplexBeamSpanner(ComplexBeamSpanner):
    ...
    ::
        ...
        >>> spannertools.MeasuredComplexBeamSpanner(staff.leaves)
    ...
    def _format_before_leaf(self, leaf):
        ...
        if self.is_beamable_component(leaf):
            ...
            elif leaf.select_parentage(include_self=False).get_first(
                measuretools.Measure) is not None:
                measure = leaf.select_parentage(include_self=False).get_first(
    ...
    def span():
        def fget(self):
            ...
            ::
                ...
                ...     Measure((2, 16), "c'16 d'16"), 
                ...     Measure((2, 16), "e'16 f'16")])
                >>> beam = spannertools.MeasuredComplexBeamSpanner(staff.leaves)
                >>> beam.span
                1
