...
class Clarinet(_SingleReedInstrument):
    ...
    def __init__(self, instrument_name_markup=None, short_instrument_name_markup=None, target_context=None):
        _SingleReedInstrument.__init__(self, instrument_name_markup, short_instrument_name_markup, target_context)
        self._default_instrument_name_markup = markuptools.Markup('Clarinet')
        self._default_short_instrument_name_markup = markuptools.Markup('Cl.')
