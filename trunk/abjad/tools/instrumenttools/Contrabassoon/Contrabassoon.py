...
class Contrabassoon(Bassoon):
    ...
    def __init__(self, instrument_name_markup=None, short_instrument_name_markup=None, target_context=None):
        Bassoon.__init__(self, instrument_name_markup, short_instrument_name_markup, target_context)
        self._default_instrument_name_markup = markuptools.Markup('Contrabassoon')
        self._default_short_instrument_name_markup = markuptools.Markup('Contrabsn.')
