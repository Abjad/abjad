...
class EnglishHorn(Oboe):
    ...
    def __init__(self, instrument_name_markup=None, short_instrument_name_markup=None, target_context=None):
        Oboe.__init__(self, instrument_name_markup, short_instrument_name_markup, target_context)
        self._default_instrument_name_markup = markuptools.Markup('English Horn')
        self._default_short_instrument_name_markup = markuptools.Markup('Eng. hn.')
