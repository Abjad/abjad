...
def testNumberedObjectChromaticPitchClassSegment_rotate_01():
...
def testNumberedObjectChromaticPitchClassSegment_rotate_02():
    '''Rotate right.'''
...
def testNumberedObjectChromaticPitchClassSegment_rotate_03():
    '''Rotate left.'''
