def transpose_pitch_number_by_octave_transposition_mapping(pitch_number, mapping):
   ...
   undergo a known transposition under `mapping` as defined here. ::
      ...
      abjad> pitchtools.transpose_pitch_number_by_octave_transposition_mapping(-30, mapping)
      6
   ...
   falls within the octave rooted at ``0`` is ``6``. ::
      ...
      abjad> pitchtools.transpose_pitch_number_by_octave_transposition_mapping(-18, mapping)
      6
   ...
   to `mapping`. ::
      ...
      ...   n, pitchtools.transpose_pitch_number_by_octave_transposition_mapping(n, mapping)
      -30 6
      -18 6
      -6 18
      6 18
