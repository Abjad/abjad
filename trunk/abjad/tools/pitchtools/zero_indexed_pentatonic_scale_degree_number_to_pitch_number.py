...
def zero_indexed_pentatonic_scale_degree_number_to_pitch_number(pentatonic_scale_degree, transpose=1, phase=0):
   ...
   integer `pentatonic_scale_degree`. ::
      ...
      ...     chromatic_pitch_number = pitchtools.zero_indexed_pentatonic_scale_degree_number_to_pitch_number(pentatonic_scale_degree)
