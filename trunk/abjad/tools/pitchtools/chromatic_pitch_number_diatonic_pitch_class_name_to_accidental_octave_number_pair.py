...
from abjad.tools.pitchtools.transpose_chromatic_pitch_class_number_to_neighbor_of_chromatic_pitch_number import transpose_chromatic_pitch_class_number_to_neighbor_of_chromatic_pitch_number
...
def chromatic_pitch_number_diatonic_pitch_class_name_to_accidental_octave_number_pair(chromatic_pitch_number, diatonic_pitch_class_name):
    ...
    nearest_neighbor = transpose_chromatic_pitch_class_number_to_neighbor_of_chromatic_pitch_number(chromatic_pitch_number, pc)
