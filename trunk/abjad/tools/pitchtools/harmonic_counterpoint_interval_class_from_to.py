...
def harmonic_counterpoint_interval_class_from_to(
   ...
   `pitch_carrier_2`. ::
      ...
      abjad> pitchtools.harmonic_counterpoint_interval_class_from_to(Pitch(-2), Pitch(12))
      HarmonicCounterpointIntervalClass(2)

   ::

      abjad> pitchtools.harmonic_counterpoint_interval_class_from_to(Pitch(12), Pitch(-2))
      HarmonicCounterpointIntervalClass(2)
   '''
