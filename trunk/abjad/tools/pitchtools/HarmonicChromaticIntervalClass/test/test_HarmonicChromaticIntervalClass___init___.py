...
def test_HarmonicChromaticIntervalClass___init____01( ):
...
def test_HarmonicChromaticIntervalClass___init____02( ):
...
def test_HarmonicChromaticIntervalClass___init____03( ):
