...
def testHarmonicObjectChromaticIntervalClass___init___01():
...
def testHarmonicObjectChromaticIntervalClass___init___02():
...
def testHarmonicObjectChromaticIntervalClass___init___03():
