...
def calculate_harmonic_counterpoint_interval_class_from_named_pitch_to_named_pitch(
   ...
   `pitch_carrier_2`. ::
      ...
      abjad> pitchtools.calculate_harmonic_counterpoint_interval_class_from_named_pitch_to_named_pitch(NamedPitch(-2), NamedPitch(12))
      HarmonicCounterpointIntervalClass(2)

   ::

      abjad> pitchtools.calculate_harmonic_counterpoint_interval_class_from_named_pitch_to_named_pitch(NamedPitch(12), NamedPitch(-2))
      HarmonicCounterpointIntervalClass(2)
