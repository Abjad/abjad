...
def iterate_pitch_pairs_forward_in_expr(expr):
   ...
   ::
      ...
      abjad> for pair in pitchtools.iterate_pitch_pairs_forward_in_expr(score):
      ...     pair
      ... 
   ...
   ::
      ...
      abjad> for pair in pitchtools.iterate_pitch_pairs_forward_in_expr(staff):
      ...   print pair
      (NamedPitch(c, 4), NamedPitch(d, 4))
