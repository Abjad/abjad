...
def test_pitchtools_pitch_class_number_to_pitch_name_with_flats_01( ):
   ...
   assert pitchtools.pitch_class_number_to_pitch_name_with_flats(0.5) == 'cqs'   
   assert pitchtools.pitch_class_number_to_pitch_name_with_flats(1) == 'cs'   
   ...
   assert pitchtools.pitch_class_number_to_pitch_name_with_flats(2.5) == 'dqs'   
