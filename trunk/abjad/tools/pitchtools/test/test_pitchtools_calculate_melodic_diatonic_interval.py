...
def test_pitchtools_calculate_melodic_diatonic_interval_01():

    pitch = pitchtools.NamedChromaticPitch(12)

    interval = pitchtools.calculate_melodic_diatonic_interval(pitch, pitchtools.NamedChromaticPitch(12))
    assert interval == pitchtools.MelodicDiatonicInterval('perfect', 1)

    interval = pitchtools.calculate_melodic_diatonic_interval(
...
def test_pitchtools_calculate_melodic_diatonic_interval_02():
