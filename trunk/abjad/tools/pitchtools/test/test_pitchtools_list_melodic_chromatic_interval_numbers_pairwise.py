...
def test_pitchtools_list_melodic_chromatic_interval_numbers_pairwise_02():

    notes = [Note("c'8"), Note("d'8"), Note("e'8"), Note("f'8"), Note("g'8"), Note("a'8"),
        Note("b'8"), Note("c''8")]
    notes.reverse()
    t = pitchtools.list_melodic_chromatic_interval_numbers_pairwise(notes)

    assert t == [-1, -2, -2, -2, -1, -2, -2]

    t = pitchtools.list_melodic_chromatic_interval_numbers_pairwise(notes, wrap=True)
