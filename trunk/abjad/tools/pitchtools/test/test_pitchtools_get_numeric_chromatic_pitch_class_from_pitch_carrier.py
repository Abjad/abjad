...
def test_pitchtools_get_numeric_chromatic_pitch_class_from_pitch_carrier_01( ):
   '''Works on notes.'''
...
def test_pitchtools_get_numeric_chromatic_pitch_class_from_pitch_carrier_03( ):
   ...
   assert py.test.raises(MissingPitchError, 
      'pitchtools.get_numeric_chromatic_pitch_class_from_pitch_carrier(chord)')


def test_pitchtools_get_numeric_chromatic_pitch_class_from_pitch_carrier_04( ):
