...
def test_pitchtools_harmonic_chromatic_interval_class_number_dictionary_01():

    chord = Chord([0, 2, 11], (1, 4))
    vector = pitchtools.harmonic_chromatic_interval_class_number_dictionary(chord.written_pitches)
