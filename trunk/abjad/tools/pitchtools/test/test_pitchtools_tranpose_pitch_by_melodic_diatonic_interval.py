...
def test_pitchtools_tranpose_pitch_by_melodic_diatonic_interval_01( ):
   ...
   new = pitchtools.tranpose_pitch_by_melodic_diatonic_interval(pitch, interval)
...
def test_pitchtools_tranpose_pitch_by_melodic_diatonic_interval_02( ):
   ...
   note = Note(12, (1, 4))
   interval = pitchtools.MelodicDiatonicInterval('minor', -3)
   new = pitchtools.tranpose_pitch_by_melodic_diatonic_interval(note, interval)
...
def test_pitchtools_tranpose_pitch_by_melodic_diatonic_interval_03( ):
   ...
   interval = pitchtools.MelodicDiatonicInterval('minor', -3)
   new = pitchtools.tranpose_pitch_by_melodic_diatonic_interval(chord, interval)
