...
def test_pitchtools_iterate_pitch_pairs_forward_in_expr_01( ):
   ...
   score.append(Staff(notes))
   score[1].clef.forced = stafftools.Clef('bass')
   ...
   pairs = pitchtools.iterate_pitch_pairs_forward_in_expr(score)
   pairs = list(pairs)
...
def test_pitchtools_iterate_pitch_pairs_forward_in_expr_02( ):
   ...
   pairs = pitchtools.iterate_pitch_pairs_forward_in_expr(staff)
   pairs = list(pairs)
