...
def test_pitchtools_list_named_chromatic_pitches_in_expr_01():
    ...
    named_pitches = pitchtools.list_named_chromatic_pitches_in_expr(tuplet)
...
def test_pitchtools_list_named_chromatic_pitches_in_expr_02():
    ...
    named_pitches = pitchtools.list_named_chromatic_pitches_in_expr(beam)
...
def test_pitchtools_list_named_chromatic_pitches_in_expr_03():
    ...
    named_pitches = pitchtools.list_named_chromatic_pitches_in_expr(pitch_set)
...
def test_pitchtools_list_named_chromatic_pitches_in_expr_05():
    ...
    assert pitchtools.list_named_chromatic_pitches_in_expr(named_pitches) == (
        pitchtools.NamedPitch('c', 4), 
        pitchtools.NamedPitch('d', 4), 
        pitchtools.NamedPitch('e', 4), 
        pitchtools.NamedPitch('fs', 4), 
