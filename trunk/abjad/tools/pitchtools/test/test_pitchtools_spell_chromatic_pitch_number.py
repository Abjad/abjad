...
def test_pitchtools_spell_chromatic_pitch_number_01():
    ...
    accidental = pitchtools.spell_chromatic_pitch_number(12, 'b')
    assert accidental == (pitchtools.Accidental('s'), 4)
    accidental = pitchtools.spell_chromatic_pitch_number(12, 'c')
    assert accidental == (pitchtools.Accidental(''), 5)
    accidental = pitchtools.spell_chromatic_pitch_number(12, 'd')
    assert accidental == (pitchtools.Accidental('ff'), 5)


def test_pitchtools_spell_chromatic_pitch_number_02():

    accidental = pitchtools.spell_chromatic_pitch_number(13, 'b')
    assert accidental == (pitchtools.Accidental('ss'), 4)
    accidental = pitchtools.spell_chromatic_pitch_number(13, 'c')
    assert accidental == (pitchtools.Accidental('s'), 5)
    accidental = pitchtools.spell_chromatic_pitch_number(13, 'd')
