...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_01( ):
   '''Ascending intervals greater than an octave.'''

   hdic = pitchtools.calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch(
...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_02( ):
   '''Ascending octave.'''
...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_03( ):
...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_04( ):
   '''Unison.'''
...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_05( ):
...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_06( ):
   '''Descending octave.'''
...
def test_pitchtools_calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch_07( ):
