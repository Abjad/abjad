...
def test_pitchtools_list_octave_transpositions_of_pitch_carrier_within_pitch_range_01( ):
   ...
   transpositions = pitchtools.list_octave_transpositions_of_pitch_carrier_within_pitch_range(chord, pitch_range)
   ...
   assert transpositions[0] == Chord([0, 2, 4], (1, 4))
   assert transpositions[1] == Chord([12, 14, 16], (1, 4))
   assert transpositions[2] == Chord([24, 26, 28], (1, 4))
   assert transpositions[3] == Chord([36, 38, 40], (1, 4))
...
def test_pitchtools_list_octave_transpositions_of_pitch_carrier_within_pitch_range_02( ):
   ...
   pitch_numbers = [0, 2, 4]
   pitch_range = pitchtools.PitchRange(0, 48)
   t = pitchtools.list_octave_transpositions_of_pitch_carrier_within_pitch_range(pitch_numbers, pitch_range)
