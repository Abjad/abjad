...
def test_pitchtools_harmonic_chromatic_class_from_to_01( ):
...
def test_pitchtools_harmonic_chromatic_class_from_to_02( ):
   '''Ascending octave.'''
...
def test_pitchtools_harmonic_chromatic_class_from_to_03( ):
...
def test_pitchtools_harmonic_chromatic_class_from_to_04( ):
   '''Unison.'''
...
def test_pitchtools_harmonic_chromatic_class_from_to_05( ):
...
def test_pitchtools_harmonic_chromatic_class_from_to_06( ):
   '''Descending octave.'''
...
def test_pitchtools_harmonic_chromatic_class_from_to_07( ):
