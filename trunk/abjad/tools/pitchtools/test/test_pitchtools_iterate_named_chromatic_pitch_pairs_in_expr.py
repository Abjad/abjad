...
def test_pitchtools_iterate_named_chromatic_pitch_pairs_in_expr_01():
    ...
    pairs = pitchtools.iterate_named_chromatic_pitch_pairs_in_expr(score)
    pairs = list(pairs)
...
def test_pitchtools_iterate_named_chromatic_pitch_pairs_in_expr_02():
    ...
    pairs = pitchtools.iterate_named_chromatic_pitch_pairs_in_expr(staff)
    pairs = list(pairs)
