...
def test_NumberedDiatonicPitchClass___init___01():
    r'''Init numbered diatonic pitch-class from diatonic pitch-class number.
    '''
...
def test_NumberedDiatonicPitchClass___init___02():
    r'''Init numbered diatonic pitch-class from diatonic pitch-class name.
    '''
...
def test_NumberedDiatonicPitchClass___init___03():
    r'''Init numbered diatonic pitch-class from diatonic pitch-class.
    '''
