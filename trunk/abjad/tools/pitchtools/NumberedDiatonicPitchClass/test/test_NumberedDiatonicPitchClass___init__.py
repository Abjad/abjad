...
def testNumberedObjectDiatonicPitchClass___init___01():
...
def testNumberedObjectDiatonicPitchClass___init___02():
...
def testNumberedObjectDiatonicPitchClass___init___03():
