...
def test_NumberedInversionEquivalentIntervalClass___init___01():
    r'''Init from zero.
    '''
...
def test_NumberedInversionEquivalentIntervalClass___init___02():
    r'''Init from positive integer.
    '''
...
def test_NumberedInversionEquivalentIntervalClass___init___03():
    r'''Init from positive float.
    '''
