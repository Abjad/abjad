...
def all_are_named_pitch_tokens(pitch_tokens):
   ...
   Abjad pitch token. ::
      ...
      abjad> pitchtools.is_named_pitch_token_collection([('c', 4), ('d', 4), NamedPitch('e', 4)])
      True
      abjad> pitchtools.is_named_pitch_token_collection([0, 2, 4])
      True

   Otherwise false. ::

      abjad> pitchtools.is_named_pitch_token_collection(['foo', 'bar'])
      False
