...
def insert_and_transpose_nested_subruns_in_lpitch_class_number_list(notes, subrun_indicators):
   ...
   *  *subrun_indicators* must be a list of zero or more
   ...
   ::
      ...
      abjad> pitchtools.insert_and_transpose_nested_subruns_in_lpitch_class_number_list(notes, subrun_indicators)
   ...
   .. versionchanged:: 1.1.2
      ...
      ``pitchtools.insert_and_transpose_nested_subruns_in_lpitch_class_number_list( )``.
   '''
   ...
   for subrun_indicator in subrun_indicators:
      ...
      for anchor_index, subrun_length in pairs:
         ...
         anchor_pitch = get_named_pitch_from_pitch_carrier(anchor_note)
