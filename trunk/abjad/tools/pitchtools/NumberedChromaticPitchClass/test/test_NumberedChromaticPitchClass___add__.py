...
def testNumberedObjectChromaticPitchClass___add___01():
...
def testNumberedObjectChromaticPitchClass___add___02():
    '''Ascending melodic chromatic interval added to pitch-class.'''
...
def testNumberedObjectChromaticPitchClass___add___03():
...
def testNumberedObjectChromaticPitchClass___add___04():
    '''Descending melodic chromatic interval added to pitch-class.'''
...
def testNumberedObjectChromaticPitchClass___add___05():
