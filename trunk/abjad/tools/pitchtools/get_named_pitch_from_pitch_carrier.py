...
def get_named_pitch_from_pitch_carrier(pitch_carrier):
   ...
   of chord `pitch_carrier`. ::
      ...
      abjad> pitch
      NamedPitch(df, 5)
      abjad> pitchtools.get_named_pitch_from_pitch_carrier(pitch)
      NamedPitch(df, 5)
   ...
   ::
      ...
      abjad> note
      Note(df'', 4)
      abjad> pitchtools.get_named_pitch_from_pitch_carrier(note)
      NamedPitch(df, 5)
   ...
   ::
      ...
      NoteHead(df'')
      abjad> pitchtools.get_named_pitch_from_pitch_carrier(note.note_head)
      NamedPitch(df, 5)
   ...
   ::
      ...
      abjad> chord
      Chord(df'', 4)
      abjad> pitchtools.get_named_pitch_from_pitch_carrier(chord)
      NamedPitch(df, 5)
   ...
   Raise :exc:`TypeError` when `pitch_carrier` is not a valid pitch carrier. ::
      ...
      abjad> staff
      Staff{ }
      abjad> pitchtools.get_named_pitch_from_pitch_carrier(staff)
      TypeError
