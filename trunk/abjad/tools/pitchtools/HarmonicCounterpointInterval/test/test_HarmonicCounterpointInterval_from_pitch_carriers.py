...
def test_HarmonicCounterpointInterval_from_pitch_carriers_01():
    r'''Ascending intervals greater than an octave.
    '''

    hcpi = pitchtools.HarmonicCounterpointInterval.from_pitch_carriers(
...
def test_HarmonicCounterpointInterval_from_pitch_carriers_02():
    r'''Ascending octave.
    '''
...
def test_HarmonicCounterpointInterval_from_pitch_carriers_03():
...
def test_HarmonicCounterpointInterval_from_pitch_carriers_04():
    r'''Unison.
    '''
...
def test_HarmonicCounterpointInterval_from_pitch_carriers_05():
...
def test_HarmonicCounterpointInterval_from_pitch_carriers_06():
    r'''Descending octave.
    '''
...
def test_HarmonicCounterpointInterval_from_pitch_carriers_07():
