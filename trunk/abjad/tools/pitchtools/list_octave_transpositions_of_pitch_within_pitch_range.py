...
def list_octave_transpositions_of_pitch_within_pitch_range(pitches, pitch_range):
   ...
   ::
      ...
      abjad> pitchtools.list_octave_transpositions_of_pitch_within_pitch_range(chord, pitch_range)
   ...
   while True:
      candidate = transpose_pitch_by_melodic_chromatic_interval(pitches, interval)
