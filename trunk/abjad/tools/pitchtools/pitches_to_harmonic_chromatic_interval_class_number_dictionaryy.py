...
def pitches_to_harmonic_chromatic_interval_class_number_dictionaryy(pitches):
   ...
   ::
      ...
      abjad> vector = pitchtools.pitches_to_harmonic_chromatic_interval_class_number_dictionaryy(chord.pitches)
      abjad> vector
   ...
   ::
      ...
      abjad> vector = pitchtools.pitches_to_harmonic_chromatic_interval_class_number_dictionaryy(pitches)
      abjad> vector
   ...
   .. versionchanged:: 1.1.2
      ...
      ``pitchtools.pitches_to_harmonic_chromatic_interval_class_number_dictionaryy( )``.
   '''
