...
def test_PitchClassSegment_from_selection_01():
    r'''Works with notes.
    '''
...
def test_PitchClassSegment_from_selection_02():
...
def test_PitchClassSegment_from_selection_03():
...
def test_PitchClassSegment_from_selection_04():
