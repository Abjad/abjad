...
def calculate_harmonic_diatonic_interval_from_named_chromatic_pitch_to_named_chromatic_pitch(pitch_carrier_1, pitch_carrier_2):
   ...
   `pitch_carrier_2`. ::
      ...
      abjad> pitchtools.calculate_harmonic_diatonic_interval_from_named_chromatic_pitch_to_named_chromatic_pitch(NamedPitch(-2), NamedPitch(12))
      HarmonicDiatonicInterval(major ninth)

   ::

      abjad> pitchtools.calculate_harmonic_diatonic_interval_from_named_chromatic_pitch_to_named_chromatic_pitch(NamedPitch(12), NamedPitch(-2))
      HarmonicDiatonicInterval(major ninth)
   ...
   .. versionchanged:: 1.1.2
      renamed ``pitchtools.calculate_harmonic_diatonic_interval_from_named_pitch_to_named_pitch( )`` to
      ``pitchtools.calculate_harmonic_diatonic_interval_from_named_chromatic_pitch_to_named_chromatic_pitch( )``.
   '''
