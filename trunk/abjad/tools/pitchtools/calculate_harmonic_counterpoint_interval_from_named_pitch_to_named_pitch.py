...
def calculate_harmonic_counterpoint_interval_from_named_pitch_to_named_pitch(pitch_carrier_1, pitch_carrier_2):
   '''.. versionadded:: 1.1.2

   Return harmonic counterpoint interval `pitch_carrier_1` to
   `pitch_carrier_2`. ::

      abjad> pitchtools.calculate_harmonic_counterpoint_interval_from_named_pitch_to_named_pitch(NamedPitch(-2), NamedPitch(12))
      HarmonicCounterpointInterval(9)

   ::

      abjad> pitchtools.calculate_harmonic_counterpoint_interval_from_named_pitch_to_named_pitch(NamedPitch(12), NamedPitch(-2))
      HarmonicCounterpointInterval(9)
