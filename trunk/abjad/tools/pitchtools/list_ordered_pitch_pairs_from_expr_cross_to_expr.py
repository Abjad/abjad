...
def list_ordered_pitch_pairs_from_expr_cross_to_expr(expr_1, expr_2):
   '''.. versionadded:: 1.1.2
   ...
   Yield ordered pitch pairs from `expr_1` to `expr_2`. ::
      ...
      abjad> for pair in pitchtools.list_ordered_pitch_pairs_from_expr_cross_to_expr(chord_1, chord_2):
      ...      pair
   ...
   .. versionchanged:: 1.1.2
      ...
      ``pitchtools.list_ordered_pitch_pairs_from_expr_cross_to_expr( )``.
   '''
