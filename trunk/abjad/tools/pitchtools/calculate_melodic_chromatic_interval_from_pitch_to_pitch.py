...
def calculate_melodic_chromatic_interval_from_pitch_to_pitch(pitch_carrier_1, pitch_carrier_2):
   ...
   `pitch_carrier_2`. ::
      ...
      abjad> pitchtools.calculate_melodic_chromatic_interval_from_pitch_to_pitch(NamedPitch(-2), NamedPitch(12))
      MelodicChromaticInterval(+14)

   ::

      abjad> pitchtools.calculate_melodic_chromatic_interval_from_pitch_to_pitch(NamedPitch(12), NamedPitch(-2))
      MelodicChromaticInterval(-14)

   .. versionchanged:: 1.1.2
      renamed ``pitchtools.melodic_chromatic_interval_from_to( )`` to
      ``pitchtools.calculate_melodic_chromatic_interval_from_pitch_to_pitch( )``.
   '''
