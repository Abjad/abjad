...
def testHarmonicObjectChromaticInterval___le___01():
...
def testHarmonicObjectChromaticInterval___le___02():
...
def testHarmonicObjectChromaticInterval___le___03():
    '''Compare two ascending chromatic intervals.'''
...
def testHarmonicObjectChromaticInterval___le___04():
    '''Compare two descending chromatic intervals.'''
