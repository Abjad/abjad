...
def melodic_counterpoint_interval_class_from_to(pitch_carrier_1, pitch_carrier_2):
   ...
   `pitch_carrier_2`. ::
      ...
      abjad> pitchtools.melodic_counterpoint_interval_class_from_to(Pitch(-2), Pitch(12))
      MelodicCounterpointIntervalClass(+2)

   ::

      abjad> pitchtools.melodic_counterpoint_interval_class_from_to(Pitch(12), Pitch(-2))
