...
def test_NamedPitchSet___init___01():
...
def test_NamedPitchSet___init___02():
...
def test_NamedPitchSet___init___03():
    r'''Works with notes.
    '''

    note = Note(13, (1, 4))
    pitch_set = pitchtools.NamedPitchSet(pitchtools.list_named_chromatic_pitches_in_expr(note))
    assert len(pitch_set) == 1


def test_NamedPitchSet___init___04():
    r'''Works with chords.
    '''

    chord = Chord([13, 14, 15], (1, 4))
    pitch_set = pitchtools.NamedPitchSet(pitchtools.list_named_chromatic_pitches_in_expr(chord))
    assert len(pitch_set) == 3


def test_NamedPitchSet___init___05():
...
def test_NamedPitchSet___init___06():
...
def test_NamedPitchSet___init___07():
    r'''Works with chords.
    '''
