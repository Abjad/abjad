...
def list_melodic_chromatic_interval_numbers_pairwise_between_pitches(pitch_carriers, wrap = False):
   ...
   *  Default to ``False``.
   ...
   ::
      ...
      abjad> pitchtools.list_melodic_chromatic_interval_numbers_pairwise_between_pitches(t)
      [2, 2, 1, 2, 2, 2, 1]

   ::

      abjad> pitchtools.list_melodic_chromatic_interval_numbers_pairwise_between_pitches(t, wrap = True)
      [2, 2, 1, 2, 2, 2, 1, -12]
   ...
   ::
      ...
      abjad> pitchtools.list_melodic_chromatic_interval_numbers_pairwise_between_pitches(notes)
      [-1, -2, -2, -2, -1, -2, -2]

   ::

      abjad> pitchtools.list_melodic_chromatic_interval_numbers_pairwise_between_pitches(notes, wrap = True)
      [-1, -2, -2, -2, -1, -2, -2, 12]
