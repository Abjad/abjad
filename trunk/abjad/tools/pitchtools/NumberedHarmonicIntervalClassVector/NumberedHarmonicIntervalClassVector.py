...
class NumberedHarmonicIntervalClassVector(Vector):
    '''Abjad model of harmonic chromatic interval-class vector:

    ::

        >>> staff = Staff("c'8 d'8 e'8 f'8 g'8")
        >>> hcicv = pitchtools.NumberedHarmonicIntervalClassVector(staff)
        >>> print hcicv
    ...
    def __init__(self, expr):
        ...
        for chromatic_interval in \
            ...
            interval_number = \
                chromatic_interval.harmonic_chromatic_interval_class.number
