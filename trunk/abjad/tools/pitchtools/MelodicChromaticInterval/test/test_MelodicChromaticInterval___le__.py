...
def testMelodicObjectChromaticInterval___le___01():
...
def testMelodicObjectChromaticInterval___le___02():
...
def testMelodicObjectChromaticInterval___le___03():
    '''Compare two ascending chromatic intervals.'''
...
def testMelodicObjectChromaticInterval___le___04():
    '''Compare two descending chromatic intervals.'''
