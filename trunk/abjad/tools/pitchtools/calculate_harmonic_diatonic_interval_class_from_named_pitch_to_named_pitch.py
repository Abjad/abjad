...
def calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch(pitch_carrier_1, pitch_carrier_2):
   '''.. versionadded:: 1.1.2

   Return harmonic diatonic interval class from `pitch_carrier_1` to 
   `pitch_carrier_2`. ::

      abjad> pitchtools.calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch(NamedPitch(-2), NamedPitch(12))
      HarmonicDiatonicIntervalClass(major second)

   ::

      abjad> pitchtools.calculate_harmonic_diatonic_interval_class_from_named_pitch_to_named_pitch(NamedPitch(12), NamedPitch(-2))
      HarmonicDiatonicIntervalClass(major second)
