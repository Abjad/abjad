...
def test_NamedInversionEquivalentIntervalClass__init_by_quality_string_and_number_01():
    r'''Init unison.
    '''
...
def test_NamedInversionEquivalentIntervalClass__init_by_quality_string_and_number_02():
    r'''Init usual cases.
    '''
...
def test_NamedInversionEquivalentIntervalClass__init_by_quality_string_and_number_03():
...
def test_NamedInversionEquivalentIntervalClass__init_by_quality_string_and_number_04():
...
def test_NamedInversionEquivalentIntervalClass__init_by_quality_string_and_number_05():
