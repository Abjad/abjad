...
def test_lcopy_01( ):
   ...
   u = clonewp.by_count_with_parentage(t, 1, 5)
...
def test_lcopy_03( ):
   ...
   assert py.test.raises(ContiguityError, 'clonewp.by_count_with_parentage(t, 1, 5)')
...
def test_lcopy_04( ):
   ...
   u = clonewp.by_count_with_parentage(t[0], 1, 3)
...
def test_lcopy_05( ):
   ...
   u = clonewp.by_count_with_parentage(t, 1, 3)
...
def test_lcopy_06( ):
   ...
   t = score[0]
   new = clonewp.by_count_with_parentage(t, 1, 3)
...
def test_lcopy_07( ):
   ...
   u = clonewp.by_count_with_parentage(t, 1, 4)
...
def test_lcopy_09( ):
   ...
   u = clonewp.by_count_with_parentage(t, 1)
...
def test_lcopy_10( ):
   ...
   u = clonewp.by_count_with_parentage(t, 2, 4)
...
def test_lcopy_local_leaf_index_11( ):
   ...
   u = clonewp.by_count_with_parentage(t[1], 1, 3)
