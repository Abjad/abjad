...
def test_labeltools_label_vertical_moments_in_expr_with_chromatic_interval_classes_01():
    ...
    labeltools.label_vertical_moments_in_expr_with_chromatic_interval_classes(score)
