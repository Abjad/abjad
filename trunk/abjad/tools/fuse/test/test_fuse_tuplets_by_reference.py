...
def test_fuse_tuplets_by_reference_01( ):
   ...
   t1 = FixedDurationTuplet((2, 8), construct.scale(3))
   Beam(t1[:])
...
def test_fuse_tuplets_by_reference_03( ):
   ...
   t1 = FixedMultiplierTuplet((2, 3), construct.scale(3))
   Beam(t1[:])
   t2 = FixedMultiplierTuplet((2, 3), construct.scale(5))
   Slur(t2[:])
   t = Voice([t1, t2])
...
def test_fuse_tuplets_by_reference_04( ):
   ...
   t1 = FixedDurationTuplet((2, 8), construct.scale(3))
   t2 = FixedDurationTuplet((2, 8), construct.scale(5))
...
def test_fuse_tuplets_by_reference_05( ):
   ...
   t1 = FixedDurationTuplet((2, 8), construct.scale(3))
   t2 = FixedMultiplierTuplet((2, 3), construct.scale(3))
