...
#   get_tie_chain_duration_preprolated as tietools_get_tie_chain_duration_preprolated
...
def duration_scale(tie_chain, multiplier):
   ...
   ## TODO: Find out why tietools_get_tie_chain_duration_preprolated( )
   ##       fails split!
   ...
   new_written_duration = \
      multiplier * tietools_get_duration_written(tie_chain)
   #new_written_duration = \
   #  multiplier * tietools_get_tie_chain_duration_preprolated(tie_chain)
