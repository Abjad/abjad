...
def test_SpacingIndication___eq___01( ):
   ...
   p = spacingtools.SpacingIndication(tempo_indication, Rational(1, 68))
   
   tempo_indication = marktools.TempoMark(Rational(1, 4), 76)
   q = spacingtools.SpacingIndication(tempo_indication, Rational(1, 68))
...
def test_SpacingIndication___eq___02( ):
   ...
   tempo_indication = marktools.TempoMark(Rational(1, 8), 38)
   q = spacingtools.SpacingIndication(tempo_indication, Rational(1, 78))
