...
def _format_grace_container(grace_container, pieces=False):
    result = []
    result.extend(_format_slot_1(grace_container))
    result.extend(_format_slot_2(grace_container))
    result.extend(_format_slot_3(grace_container))
    result.extend(_format_slot_4(grace_container))
    result.extend(_format_slot_5(grace_container))
    result.extend(_format_slot_6(grace_container))
    result.extend(_format_slot_7(grace_container))
    contributions = []
...
def _format_slot_2(grace_container):
    result = []
