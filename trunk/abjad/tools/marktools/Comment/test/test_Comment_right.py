...
def test_Comment_right_01():
    '''Context comments right.'''

    t = Voice("c'8 d'8 e'8 f'8")
    beam = spannertools.BeamSpanner(t[:])
    beam.override.beam.thickness = 3
    marktools.Comment('Voice right comments here.', 'right')(t)
    marktools.Comment('More voice right comments.', 'right')(t)
...
def test_Comment_right_02():
    '''Leaf comments right.'''

    t = Note(0, (1, 8))
    t.override.beam.thickness = 3
    marktools.Comment('Leaf comments right here.', 'right')(t)
    marktools.Comment('More comments right.', 'right')(t)
