...
from abjad.tools.importtools.remove_modules_from_namespace \
    import remove_modules_from_namespace
import os
...
def import_public_names_from_packagesystem_path_into_namespace(
    ...
    for root, dirs, files in os.walk(package):
        ...
        for file in files:
            if file.endswith('py') and not file.startswith(('_', '.')):
                ...
                functions.extend(get_public_function_names_in_module(module))
    ...
    # remove modules
    remove_modules_from_namespace(namespace)
