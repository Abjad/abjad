...
def test_sequencetools_retain_sequence_elements_at_indices_cyclically_01():
    ...
    sequence_2 = sequencetools.retain_sequence_elements_at_indices_cyclically(range(20), [0, 1], 5)
    assert sequence_2 == [0, 1, 5, 6, 10, 11, 15, 16]


def test_sequencetools_retain_sequence_elements_at_indices_cyclically_02():

    sequence_2 = sequencetools.retain_sequence_elements_at_indices_cyclically(range(20), [0, 1], 5, 1)
