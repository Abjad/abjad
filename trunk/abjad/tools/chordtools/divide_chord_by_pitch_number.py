...
def divide_chord_by_pitch_number(chord, pitch = NamedChromaticPitch('b', 3)):
   ...
   * Parts of length greater than ``1`` return as Abjad chords.
   ...
   Example::
      ...
      abjad> chordtools.divide_chord_by_pitch_number(chord, NamedChromaticPitch(6))
   ...
   ::
      ...
      abjad> treble, bass = chordtools.divide_chord_by_pitch_number(t, 2)     
      abjad> f(treble)
      <
              \tweak #'color #blue
              d'
   ...
   treble, bass = _split(chord, pitch = pitch, attr = 'numbered_chromatic_pitch')
