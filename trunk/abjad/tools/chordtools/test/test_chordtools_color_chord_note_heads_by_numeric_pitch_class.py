...
def test_chordtools_color_chord_note_heads_by_numbered_chromatic_pitch_class_01( ):
   '''Works on chords.'''
...
def test_chordtools_color_chord_note_heads_by_numbered_chromatic_pitch_class_02( ):
   '''Works on notes.'''
