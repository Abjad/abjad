...
def test_chordtools_Chord_written_pitch_indication_is_nonsemantic_01():
...
def test_chordtools_Chord_written_pitch_indication_is_nonsemantic_02():
...
def test_chordtools_Chord_written_pitch_indication_is_nonsemantic_03():
