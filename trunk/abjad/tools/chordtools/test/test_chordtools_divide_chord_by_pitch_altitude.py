...
def test_chordtools_divide_chord_by_pitch_altitude_01( ):
   ...
   treble, bass = chordtools.divide_chord_by_pitch_altitude(t, Pitch('d', 4))
...
def test_chordtools_divide_chord_by_pitch_altitude_02( ):
   ...
   t = Chord([('d', 4), ('ef', 4), ('e', 4)], (1, 4))
   treble, bass = chordtools.divide_chord_by_pitch_altitude(t, Pitch('e', 4))
   assert isinstance(treble, Chord)
...
def test_chordtools_divide_chord_by_pitch_altitude_03( ):
   ...
   t = Chord([('d', 4), ('ef', 4), ('e', 4)], (1, 4))
   treble1, bass1 = chordtools.divide_chord_by_pitch_altitude(t, Pitch('e', 4))
   treble2, bass2 = chordtools.divide_chord_by_pitch_altitude(t, Pitch('ef', 4))
...
def test_chordtools_divide_chord_by_pitch_altitude_04( ):
   ...
   treble, bass = chordtools.divide_chord_by_pitch_altitude(t, Pitch('f', 4))
   assert isinstance(treble, Chord)
