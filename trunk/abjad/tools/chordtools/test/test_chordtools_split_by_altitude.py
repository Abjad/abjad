...
def test_chordtools_split_by_altitude_01( ):
   '''Chord split by altitude only; empty bass.'''
   t = Chord([('d', 4), ('ef', 4), ('e', 4)], (1, 4))
   treble, bass = chordtools.split_by_altitude(t, Pitch('d', 4))
...
def test_chordtools_split_by_altitude_02( ):
   '''Chord split by altitude only; one-note bass.'''
   t = Chord([('d', 4), ('ef', 4), ('e', 4)], (1, 4))
   treble, bass = chordtools.split_by_altitude(t, Pitch('e', 4))
   assert isinstance(treble, Chord)
...
def test_chordtools_split_by_altitude_03( ):
   '''Chord split by altitude is accidental agnostic.'''
   t = Chord([('d', 4), ('ef', 4), ('e', 4)], (1, 4))
   treble1, bass1 = chordtools.split_by_altitude(t, Pitch('e', 4))
   treble2, bass2 = chordtools.split_by_altitude(t, Pitch('ef', 4))
   assert treble1.signature == treble2.signature
   assert bass1.signature == bass2.signature


def test_chordtools_split_by_altitude_04( ):
   '''Typographically crossed split by altitude only.'''
   t = Chord([('d', 4), ('es', 4), ('ff', 4), ('g', 4)], (1, 4))
   treble, bass = chordtools.split_by_altitude(t, Pitch('f', 4))
   assert isinstance(treble, Chord)
...
def test_chordtools_split_by_altitude_05( ):
