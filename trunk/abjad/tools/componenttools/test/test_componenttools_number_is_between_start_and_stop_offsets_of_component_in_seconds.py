...
def test_componenttools_number_is_between_start_and_stop_offsets_of_component_in_seconds_01( ):
   ...
   t = Note(0, (1, 4))
   t.tempo.forced = tempotools.TempoIndication(Rational(1, 2), 60)
   ...
   assert not componenttools.number_is_between_start_and_stop_offsets_of_component_in_seconds(0.5, t)
