...
def test_componenttools_iterate_timeline_backward_from_component_01():
    ...
    leaf_generator = componenttools.iterate_timeline_backward_from_component(staff_2[2])
...
def test_componenttools_iterate_timeline_backward_from_component_02():
    '''Yield klass instances in score of expr,
    sorted backward by score offset stop time,
    and starting from expr.
    '''
    ...
    leaf_generator = componenttools.iterate_timeline_backward_from_component(staff_1[3])
    leaves = list(leaf_generator)
