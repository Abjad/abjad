...
def test_componenttools_partition_components_by_durations_in_seconds_01( ):
   ...
   groups = componenttools.partition_components_by_durations_in_seconds(t.leaves, [1.5], )
...
def test_componenttools_partition_components_by_durations_in_seconds_02( ):
   ...
   groups = componenttools.partition_components_by_durations_in_seconds(t.leaves, [1.5], cyclic = True)
...
def test_componenttools_partition_components_by_durations_in_seconds_03( ):
   '''Read durations cyclically.
   ...
   groups = componenttools.partition_components_by_durations_in_seconds(
...
def test_componenttools_partition_components_by_durations_in_seconds_04( ):
...
def test_componenttools_partition_components_by_durations_in_seconds_05( ):
