...
def test_componenttools_partition_components_by_prolated_durations_01( ):
   ...
   groups = componenttools.partition_components_by_prolated_durations(t.leaves, [Rational(3, 8)], )
...
def test_componenttools_partition_components_by_prolated_durations_02( ):
   ...
   groups = componenttools.partition_components_by_prolated_durations(t.leaves, [Rational(3, 8)], cyclic = True)
...
def test_componenttools_partition_components_by_prolated_durations_03( ):
...
def test_componenttools_partition_components_by_prolated_durations_04( ):
...
def test_componenttools_partition_components_by_prolated_durations_05( ):
