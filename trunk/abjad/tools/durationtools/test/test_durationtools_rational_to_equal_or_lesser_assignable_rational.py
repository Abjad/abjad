...
def test_durationtools_rational_to_equal_or_lesser_assignable_rational_01():
    '''Wrapper around _naivedurationtools.rational_to_equal_or_lesser_assignable_rational()
    that returns dotted and double dotted durations where appropriate.'''

    assert durationtools.rational_to_equal_or_lesser_assignable_rational(
