...
def test_Meter_compare_02( ):
   ...
   m1, m2 = metertools.Meter(3, 8), metertools.Meter(3, 8)
   assert     m1 == m2
   assert not m1 != m2 
   assert not m1 >  m2
   assert     m1 >= m2
...
def test_Meter_compare_03( ):
   ...
   m1, m2 = metertools.Meter(3, 8), metertools.Meter(6, 16)
   assert not m1 == m2
   assert     m1 != m2 
   assert not m1 >  m2
   assert     m1 >= m2
...
def test_Meter_compare_04( ):
   ...
   m1, m2 = metertools.Meter(3, 8), metertools.Meter(4, 8)
   assert not m1 == m2
   assert     m1 != m2 
   assert not m1 >  m2
   assert not m1 >= m2
