...
def test_metertools_duration_and_possible_denominators_to_meter_01( ):
   ...
   t = metertools.duration_and_possible_denominators_to_meter(Fraction(3, 2), [5, 6, 7, 8, 9])
...
def test_metertools_duration_and_possible_denominators_to_meter_02( ):
   ...
   t = metertools.duration_and_possible_denominators_to_meter(Fraction(3, 2), [4, 8, 16, 32])
...
def test_metertools_duration_and_possible_denominators_to_meter_03( ):
   ...
   t = metertools.duration_and_possible_denominators_to_meter(Fraction(3, 2))
...
def test_metertools_duration_and_possible_denominators_to_meter_04( ):
   ...
   t = metertools.duration_and_possible_denominators_to_meter(Fraction(3, 2), [7, 11, 13, 19])
   assert t == metertools.Meter(3, 2)
