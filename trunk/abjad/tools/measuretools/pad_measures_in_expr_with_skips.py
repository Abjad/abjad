...
def pad_measures_in_expr_with_skips(expr, front, back, splice = False):
   ...
   Works when measures contain stacked voices. ::
      ...
      abjad> measuretools.pad_measures_in_expr_with_skips(t, Fraction(1, 32), Fraction(1, 64)) # doctest: +SKIP
   ...
   spanners over newly inserted skips. ::
      ...
      abjad> measuretools.pad_measures_in_expr_with_skips(t, Fraction(1, 32), Fraction(1, 64), splice = True) # doctest: +SKIP
