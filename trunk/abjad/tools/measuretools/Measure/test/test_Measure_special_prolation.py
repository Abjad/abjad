...
def test_Measure_special_prolation_01():
    ...
    assert more(measure[0]).get_duration() == Duration(1, 4)
...
def test_Measure_special_prolation_02():
    ...
    assert more(measure.select_leaves()[0]).get_duration() == Duration(1, 4)
    assert measure.select_leaves()[1].written_duration == Duration(1, 4)
    assert more(measure.select_leaves()[1]).get_duration() == Duration(1, 6)
...
def test_Measure_special_prolation_03():
    ...
    assert more(measure.select_leaves()[0]).get_duration() == Duration(1, 4)
    assert measure.select_leaves()[1].written_duration == Duration(1, 4)
    assert more(measure.select_leaves()[1]).get_duration() == Duration(1, 9)
...
def test_Measure_special_prolation_04():
    ...
    assert measure[0].written_duration == Duration(1, 4)
    assert more(measure[0]).get_duration() == Duration(1, 5)
...
def test_Measure_special_prolation_05():
    ...
    measure = Measure((4, 5), [
        ...
        Note("c'4")])
    assert measure.select_leaves()[0].written_duration == Duration(1, 4)
    assert more(measure.select_leaves()[0]).get_duration() == Duration(1, 5)
    assert measure.select_leaves()[1].written_duration == Duration(1, 4)
    assert more(measure.select_leaves()[1]).get_duration() == Duration(2, 15)
...
def test_Measure_special_prolation_06():
    ...
    assert more(measure.select_leaves()[0]).get_duration() == Duration(1, 5)
    assert measure.select_leaves()[1].written_duration == Duration(1, 4)
    assert more(measure.select_leaves()[1]).get_duration() == Duration(4, 45)
