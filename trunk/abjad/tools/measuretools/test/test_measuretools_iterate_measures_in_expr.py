...
def test_measuretools_iterate_measures_in_expr_01():
    ...
    measures = list(measuretools.iterate_measures_in_expr(staff, reverse=True))
...
def test_measuretools_iterate_measures_in_expr_02():
    ...
    measures = list(measuretools.iterate_measures_in_expr(staff, start=1, reverse=True))
    assert measures[0] is staff[1]
    assert measures[1] is staff[0]
    assert len(measures) == 2

    measures = list(measuretools.iterate_measures_in_expr(staff, stop=2, reverse=True))
    assert measures[0] is staff[2]
    assert measures[1] is staff[1]
    assert len(measures) == 2
...
def test_measuretools_iterate_measures_in_expr_03():
    ...
    measures = list(measuretools.iterate_measures_in_expr(staff))
...
def test_measuretools_iterate_measures_in_expr_04():
    ...
    measures = list(measuretools.iterate_measures_in_expr(staff, start=1))
    assert measures[0] is staff[1]
    assert measures[1] is staff[2]
    assert len(measures) == 2

    measures = list(measuretools.iterate_measures_in_expr(staff, stop=2))
    assert measures[0] is staff[0]
    assert measures[1] is staff[1]
    assert len(measures) == 2
