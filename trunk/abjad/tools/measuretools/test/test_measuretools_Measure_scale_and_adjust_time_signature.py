...
def test_measuretools_Measure_scale_and_adjust_time_signature_01():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_02():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_03():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_04():
    r'''Scale power-of-two time signature to power-of-two time signature.
...
def test_measuretools_Measure_scale_and_adjust_time_signature_05():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_06():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_07():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_08():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_09():
...
def test_measuretools_Measure_scale_and_adjust_time_signature_10():
