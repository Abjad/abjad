...
def test_measuretools_Measure_special_prolation_01():
...
def test_measuretools_Measure_special_prolation_02():
    r'''Measures with power-of-two time signature denominator
    contribute trivially to contents prolation.
    '''
...
def test_measuretools_Measure_special_prolation_03():
    r'''Measures with power-of-two time signature denominator
    contribute trivially to contents prolation.
    '''
...
def test_measuretools_Measure_special_prolation_04():
...
def test_measuretools_Measure_special_prolation_05():
    r'''Measures without power-of-two time signature denominators
    contribute nontrivially to prolation.
    '''
...
def test_measuretools_Measure_special_prolation_06():
    r'''Measures without power-of-two time signature denominators
    contribute nontrivially to prolation.
    '''
