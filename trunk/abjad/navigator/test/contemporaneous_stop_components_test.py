...
def test_contemporaneous_stop_components_01( ):
   '''
   Notes.
   '''
   ...
   "[Voice{3}, Sequential(g'8, a'8), Note(a', 8)]"
   ...
   "[Sequential(g'8, a'8), Note(a', 8), Voice{3}]"
   ...
   "[Note(a', 8), Sequential(g'8, a'8), Voice{3}]"
...
def test_contemporaneous_stop_components_02( ):
   '''
   ...
   "[Parallel(Sequential(c'8, d'8), Sequential(e'8, f'8)), Sequential(c'8, d'8), Sequential(e'8, f'8), Note(f', 8), Note(d', 8)]"
