...
def test_contemporaneous_components_01( ):
   '''
   Notes.
   '''
   ...
   result = t._navigator._contemporaneousComponents
   ...
   result = t[0]._navigator._contemporaneousComponents
   ...
   result = t[0][0]._navigator._contemporaneousComponents
...
def test_contemporaneous_components_02( ):
   '''
