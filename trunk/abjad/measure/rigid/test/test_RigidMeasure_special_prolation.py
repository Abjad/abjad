...
def test_rigid_measure_special_prolation_01( ):
...
def test_rigid_measure_special_prolation_02( ):
   '''Binary measures contribute trivially to contents prolation;
...
def test_rigid_measure_special_prolation_03( ):
   '''Binary measures contribute trivially to contents prolation;
...
def test_rigid_measure_special_prolation_04( ):
...
def test_rigid_measure_special_prolation_05( ):
...
def test_rigid_measure_special_prolation_06( ):
   '''Nonbinary measures contribute nontrivially to contents prolation;
      works on notes and nested tuplets together.'''
   t = RigidMeasure((4, 5), [
      Note(0, (1, 4)),
