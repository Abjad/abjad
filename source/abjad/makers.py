    ...
    *,
    ...
    if pitch_list == []:
        if skips_instead_of_rests is True:
            ...
            multimeasure_rest.set_dmp(duration.pair())
...
def make_tuplet(
    ...
    *,
    ...
    if len(proportion) == 1:
        ...
        exponent = int(
            math.log(_math.weight(proportion, start=0), 2) - math.log(numerator, 2)
        )
