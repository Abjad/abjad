...
class MetricModulation:
    ...
    def _get_markup_arguments(self):
        ...
        right_rhythm = self._initialize_rhythm(self.right_rhythm)
        if self._note_to_note():
            left_exponent = left_rhythm[0].get_written_duration().exponent()
            left_dots = left_rhythm[0].get_written_duration().dot_count()
            right_exponent = right_rhythm[0].get_written_duration().exponent()
            right_dots = right_rhythm[0].get_written_duration().dot_count()
            return (left_exponent, left_dots, right_exponent, right_dots)
        elif self._lhs_tuplet():
            tuplet_exponent = left_rhythm[0][0].get_written_duration().exponent()
            tuplet_dots = left_rhythm[0][0].get_written_duration().dot_count()
            ...
            note_exponent = right_rhythm[0].get_written_duration().exponent()
            note_dots = right_rhythm[0].get_written_duration().dot_count()
            return (
                tuplet_exponent,
                tuplet_dots,
                tuplet_n,
            ...
            note_exponent = left_rhythm[0].get_written_duration().exponent()
            note_dots = left_rhythm[0].get_written_duration().dot_count()
            tuplet_exponent = right_rhythm[0][0].get_written_duration().exponent()
            tuplet_dots = right_rhythm[0][0].get_written_duration().dot_count()
