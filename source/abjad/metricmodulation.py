...
class MetricModulation:
    ...
    def _get_markup_arguments(self):
        ...
        right_rhythm = self._initialize_rhythm(self.right_rhythm)
        if self._note_to_note():
            left_exponent = left_rhythm[0].get_written_duration().get_exponent()
            left_dots = left_rhythm[0].get_written_duration().get_dot_count()
            right_exponent = right_rhythm[0].get_written_duration().get_exponent()
            right_dots = right_rhythm[0].get_written_duration().get_dot_count()
            ...
            note_exponent = left_rhythm[0].get_written_duration().get_exponent()
            note_dots = left_rhythm[0].get_written_duration().get_dot_count()
