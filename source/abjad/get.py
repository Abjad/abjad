...
def contents(argument) -> list[_score.Component]:
    ...
    if hasattr(argument, "components"):
        result.extend(argument.components())
    return result
...
def duration(
    ...
    ..  container:: example
        ...
        Staff("{ c'4 d'4 { { <e' g'>16 gs'16 a'16 as'16 } { e'4 } } f'4 }") Duration(numerator=1, denominator=1)
        Voice("c'4 d'4 { { <e' g'>16 gs'16 a'16 as'16 } { e'4 } } f'4", name='MusicVoice') Duration(numerator=1, denominator=1)
        Note("c'4")                    Duration(numerator=1, denominator=4)
        BeforeGraceContainer("cs'16")  Duration(numerator=1, denominator=16)
        Note("cs'16")                  Duration(numerator=1, denominator=16)
        Note("d'4")                    Duration(numerator=1, denominator=4)
        Container("{ <e' g'>16 gs'16 a'16 as'16 } { e'4 }") Duration(numerator=1, denominator=4)
        OnBeatGraceContainer("<e' g'>16 gs'16 a'16 as'16") Duration(numerator=1, denominator=4)
        Chord("<e' g'>16")             Duration(numerator=1, denominator=16)
        Note("gs'16")                  Duration(numerator=1, denominator=16)
        Note("a'16")                   Duration(numerator=1, denominator=16)
        Note("as'16")                  Duration(numerator=1, denominator=16)
        Voice("e'4", name='MusicVoice') Duration(numerator=1, denominator=4)
        Note("e'4")                    Duration(numerator=1, denominator=4)
        Note("f'4")                    Duration(numerator=1, denominator=4)
        AfterGraceContainer("fs'16")   Duration(numerator=1, denominator=16)
        Note("fs'16")                  Duration(numerator=1, denominator=16)
    ...
    ..  container:: example
        ...
        ...     duration = abjad.get.duration(component)
        ...     print(f"{repr(component):30} {repr(duration)}")
        Staff("{ c'4 d'4 e'4 { gf'16 } f'4 }") Duration(numerator=1, denominator=1)
        Voice("c'4 d'4 e'4 { gf'16 } f'4", name='MusicVoice') Duration(numerator=1, denominator=1)
        Note("c'4")                    Duration(numerator=1, denominator=4)
        Note("d'4")                    Duration(numerator=1, denominator=4)
        Note("e'4")                    Duration(numerator=1, denominator=4)
        IndependentAfterGraceContainer("gf'16") Duration(numerator=0, denominator=1)
        Note("gf'16")                  Duration(numerator=1, denominator=16)
        Note("f'4")                    Duration(numerator=1, denominator=4)
    ...
    ..  container:: example
        ...
        ...     duration = abjad.get.duration(component)
        ...     print(f"{repr(component):30} {repr(duration)}")
        Staff("{ c'16 e'16 } cs'4 { d'16 f'16 } ds'4") Duration(numerator=1, denominator=1)
        TremoloContainer("c'16 e'16")  Duration(numerator=1, denominator=4)
        Note("c'16")                   Duration(numerator=1, denominator=8)
        Note("e'16")                   Duration(numerator=1, denominator=8)
        Note("cs'4")                   Duration(numerator=1, denominator=4)
        TremoloContainer("d'16 f'16")  Duration(numerator=1, denominator=4)
        Note("d'16")                   Duration(numerator=1, denominator=8)
        Note("f'16")                   Duration(numerator=1, denominator=8)
        Note("ds'4")                   Duration(numerator=1, denominator=4)
...
def effective_indicator(
    ...
    *,
    ...
    ..  container:: example
        ...
        ...     staff[0],
        ...     hide=True,
        ...     synthetic_offset=abjad.Offset(abjad.Fraction(-1)),
        ... )
    ...
    *,
    ...
    ..  container:: example
        ...
        Note("d'4")
            None
        Container("{ <e' g'>16 gs'16 a'16 as'16 } { e'4 }")
            Wrapper(annotation=None, context_name='Staff', deactivate=False, direction=None, hide=False, indicator=Clef(name='alto'), synthetic_offset=None, tag=Tag(string=''))
        OnBeatGraceContainer("<e' g'>16 gs'16 a'16 as'16")
            Wrapper(annotation=None, context_name='Staff', deactivate=False, direction=None, hide=False, indicator=Clef(name='alto'), synthetic_offset=None, tag=Tag(string=''))
        Chord("<e' g'>16")
            Wrapper(annotation=None, context_name='Staff', deactivate=False, direction=None, hide=False, indicator=Clef(name='alto'), synthetic_offset=None, tag=Tag(string=''))
...
def timespan(argument, in_seconds: bool = False) -> _timespan.Timespan:
    ...
    ..  container:: example
        ...
        BeforeGraceContainer("cs'16"):
            Timespan(Offset(Fraction(1, 4), displacement=Duration(numerator=-1, denominator=16)), Offset(Fraction(1, 4)))
        Note("cs'16"):
            Timespan(Offset(Fraction(1, 4), displacement=Duration(numerator=-1, denominator=16)), Offset(Fraction(1, 4)))
        Note("d'4"):
        ...
        OnBeatGraceContainer("<e' g'>16 gs'16 a'16 as'16"):
            Timespan(Offset(Fraction(1, 2)), Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=4)))
        Chord("<e' g'>16"):
            Timespan(Offset(Fraction(1, 2)), Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=16)))
        Note("gs'16"):
            Timespan(Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=16)), Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=8)))
        Note("a'16"):
            Timespan(Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=8)), Offset(Fraction(1, 2), displacement=Duration(numerator=3, denominator=16)))
        Note("as'16"):
            Timespan(Offset(Fraction(1, 2), displacement=Duration(numerator=3, denominator=16)), Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=4)))
        Voice("e'4", name='MusicVoice'):
            Timespan(Offset(Fraction(1, 2)), Offset(Fraction(3, 4)))
        Note("e'4"):
            Timespan(Offset(Fraction(1, 2), displacement=Duration(numerator=1, denominator=4)), Offset(Fraction(3, 4)))
        Note("f'4"):
            Timespan(Offset(Fraction(3, 4)), Offset(Fraction(1, 1)))
        AfterGraceContainer("fs'16"):
            Timespan(Offset(Fraction(1, 1), displacement=Duration(numerator=-1, denominator=16)), Offset(Fraction(1, 1)))
        Note("fs'16"):
            Timespan(Offset(Fraction(1, 1), displacement=Duration(numerator=-1, denominator=16)), Offset(Fraction(1, 1)))
    ...
    ..  container:: example
        ...
        Note("e'4"):
            Timespan(Offset(Fraction(1, 2)), Offset(Fraction(3, 4)))
        IndependentAfterGraceContainer("gf'16"):
            Timespan(Offset(Fraction(3, 4), displacement=Duration(numerator=-1, denominator=16)), Offset(Fraction(3, 4)))
        Note("gf'16"):
            Timespan(Offset(Fraction(3, 4), displacement=Duration(numerator=-1, denominator=16)), Offset(Fraction(3, 4)))
        Note("f'4"):
            Timespan(Offset(Fraction(3, 4)), Offset(Fraction(1, 1)))
    ...
    ..  container:: example
        ...
        Staff("{ c'16 e'16 } cs'4 { d'16 f'16 } ds'4") Timespan(Offset(Fraction(0, 1)), Offset(Fraction(1, 1)))
        TremoloContainer("c'16 e'16")  Timespan(Offset(Fraction(0, 1)), Offset(Fraction(1, 4)))
        Note("c'16")                   Timespan(Offset(Fraction(0, 1)), Offset(Fraction(1, 8)))
        Note("e'16")                   Timespan(Offset(Fraction(1, 8)), Offset(Fraction(1, 4)))
        Note("cs'4")                   Timespan(Offset(Fraction(1, 4)), Offset(Fraction(1, 2)))
        TremoloContainer("d'16 f'16")  Timespan(Offset(Fraction(1, 2)), Offset(Fraction(3, 4)))
        Note("d'16")                   Timespan(Offset(Fraction(1, 2)), Offset(Fraction(5, 8)))
        Note("f'16")                   Timespan(Offset(Fraction(5, 8)), Offset(Fraction(3, 4)))
        Note("ds'4")                   Timespan(Offset(Fraction(3, 4)), Offset(Fraction(1, 1)))
    ...
    *,
    ...
    ..  container:: example
        ...
        Voice("c'4 d'4 { { <e' g'>16 gs'16 a'16 as'16 } { e'4 } } f'4", name='MusicVoice'):
            None
        Note("c'4"):
            Wrapper(annotation=None, context_name=None, deactivate=False, direction=None, hide=False, indicator=Articulation(name='.'), synthetic_offset=None, tag=Tag(string=''))
        BeforeGraceContainer("cs'16"):
            None
        Note("cs'16"):
            Wrapper(annotation=None, context_name=None, deactivate=False, direction=None, hide=False, indicator=Articulation(name='.'), synthetic_offset=None, tag=Tag(string=''))
